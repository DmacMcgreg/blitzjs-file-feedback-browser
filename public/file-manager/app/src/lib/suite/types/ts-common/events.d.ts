...
declare type ArgumentTypes<F extends (...args: any[]) => any> = F extends (...args: infer A) => any
	? A
	: never;
export declare class EventSystem<E extends string, T extends IEventHandlersMap = IEventHandlersMap>
