  ...
  [2],
  {
      ...
      var s = (e.Bounds = (function () {
        ...
        i =
          ...
          (e.parseBoundCurves = function (A, e, t) {
            ...
            U > 1 &&
              ((r /= U), (B /= U), (a /= U), (s /= U), (o /= U), (l /= U), (u /= U), (Q /= U))
            var g = A.width - a,
              C = A.height - l,
              F = A.width - o,
              d = A.height - Q
        ...
        var w = e.ownerDocument,
          ...
          F =
            e === w.documentElement
              ...
              : null
        return (
          t.foreignObjectRendering ? s.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)
        ).then(function (s) {
          return s
    ...
    1289: function (A, e, t) {
      ...
      var c = (e.LETTER_NUMBER_MODIFIER = 50),
        ...
        W = function (A, e, t, r, n) {
          ...
          if ((o === H && -1 !== [v, I, K].indexOf(c)) || (-1 !== [v, I, K].indexOf(o) && c === f))
            return D
          if (
          ...
          if (
            ...
            return D
          if ((-1 !== V.indexOf(o) && -1 !== [C, f].indexOf(c)) || (-1 !== V.indexOf(c) && o === H))
            return D
    ...
    1293: function (A, e, t) {
      ...
      var Q = function (A) {
        ...
        w = function (A) {
          for (
            var e = [], t = [], r = [], n = [], B = [], a = A.contexts.length, s = 0;
            s < a;
            s++
          ) {
            var o = A.contexts[s]
    ...
    1294: function (A, e, t) {
      ...
      var l = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i,
        ...
        H = function (A, e, t) {
          ...
          r &&
            (void 0 !== r[3] &&
              (B.x = (0, a.calculateLengthFromValueWithUnit)(A, r[3], r[4]).getAbsoluteValue(
                t.width
              )),
            void 0 !== r[5] &&
              (B.y = (0, a.calculateLengthFromValueWithUnit)(A, r[5], r[6]).getAbsoluteValue(
                t.height
              )),
            r[7]
            ...
            r[10]
              ...
              : void 0 !== r[11] &&
                (s.y = (0, a.calculateLengthFromValueWithUnit)(A, r[11], r[12])))
          var o = {
