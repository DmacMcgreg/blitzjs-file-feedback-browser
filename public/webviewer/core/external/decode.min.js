...
var BrotliDecode = (function () {
  ...
  function p(e, t, i, n) {
    ...
    if (
      (n.t >= 16 && ((n.i = (n.o[n.s++] << 16) | (n.i >>> 16)), (n.t -= 16)), 1 == (a = S(n, 2)))
    ) {
  ...
  function Y(e) {
    ...
    return (
      0 != t && (e.oe.set(e.L.subarray(e.J, e.J + t), e.re + e.ae), (e.ae += t), (e.J += t)),
      e.ae < e.ne ? 1 : 0
    )
  }
  function Q(e, t, i) {
  ...
  function x(e, t, i, n, a, o) {
    for (var r = t, s = 3 * o, l = ce[se[s]], c = se[s + 1], d = ce[se[s + 2]]; 0 != le[l]; )
      e[r++] = le[l++]
    var h = c >= 12 ? c - 11 : 0
    h > a && (h = a), (n += h), (a -= h)
