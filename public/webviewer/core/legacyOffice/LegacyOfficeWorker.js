  ...
  function (e, t, n) {
    ...
    var S,
      ...
      W =
        ...
        (I = /(msie) ([\w.]+)/.exec(S) || /(trident)(?:.*? rv:([\w.]+)|)/.exec(S))
          ? parseInt(I[2], 10)
          : I),
      C =
      ...
      D = (/Android/i.test(navigator.userAgent), L.navigator.userAgent.match(/Firefox/)),
      N =
        ((function () {
          if (!D) return null
      ...
      z =
        ...
        parseInt(L.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)[3]) >= 14,
    ...
    !(function (e) {
      var t, n, r, o
      e.basePath = "../"
      var i = e.legacyOfficeWorkerPath || ""
      ...
      ;(e.ContinueFunc = function (e) {
        ...
        (e.Module = {
          ...
          onRuntimeInitialized: function () {
            ...
            for (var i = 0; i < s.length; ++i) onmessage(s[i])
            s = null
          },
          fetchSelf: function () {
            ;(J = Date.now()),
              Y(
                "".concat(i, "WebB2XOfficeWorker"),
