;(function () {
  ...
  $jscomp.makeIterator = function (iterable) {
    var iteratorFunction =
      "undefined" != typeof Symbol && Symbol.iterator && iterable[Symbol.iterator]
  ...
  $jscomp.checkStringArgs = function (thisArg, arg, func) {
    if (null == thisArg)
      throw new TypeError(
        "The 'this' value for String.prototype." + func + " must not be null or undefined"
      )
    if (arg instanceof RegExp)
      throw new TypeError(
        "First argument to String.prototype." + func + " must not be a regular expression"
      )
    return thisArg + ""
  }
  $jscomp.polyfill(
    ...
    function (orig) {
      return orig
        ...
        : function (arrayLike, opt_mapFn, opt_thisArg) {
            ...
            var result = [],
              iteratorFunction =
                "undefined" != typeof Symbol && Symbol.iterator && arrayLike[Symbol.iterator]
            if ("function" == typeof iteratorFunction) {
              ...
              for (iteratorFunction = arrayLike.length, k = 0; k < iteratorFunction; k++)
  ...
  ;(function (modules) {
    ...
    function (module, exports$jscomp$0) {
      ...
      ;(function (exports) {
        ...
        PDFNet.Convert =
          exports.Core.PDFNet && exports.Core.PDFNet.Convert ? exports.Core.PDFNet.Convert : {}
        PDFNet.Optimizer = {}
        ...
        PDFNet.Destroyable.prototype.destroy = function () {
          this.takeOwnership()
          return PDFNet.sendWithPromise(this.name + ".destroy", { auto_dealloc_obj: this.id })
        }
        ...
        PDFNet.DigitalSignatureField = function (mp_field_dict_obj) {
          ...
          if ("object" === _typeof(mp_field_dict_obj)) copyFunc(mp_field_dict_obj, this)
            ...
            return new PDFNet.DigitalSignatureField({ mp_field_dict_obj: mp_field_dict_obj })
        }
        ...
        PDFNet.FDFField = function (mp_leaf_node, mp_root_array) {
          ...
          if (mp_leaf_node && "undefined" === typeof mp_root_array) copyFunc(mp_leaf_node, this)
            ...
            return (
              ...
              new PDFNet.FDFField({ mp_leaf_node: mp_leaf_node, mp_root_array: mp_root_array })
            )
        }
        ...
        PDFNet.Matrix2D = function (m_a, m_b, m_c, m_d, m_h, m_v) {
          ...
          if (m_a && "undefined" === typeof m_b) copyFunc(m_a, this)
            ...
            return (
              ...
              new PDFNet.Matrix2D({ m_a: m_a, m_b: m_b, m_c: m_c, m_d: m_d, m_h: m_h, m_v: m_v })
            )
        }
        ...
        PDFNet.Rect = function (x1, y1, x2, y2, mp_rect) {
          ...
          if (x1 && "undefined" === typeof y1) copyFunc(x1, this)
            ...
            return (
              ...
              new PDFNet.Rect({ x1: x1, y1: y1, x2: x2, y2: y2, mp_rect: mp_rect })
            )
        }
        ...
        PDFNet.PDFDoc.TextDiffOptions.prototype.addZonesForPage = function (
          ...
          if (this.mImpl[zones].length < page_num)
            for (var i = this.mImpl[zones].length; i < page_num; i++) this.mImpl[zones].push([])
          regions = regions.map(function (rect) {
            return [rect.x1, rect.y1, rect.x2, rect.y2]
          })
          this.mImpl[zones][page_num - 1] = regions
        }
        PDFNet.PDFDoc.TextDiffOptions.prototype.addIgnoreZonesForPage = function (
          regions,
          page_num
        ) {
        ...
        PDFNet.Convert.createAdvancedImagingConvertOptions = function () {
          return Promise.resolve(new PDFNet.Convert.AdvancedImagingConvertOptions())
        }
        PDFNet.Convert.AdvancedImagingConvertOptions = function () {
          this.name = "PDFNet.Convert.AdvancedImagingConvertOptions"
          this.mImpl = {}
          this.mHelpers = optionsHelpers()
        }
        PDFNet.Convert.AdvancedImagingConvertOptions.prototype.getDefaultDPI = function () {
          return "DefaultDPI" in this.mImpl ? this.mImpl.DefaultDPI : 72
        }
        PDFNet.Convert.AdvancedImagingConvertOptions.prototype.setDefaultDPI = function (value) {
          this.mHelpers.putNumber(this.mImpl, "DefaultDPI", value)
          return this
        }
        PDFNet.Convert.AdvancedImagingConvertOptions.prototype.getEnableAutoLevel = function () {
          return "EnableAutoLevel" in this.mImpl ? !!this.mImpl.EnableAutoLevel : !1
        }
        PDFNet.Convert.AdvancedImagingConvertOptions.prototype.setEnableAutoLevel = function (
          value
        ) {
          this.mHelpers.putBool(this.mImpl, "EnableAutoLevel", value)
          return this
        }
        ...
        PDFNet.Optimizer.MonoImageSettings.prototype.setJBIG2Threshold = function (
          jbig2_threshold
        ) {
        ...
        PDFNet.Optimizer.OptimizerSettings.prototype.setGrayscaleImageSettings = function (
          settings
        ) {
        ...
        PDFNet.Optimizer.OptimizerSettings.prototype.removeCustomEntries = function (
          should_remove
        ) {
        ...
        PDFNet.Convert.OfficeToPDFOptions.prototype.setExcelDefaultCellBorderWidth = function (
          width
        ) {
        ...
        PDFNet.Convert.XODOutputOptions.prototype.setThumbnailSize = function (
          ...
          this.LARGE_THUMB_SIZE = large_size ? large_size : regular_size
          return this
        }
        ...
        PDFNet.Convert.XODOutputOptions.prototype.setOpacityMaskWorkaround = function (
          opacity_render
        ) {
        ...
        PDFNet.Convert.XODOutputOptions.prototype.setSilverlightTextWorkaround = function (
          workaround
        ) {
        ...
        PDFNet.Convert.XODOutputOptions.prototype.useSilverlightFlashCompatible = function (
          compatible
        ) {
        ...
        PDFNet.Convert.SVGOutputOptions.prototype.setEmbedImages = function (embed_images) {
          this.EMBEDIMAGES = embed_images
          return this
        }
        PDFNet.Convert.SVGOutputOptions.prototype.setNoFonts = function (no_fonts) {
          this.NOFONTS = no_fonts
          return this
        }
        PDFNet.Convert.SVGOutputOptions.prototype.setSvgFonts = function (svg_fonts) {
          this.SVGFONTS = svg_fonts
          return this
        }
        PDFNet.Convert.SVGOutputOptions.prototype.setEmbedFonts = function (embed_fonts) {
          this.EMBEDFONTS = embed_fonts
          return this
        }
        PDFNet.Convert.SVGOutputOptions.prototype.setNoUnicode = function (no_unicode) {
          this.NOUNICODE = no_unicode
          return this
        }
        PDFNet.Convert.SVGOutputOptions.prototype.setIndividualCharPlacement = function (
          individual_char_placement
        ) {
          this.INDIVIDUALCHARPLACEMENT = individual_char_placement
          return this
        }
        PDFNet.Convert.SVGOutputOptions.prototype.setRemoveCharPlacement = function (
          remove_char_placement
        ) {
          this.REMOVECHARPLACEMENT = remove_char_placement
          return this
        }
        ...
        PDFNet.Convert.SVGOutputOptions.prototype.setFlattenMaximumImagePixels = function (
          max_pixels
        ) {
          this.MAX_IMAGE_PIXELS = max_pixels
          return this
        ...
        PDFNet.PDFDoc.ViewerOptimizedOptions.prototype.setThumbnailRenderingThreshold = function (
          threshold
        ) {
          this.COMPLEXITY_THRESHOLD = threshold
          return this
        }
        PDFNet.PDFDoc.ViewerOptimizedOptions.prototype.setMinimumInitialThumbnails = function (
          initial_thumbs
        ) {
          this.MINIMUM_INITIAL_THUMBNAILS = initial_thumbs
          return this
        }
        ...
        PDFNet.Page.Box = { e_media: 0, e_crop: 1, e_bleed: 2, e_trim: 3, e_art: 4, e_user_crop: 5 }
        ...
        PDFNet.Stamper.SizeType = { e_relative_scale: 1, e_absolute_size: 2, e_font_size: 3 }
        ...
        PDFNet.DictIterator.prototype.hasNext = function () {
          return PDFNet.sendWithPromise("DictIterator.hasNext", { itr: this.id })
        }
        PDFNet.DictIterator.prototype.key = function () {
          return PDFNet.sendWithPromise("DictIterator.key", { itr: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.DictIterator.prototype.value = function () {
          return PDFNet.sendWithPromise("DictIterator.value", { itr: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Matrix2D.prototype.inverse = function () {
          ...
          return PDFNet.sendWithPromise("Matrix2D.inverse", { matrix: this }).then(function (id) {
            return new PDFNet.Matrix2D(id)
          })
        }
        PDFNet.Matrix2D.prototype.translate = function (h, v) {
          ...
          return PDFNet.sendWithPromise("Matrix2D.translate", { matrix: this, h: h, v: v }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.Matrix2D.prototype.preTranslate = function (h, v) {
          ...
          return PDFNet.sendWithPromise("Matrix2D.preTranslate", { matrix: this, h: h, v: v }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.Matrix2D.prototype.scale = function (h, v) {
          ...
          return PDFNet.sendWithPromise("Matrix2D.scale", { matrix: this, h: h, v: v }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.Matrix2D.createRotationMatrix = function (angle) {
          checkArguments(arguments.length, 1, "createRotationMatrix", "(number)", [
            [angle, "number"],
          ])
          return PDFNet.sendWithPromise("matrix2DCreateRotationMatrix", { angle: angle }).then(
            function (id) {
              return new PDFNet.Matrix2D(id)
            }
          )
        ...
        PDFNet.Matrix2D.prototype.multiply = function (m) {
          ...
          return PDFNet.sendWithPromise("Matrix2D.multiply", { matrix: this, m: m }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id, me)
        ...
        PDFNet.Field.create = function (field_dict) {
          ...
          return PDFNet.sendWithPromise("fieldCreate", { field_dict: field_dict.id }).then(
            function (id) {
        ...
        PDFNet.Field.prototype.getValueAsString = function () {
          ...
          return PDFNet.sendWithPromise("Field.getValueAsString", { field: this })
        }
        PDFNet.Field.prototype.getDefaultValueAsString = function () {
          checkThisYieldFunction("getDefaultValueAsString", this.yieldFunction)
          return PDFNet.sendWithPromise("Field.getDefaultValueAsString", { field: this })
        }
        ...
        PDFNet.Field.prototype.setValue = function (value) {
          ...
          return PDFNet.sendWithPromise("Field.setValue", { field: this, value: value.id }).then(
            function (id) {
              me.yieldFunction = void 0
              id.result = createDestroyableObj(PDFNet.ViewChangeCollection, id.result)
              copyFunc(id.field, me)
        ...
        PDFNet.Field.prototype.setValueAsBool = function (value) {
          ...
          return PDFNet.sendWithPromise("Field.setValueAsBool", { field: this, value: value }).then(
            function (id) {
              me.yieldFunction = void 0
              id.result = createDestroyableObj(PDFNet.ViewChangeCollection, id.result)
              copyFunc(id.field, me)
        ...
        PDFNet.Field.prototype.refreshAppearance = function () {
          ...
          return PDFNet.sendWithPromise("Field.refreshAppearance", { field: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id, me)
        ...
        PDFNet.Field.prototype.eraseAppearance = function () {
          ...
          return PDFNet.sendWithPromise("Field.eraseAppearance", { field: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id, me)
        ...
        PDFNet.Field.prototype.getDefaultValue = function () {
          ...
          return PDFNet.sendWithPromise("Field.getDefaultValue", { field: this }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Field.prototype.useSignatureHandler = function (signature_handler_id) {
          checkArguments(arguments.length, 1, "useSignatureHandler", "(number)", [
        ...
        PDFNet.Field.prototype.getFlag = function (flag) {
          ...
          return PDFNet.sendWithPromise("Field.getFlag", { field: this, flag: flag })
        }
        ...
        PDFNet.Field.prototype.getJustification = function () {
          ...
          return PDFNet.sendWithPromise("Field.getJustification", { field: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id.field, me)
        ...
        PDFNet.Field.prototype.setJustification = function (j) {
          ...
          return PDFNet.sendWithPromise("Field.setJustification", { field: this, j: j }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.Field.prototype.setMaxLen = function (max_len) {
          ...
          return PDFNet.sendWithPromise("Field.setMaxLen", { field: this, max_len: max_len }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.Field.prototype.getDefaultAppearance = function () {
          ...
          return PDFNet.sendWithPromise("Field.getDefaultAppearance", { field: this }).then(
            function (id) {
              me.yieldFunction = void 0
        ...
        PDFNet.Field.prototype.getUpdateRect = function () {
          ...
          return PDFNet.sendWithPromise("Field.getUpdateRect", { field: this }).then(function (id) {
        ...
        PDFNet.Field.prototype.flatten = function (page) {
          ...
          return PDFNet.sendWithPromise("Field.flatten", { field: this, page: page.id }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.Field.prototype.findInheritedAttribute = function (attrib) {
          checkArguments(arguments.length, 1, "findInheritedAttribute", "(string)", [
            [attrib, "string"],
          ])
        ...
        PDFNet.Field.prototype.getSDFObj = function () {
          ...
          return PDFNet.sendWithPromise("Field.getSDFObj", { field: this }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Field.prototype.getOpt = function (index) {
          ...
          return PDFNet.sendWithPromise("Field.getOpt", { field: this, index: index })
        }
        PDFNet.Field.prototype.isLockedByDigitalSignature = function () {
          ...
          return PDFNet.sendWithPromise("Field.isLockedByDigitalSignature", { field: this })
        }
        ...
        PDFNet.FDFDoc.createFromStream = function (stream) {
          checkArguments(arguments.length, 1, "createFromStream", "(PDFNet.Filter)", [
        ...
        PDFNet.FDFDoc.prototype.saveMemoryBuffer = function () {
          return PDFNet.sendWithPromise("FDFDoc.saveMemoryBuffer", { doc: this.id }).then(function (
            id
          ) {
        ...
        PDFNet.FDFDoc.prototype.getTrailer = function () {
          return PDFNet.sendWithPromise("FDFDoc.getTrailer", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.FDFDoc.prototype.getRoot = function () {
          return PDFNet.sendWithPromise("FDFDoc.getRoot", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.FDFDoc.prototype.getPDFFileName = function () {
          return PDFNet.sendWithPromise("FDFDoc.getPDFFileName", { doc: this.id })
        }
        ...
        PDFNet.FDFDoc.prototype.setID = function (id) {
          ...
          return PDFNet.sendWithPromise("FDFDoc.setID", { doc: this.id, id: id.id })
        }
        PDFNet.FDFDoc.prototype.getFieldIteratorBegin = function () {
          return PDFNet.sendWithPromise("FDFDoc.getFieldIteratorBegin", { doc: this.id }).then(
            function (id) {
        ...
        PDFNet.FDFDoc.prototype.getSDFDoc = function () {
          return PDFNet.sendWithPromise("FDFDoc.getSDFDoc", { doc: this.id }).then(function (id) {
        ...
        PDFNet.FDFDoc.createFromXFDF = function (file_name) {
          ...
          return PDFNet.sendWithPromise("fdfDocCreateFromXFDF", { file_name: file_name }).then(
            function (id) {
              return createDestroyableObj(PDFNet.FDFDoc, id)
            }
          )
        ...
        PDFNet.FDFDoc.prototype.saveAsXFDFAsString = function () {
          return PDFNet.sendWithPromise("FDFDoc.saveAsXFDFAsString", { doc: this.id })
        }
        ...
        PDFNet.FDFField.prototype.getValue = function () {
          ...
          return PDFNet.sendWithPromise("FDFField.getValue", { field: this }).then(function (id) {
            me.yieldFunction = void 0
            id.result = createPDFNetObj(PDFNet.Obj, id.result)
            copyFunc(id.field, me)
            return id.result
        ...
        PDFNet.FDFField.prototype.setValue = function (value) {
          ...
          return PDFNet.sendWithPromise("FDFField.setValue", { field: this, value: value.id }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.FDFField.prototype.getName = function () {
          ...
          return PDFNet.sendWithPromise("FDFField.getName", { field: this }).then(function (id) {
            me.yieldFunction = void 0
            copyFunc(id.field, me)
            return id.result
          })
        ...
        PDFNet.FDFField.prototype.getPartialName = function () {
          ...
          return PDFNet.sendWithPromise("FDFField.getPartialName", { field: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id.field, me)
        ...
        PDFNet.FDFField.prototype.getSDFObj = function () {
          checkThisYieldFunction("getSDFObj", this.yieldFunction)
          return PDFNet.sendWithPromise("FDFField.getSDFObj", { field: this }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Filter.createImage2RGBFromElement = function (elem) {
          checkArguments(arguments.length, 1, "createImage2RGBFromElement", "(PDFNet.Element)", [
            [elem, "Object", PDFNet.Element, "Element"],
          ])
          return PDFNet.sendWithPromise("filterCreateImage2RGBFromElement", { elem: elem.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.Filter, id)
            }
          )
        ...
        PDFNet.Filter.createImage2RGBFromObj = function (obj) {
          checkArguments(arguments.length, 1, "createImage2RGBFromObj", "(PDFNet.Obj)", [
            [obj, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("filterCreateImage2RGBFromObj", { obj: obj.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.Filter, id)
            }
          )
        ...
        PDFNet.Filter.createImage2RGB = function (img) {
          checkArguments(arguments.length, 1, "createImage2RGB", "(PDFNet.Image)", [
            [img, "Object", PDFNet.Image, "Image"],
          ])
          return PDFNet.sendWithPromise("filterCreateImage2RGB", { img: img.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.Filter, id)
          })
        ...
        PDFNet.Filter.prototype.attachFilter = function (attach_filter) {
          checkArguments(arguments.length, 1, "attachFilter", "(PDFNet.Filter)", [
        ...
        PDFNet.Filter.prototype.releaseAttachedFilter = function () {
          return PDFNet.sendWithPromise("Filter.releaseAttachedFilter", { filter: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.Filter, id)
            }
          )
        ...
        PDFNet.Filter.prototype.getAttachedFilter = function () {
          return PDFNet.sendWithPromise("Filter.getAttachedFilter", { filter: this.id }).then(
            function (id) {
        ...
        PDFNet.Filter.prototype.getSourceFilter = function () {
          return PDFNet.sendWithPromise("Filter.getSourceFilter", { filter: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Filter, id)
            }
          )
        ...
        PDFNet.Filter.prototype.getDecodeName = function () {
          return PDFNet.sendWithPromise("Filter.getDecodeName", { filter: this.id })
        }
        ...
        PDFNet.Filter.prototype.consume = function (num_bytes) {
          ...
          return PDFNet.sendWithPromise("Filter.consume", { filter: this.id, num_bytes: num_bytes })
        }
        ...
        PDFNet.Filter.prototype.setStreamLength = function (bytes) {
          ...
          return PDFNet.sendWithPromise("Filter.setStreamLength", { filter: this.id, bytes: bytes })
        }
        ...
        PDFNet.Filter.prototype.isInputFilter = function () {
          return PDFNet.sendWithPromise("Filter.isInputFilter", { filter: this.id })
        }
        ...
        PDFNet.Filter.prototype.createInputIterator = function () {
          return PDFNet.sendWithPromise("Filter.createInputIterator", { filter: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.Filter, id)
            }
          )
        ...
        PDFNet.Filter.prototype.getFilePath = function () {
          return PDFNet.sendWithPromise("Filter.getFilePath", { filter: this.id })
        }
        PDFNet.Filter.prototype.memoryFilterGetBuffer = function () {
          return PDFNet.sendWithPromise("Filter.memoryFilterGetBuffer", { filter: this.id })
        }
        PDFNet.Filter.prototype.memoryFilterSetAsInputFilter = function () {
          return PDFNet.sendWithPromise("Filter.memoryFilterSetAsInputFilter", { filter: this.id })
        }
        PDFNet.Filter.prototype.memoryFilterReset = function () {
          return PDFNet.sendWithPromise("Filter.memoryFilterReset", { filter: this.id })
        }
        PDFNet.FilterReader.create = function (filter) {
          ...
          return PDFNet.sendWithPromise("filterReaderCreate", { filter: filter.id }).then(function (
            id
          ) {
        ...
        PDFNet.FilterReader.prototype.getAttachedFilter = function () {
          return PDFNet.sendWithPromise("FilterReader.getAttachedFilter", { reader: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Filter, id)
            }
          )
        ...
        PDFNet.FilterReader.prototype.tell = function () {
          return PDFNet.sendWithPromise("FilterReader.tell", { reader: this.id })
        }
        PDFNet.FilterReader.prototype.count = function () {
          return PDFNet.sendWithPromise("FilterReader.count", { reader: this.id })
        }
        PDFNet.FilterReader.prototype.flush = function () {
          return PDFNet.sendWithPromise("FilterReader.flush", { reader: this.id })
        }
        PDFNet.FilterReader.prototype.flushAll = function () {
          return PDFNet.sendWithPromise("FilterReader.flushAll", { reader: this.id })
        }
        ...
        PDFNet.FilterReader.prototype.peek = function () {
          return PDFNet.sendWithPromise("FilterReader.peek", { reader: this.id })
        }
        PDFNet.FilterWriter.create = function (filter) {
          checkArguments(arguments.length, 1, "create", "(PDFNet.Filter)", [
            [filter, "Object", PDFNet.Filter, "Filter"],
          ])
          return PDFNet.sendWithPromise("filterWriterCreate", { filter: filter.id }).then(function (
            id
          ) {
        ...
        PDFNet.FilterWriter.prototype.getAttachedFilter = function () {
          return PDFNet.sendWithPromise("FilterWriter.getAttachedFilter", { writer: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Filter, id)
            }
          )
        ...
        PDFNet.FilterWriter.prototype.writeBuffer = function (buf) {
          checkArguments(arguments.length, 1, "writeBuffer", "(ArrayBuffer|TypedArray)", [
            [buf, "ArrayBuffer"],
          ])
          var bufArrayBuffer = getArrayBuffer(buf, !1)
        ...
        PDFNet.OCG.create = function (pdfdoc, name) {
          ...
          return PDFNet.sendWithPromise("ocgCreate", { pdfdoc: pdfdoc.id, name: name }).then(
            function (id) {
        ...
        PDFNet.OCG.createFromObj = function (ocg_dict) {
          ...
          return PDFNet.sendWithPromise("ocgCreateFromObj", { ocg_dict: ocg_dict.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.OCG, id)
            }
          )
        ...
        PDFNet.OCG.prototype.setName = function (value) {
          ...
          return PDFNet.sendWithPromise("OCG.setName", { c: this.id, value: value })
        }
        ...
        PDFNet.OCG.prototype.setIntent = function (value) {
          ...
          return PDFNet.sendWithPromise("OCG.setIntent", { c: this.id, value: value.id })
        }
        ...
        PDFNet.OCG.prototype.getUsage = function (key) {
          ...
          return PDFNet.sendWithPromise("OCG.getUsage", { c: this.id, key: key }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.OCG.prototype.getCurrentState = function (ctx) {
          checkArguments(arguments.length, 1, "getCurrentState", "(PDFNet.OCGContext)", [
            [ctx, "Object", PDFNet.OCGContext, "OCGContext"],
          ])
          return PDFNet.sendWithPromise("OCG.getCurrentState", { c: this.id, ctx: ctx.id })
        }
        ...
        PDFNet.OCG.prototype.getInitialState = function (cfg) {
          checkArguments(arguments.length, 1, "getInitialState", "(PDFNet.OCGConfig)", [
            [cfg, "Object", PDFNet.OCGConfig, "OCGConfig"],
          ])
          return PDFNet.sendWithPromise("OCG.getInitialState", { c: this.id, cfg: cfg.id })
        }
        ...
        PDFNet.OCG.prototype.isLocked = function (cfg) {
          checkArguments(arguments.length, 1, "isLocked", "(PDFNet.OCGConfig)", [
            [cfg, "Object", PDFNet.OCGConfig, "OCGConfig"],
          ])
          return PDFNet.sendWithPromise("OCG.isLocked", { c: this.id, cfg: cfg.id })
        }
        PDFNet.OCG.prototype.setLocked = function (cfg, state) {
          ...
          return PDFNet.sendWithPromise("OCG.setLocked", { c: this.id, cfg: cfg.id, state: state })
        }
        PDFNet.OCGConfig.createFromObj = function (dict) {
          checkArguments(arguments.length, 1, "createFromObj", "(PDFNet.Obj)", [
            [dict, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("ocgConfigCreateFromObj", { dict: dict.id }).then(function (
            id
          ) {
        ...
        PDFNet.OCGConfig.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("OCGConfig.getSDFObj", { c: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.OCGConfig.prototype.getOrder = function () {
          return PDFNet.sendWithPromise("OCGConfig.getOrder", { c: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.OCGConfig.prototype.setOrder = function (value) {
          ...
          return PDFNet.sendWithPromise("OCGConfig.setOrder", { c: this.id, value: value.id })
        }
        ...
        PDFNet.OCGConfig.prototype.setName = function (value) {
          checkArguments(arguments.length, 1, "setName", "(string)", [[value, "string"]])
          return PDFNet.sendWithPromise("OCGConfig.setName", { c: this.id, value: value })
        }
        ...
        PDFNet.OCGConfig.prototype.setCreator = function (value) {
          ...
          return PDFNet.sendWithPromise("OCGConfig.setCreator", { c: this.id, value: value })
        }
        PDFNet.OCGConfig.prototype.getInitBaseState = function () {
          return PDFNet.sendWithPromise("OCGConfig.getInitBaseState", { c: this.id })
        }
        PDFNet.OCGConfig.prototype.setInitBaseState = function (value) {
          ...
          return PDFNet.sendWithPromise("OCGConfig.setInitBaseState", { c: this.id, value: value })
        }
        PDFNet.OCGConfig.prototype.getInitOnStates = function () {
          return PDFNet.sendWithPromise("OCGConfig.getInitOnStates", { c: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.OCGConfig.prototype.setInitOnStates = function (value) {
          checkArguments(arguments.length, 1, "setInitOnStates", "(PDFNet.Obj)", [
            [value, "Object", PDFNet.Obj, "Obj"],
          ])
        ...
        PDFNet.OCGConfig.prototype.getInitOffStates = function () {
          return PDFNet.sendWithPromise("OCGConfig.getInitOffStates", { c: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.OCGConfig.prototype.setInitOffStates = function (value) {
          checkArguments(arguments.length, 1, "setInitOffStates", "(PDFNet.Obj)", [
            [value, "Object", PDFNet.Obj, "Obj"],
          ])
        ...
        PDFNet.OCGConfig.prototype.getIntent = function () {
          return PDFNet.sendWithPromise("OCGConfig.getIntent", { c: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.OCGConfig.prototype.setIntent = function (value) {
          ...
          return PDFNet.sendWithPromise("OCGConfig.setIntent", { c: this.id, value: value.id })
        }
        PDFNet.OCGConfig.prototype.getLockedOCGs = function () {
          return PDFNet.sendWithPromise("OCGConfig.getLockedOCGs", { c: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.OCGConfig.prototype.setLockedOCGs = function (value) {
          ...
          return PDFNet.sendWithPromise("OCGConfig.setLockedOCGs", { c: this.id, value: value.id })
        }
        PDFNet.OCGContext.createFromConfig = function (cfg) {
          checkArguments(arguments.length, 1, "createFromConfig", "(PDFNet.OCGConfig)", [
            [cfg, "Object", PDFNet.OCGConfig, "OCGConfig"],
          ])
          return PDFNet.sendWithPromise("ocgContextCreateFromConfig", { cfg: cfg.id }).then(
            function (id) {
        ...
        PDFNet.OCGContext.prototype.getState = function (grp) {
          ...
          return PDFNet.sendWithPromise("OCGContext.getState", { c: this.id, grp: grp.id })
        }
        ...
        PDFNet.OCGContext.prototype.resetStates = function (all_on) {
          ...
          return PDFNet.sendWithPromise("OCGContext.resetStates", { c: this.id, all_on: all_on })
        }
        ...
        PDFNet.OCGContext.prototype.getNonOCDrawing = function () {
          return PDFNet.sendWithPromise("OCGContext.getNonOCDrawing", { c: this.id })
        }
        ...
        PDFNet.OCMD.createFromObj = function (ocmd_dict) {
          ...
          return PDFNet.sendWithPromise("ocmdCreateFromObj", { ocmd_dict: ocmd_dict.id }).then(
            function (id) {
        ...
        PDFNet.OCMD.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("OCMD.getSDFObj", { ocmd: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.OCMD.prototype.getVisibilityExpression = function () {
          return PDFNet.sendWithPromise("OCMD.getVisibilityExpression", { ocmd: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.OCMD.prototype.isCurrentlyVisible = function (ctx) {
          checkArguments(arguments.length, 1, "isCurrentlyVisible", "(PDFNet.OCGContext)", [
            [ctx, "Object", PDFNet.OCGContext, "OCGContext"],
          ])
          return PDFNet.sendWithPromise("OCMD.isCurrentlyVisible", { ocmd: this.id, ctx: ctx.id })
        }
        PDFNet.OCMD.prototype.getVisibilityPolicy = function () {
          return PDFNet.sendWithPromise("OCMD.getVisibilityPolicy", { ocmd: this.id })
        }
        PDFNet.OCMD.prototype.setVisibilityPolicy = function (vis_policy) {
          checkArguments(arguments.length, 1, "setVisibilityPolicy", "(number)", [
            [vis_policy, "number"],
          ])
        ...
        PDFNet.PDFACompliance.prototype.getErrorCount = function () {
          return PDFNet.sendWithPromise("PDFACompliance.getErrorCount", { pdfac: this.id })
        }
        PDFNet.PDFACompliance.prototype.getError = function (idx) {
          checkArguments(arguments.length, 1, "getError", "(number)", [[idx, "number"]])
          return PDFNet.sendWithPromise("PDFACompliance.getError", { pdfac: this.id, idx: idx })
        }
        PDFNet.PDFACompliance.prototype.getRefObjCount = function (id) {
          ...
          return PDFNet.sendWithPromise("PDFACompliance.getRefObjCount", { pdfac: this.id, id: id })
        }
        ...
        PDFNet.PDFACompliance.getPDFAErrorMessage = function (id) {
          ...
          return PDFNet.sendWithPromise("pdfaComplianceGetPDFAErrorMessage", { id: id })
        }
        PDFNet.PDFACompliance.getDeclaredConformance = function (doc) {
          checkArguments(arguments.length, 1, "getDeclaredConformance", "(PDFNet.PDFDoc)", [
            [doc, "PDFDoc"],
          ])
        ...
        PDFNet.AttrObj.create = function (dict) {
          ...
          return PDFNet.sendWithPromise("attrObjCreate", { dict: dict.id }).then(function (id) {
        ...
        PDFNet.AttrObj.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("AttrObj.getSDFObj", { obj: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.ClassMap.create = function (dict) {
          ...
          return PDFNet.sendWithPromise("classMapCreate", { dict: dict.id }).then(function (id) {
        ...
        PDFNet.ClassMap.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("ClassMap.getSDFObj", { map: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.ContentItem.prototype.getParent = function () {
          ...
          return PDFNet.sendWithPromise("ContentItem.getParent", { item: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
        ...
        PDFNet.ContentItem.prototype.getPage = function () {
          ...
          return PDFNet.sendWithPromise("ContentItem.getPage", { item: this }).then(function (id) {
            me.yieldFunction = void 0
        ...
        PDFNet.ContentItem.prototype.getSDFObj = function () {
          checkThisYieldFunction("getSDFObj", this.yieldFunction)
          return PDFNet.sendWithPromise("ContentItem.getSDFObj", { item: this }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.ContentItem.prototype.getContainingStm = function () {
          ...
          return PDFNet.sendWithPromise("ContentItem.getContainingStm", { item: this }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.ContentItem.prototype.getStmOwner = function () {
          ...
          return PDFNet.sendWithPromise("ContentItem.getStmOwner", { item: this }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.ContentItem.prototype.getRefObj = function () {
          ...
          return PDFNet.sendWithPromise("ContentItem.getRefObj", { item: this }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.RoleMap.create = function (dict) {
          ...
          return PDFNet.sendWithPromise("roleMapCreate", { dict: dict.id }).then(function (id) {
        ...
        PDFNet.RoleMap.prototype.getDirectMap = function (type) {
          ...
          return PDFNet.sendWithPromise("RoleMap.getDirectMap", { map: this.id, type: type })
        }
        PDFNet.RoleMap.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("RoleMap.getSDFObj", { map: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.SElement.create = function (dict) {
          ...
          return PDFNet.sendWithPromise("sElementCreate", { dict: dict.id }).then(function (id) {
        ...
        PDFNet.SElement.prototype.isContentItem = function (index) {
          ...
          return PDFNet.sendWithPromise("SElement.isContentItem", { e: this, index: index })
        }
        ...
        PDFNet.SElement.prototype.getAsStructElem = function (index) {
          ...
          return PDFNet.sendWithPromise("SElement.getAsStructElem", { e: this, index: index }).then(
            function (id) {
              return new PDFNet.SElement(id)
            }
          )
        ...
        PDFNet.SElement.prototype.getStructTreeRoot = function () {
          ...
          return PDFNet.sendWithPromise("SElement.getStructTreeRoot", { e: this }).then(function (
            id
          ) {
        ...
        PDFNet.STree.create = function (struct_dict) {
          ...
          return PDFNet.sendWithPromise("sTreeCreate", { struct_dict: struct_dict.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.STree, id)
            }
          )
        ...
        PDFNet.STree.createFromPDFDoc = function (doc) {
          checkArguments(arguments.length, 1, "createFromPDFDoc", "(PDFNet.PDFDoc)", [
            [doc, "PDFDoc"],
          ])
          return PDFNet.sendWithPromise("sTreeCreateFromPDFDoc", { doc: doc.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.STree, id)
          })
        ...
        PDFNet.STree.prototype.getKid = function (index) {
          ...
          return PDFNet.sendWithPromise("STree.getKid", { tree: this.id, index: index }).then(
            function (id) {
              return new PDFNet.SElement(id)
            }
          )
        ...
        PDFNet.STree.prototype.getRoleMap = function () {
          return PDFNet.sendWithPromise("STree.getRoleMap", { tree: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.RoleMap, id)
          })
        }
        PDFNet.STree.prototype.getClassMap = function () {
          return PDFNet.sendWithPromise("STree.getClassMap", { tree: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.ClassMap, id)
          })
        }
        PDFNet.STree.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("STree.getSDFObj", { tree: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.Action.createGoto = function (dest) {
          checkArguments(arguments.length, 1, "createGoto", "(PDFNet.Destination)", [
            [dest, "Object", PDFNet.Destination, "Destination"],
          ])
          return PDFNet.sendWithPromise("actionCreateGoto", { dest: dest.id }).then(function (id) {
        ...
        PDFNet.Action.createURI = function (sdfdoc, uri) {
          ...
          return PDFNet.sendWithPromise("actionCreateURI", { sdfdoc: sdfdoc.id, uri: uri }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Action, id)
            }
          )
        ...
        PDFNet.Action.createSubmitForm = function (url) {
          checkArguments(arguments.length, 1, "createSubmitForm", "(PDFNet.FileSpec)", [
            [url, "Object", PDFNet.FileSpec, "FileSpec"],
          ])
          return PDFNet.sendWithPromise("actionCreateSubmitForm", { url: url.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Action, id)
          })
        ...
        PDFNet.Action.createResetForm = function (sdfdoc) {
          checkArguments(arguments.length, 1, "createResetForm", "(PDFNet.SDFDoc)", [
            [sdfdoc, "SDFDoc"],
          ])
          return PDFNet.sendWithPromise("actionCreateResetForm", { sdfdoc: sdfdoc.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Action, id)
            }
          )
        ...
        PDFNet.Action.create = function (in_obj) {
          ...
          return PDFNet.sendWithPromise("actionCreate", { in_obj: in_obj.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Action, id)
          })
        }
        PDFNet.Action.prototype.copy = function () {
          return PDFNet.sendWithPromise("Action.copy", { in_action: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Action, id)
          })
        }
        ...
        PDFNet.Action.prototype.getDest = function () {
          return PDFNet.sendWithPromise("Action.getDest", { action: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Destination, id)
          })
        }
        PDFNet.Action.prototype.getNext = function () {
          return PDFNet.sendWithPromise("Action.getNext", { action: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.Action.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("Action.getSDFObj", { action: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Action.prototype.getFormActionFlag = function (flag) {
          ...
          return PDFNet.sendWithPromise("Action.getFormActionFlag", { action: this.id, flag: flag })
        }
        ...
        PDFNet.Action.prototype.needsWriteLock = function () {
          return PDFNet.sendWithPromise("Action.needsWriteLock", { action: this.id })
        }
        ...
        PDFNet.KeyStrokeActionResult.prototype.isValid = function () {
          return PDFNet.sendWithPromise("KeyStrokeActionResult.isValid", { action_ret: this.id })
        }
        PDFNet.KeyStrokeActionResult.prototype.getText = function () {
          return PDFNet.sendWithPromise("KeyStrokeActionResult.getText", { action_ret: this.id })
        }
        PDFNet.KeyStrokeActionResult.prototype.copy = function () {
          return PDFNet.sendWithPromise("KeyStrokeActionResult.copy", { action_ret: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.KeyStrokeActionResult, id)
            }
          )
        ...
        PDFNet.KeyStrokeEventData.prototype.copy = function () {
          return PDFNet.sendWithPromise("KeyStrokeEventData.copy", { data: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.KeyStrokeEventData, id)
            }
          )
        ...
        PDFNet.Page.create = function (page_dict) {
          ...
          return PDFNet.sendWithPromise("pageCreate", { page_dict: page_dict.id }).then(function (
            id
          ) {
        ...
        PDFNet.Page.prototype.getBox = function (type) {
          ...
          return PDFNet.sendWithPromise("Page.getBox", { page: this.id, type: type }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.Page.prototype.setBox = function (type, box) {
          ...
          return PDFNet.sendWithPromise("Page.setBox", { page: this.id, type: type, box: box })
        }
        PDFNet.Page.prototype.getCropBox = function () {
          return PDFNet.sendWithPromise("Page.getCropBox", { page: this.id }).then(function (id) {
            return new PDFNet.Rect(id)
          })
        }
        PDFNet.Page.prototype.setCropBox = function (box) {
          ...
          return PDFNet.sendWithPromise("Page.setCropBox", { page: this.id, box: box })
        }
        PDFNet.Page.prototype.getMediaBox = function () {
          return PDFNet.sendWithPromise("Page.getMediaBox", { page: this.id }).then(function (id) {
            return new PDFNet.Rect(id)
          })
        }
        PDFNet.Page.prototype.setMediaBox = function (box) {
          ...
          return PDFNet.sendWithPromise("Page.setMediaBox", { page: this.id, box: box })
        }
        PDFNet.Page.prototype.getVisibleContentBox = function () {
          return PDFNet.sendWithPromise("Page.getVisibleContentBox", { page: this.id }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.Page.prototype.setRotation = function (angle) {
          ...
          return PDFNet.sendWithPromise("Page.setRotation", { page: this.id, angle: angle })
        }
        ...
        PDFNet.Page.subtractRotations = function (r0, r1) {
          ...
          return PDFNet.sendWithPromise("pageSubtractRotations", { r0: r0, r1: r1 })
        }
        ...
        PDFNet.Page.prototype.getPageWidth = function (box_type) {
          ...
          return PDFNet.sendWithPromise("Page.getPageWidth", { page: this.id, box_type: box_type })
        }
        PDFNet.Page.prototype.getPageHeight = function (box_type) {
          ...
          return PDFNet.sendWithPromise("Page.getPageHeight", { page: this.id, box_type: box_type })
        }
        ...
        PDFNet.Page.prototype.getAnnots = function () {
          return PDFNet.sendWithPromise("Page.getAnnots", { page: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Page.prototype.getAnnot = function (index) {
          ...
          return PDFNet.sendWithPromise("Page.getAnnot", { page: this.id, index: index }).then(
            function (id) {
        ...
        PDFNet.Page.prototype.annotPushBack = function (annot) {
          checkArguments(arguments.length, 1, "annotPushBack", "(PDFNet.Annot)", [
            [annot, "Object", PDFNet.Annot, "Annot"],
          ])
          return PDFNet.sendWithPromise("Page.annotPushBack", { page: this.id, annot: annot.id })
        }
        PDFNet.Page.prototype.annotPushFront = function (annot) {
          checkArguments(arguments.length, 1, "annotPushFront", "(PDFNet.Annot)", [
            [annot, "Object", PDFNet.Annot, "Annot"],
          ])
          return PDFNet.sendWithPromise("Page.annotPushFront", { page: this.id, annot: annot.id })
        }
        PDFNet.Page.prototype.annotRemove = function (annot) {
          checkArguments(arguments.length, 1, "annotRemove", "(PDFNet.Annot)", [
            [annot, "Object", PDFNet.Annot, "Annot"],
          ])
          return PDFNet.sendWithPromise("Page.annotRemove", { page: this.id, annot: annot.id })
        }
        PDFNet.Page.prototype.annotRemoveByIndex = function (index) {
          ...
          return PDFNet.sendWithPromise("Page.annotRemoveByIndex", { page: this.id, index: index })
        }
        PDFNet.Page.prototype.scale = function (scale) {
          checkArguments(arguments.length, 1, "scale", "(number)", [[scale, "number"]])
          return PDFNet.sendWithPromise("Page.scale", { page: this.id, scale: scale })
        }
        PDFNet.Page.prototype.flattenField = function (field_to_flatten) {
          checkArguments(arguments.length, 1, "flattenField", "(PDFNet.Field)", [
        ...
        PDFNet.Page.prototype.getUserUnitSize = function () {
          return PDFNet.sendWithPromise("Page.getUserUnitSize", { page: this.id })
        }
        ...
        PDFNet.Page.prototype.getResourceDict = function () {
          return PDFNet.sendWithPromise("Page.getResourceDict", { page: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Page.prototype.getContents = function () {
          return PDFNet.sendWithPromise("Page.getContents", { page: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.Page.prototype.getThumb = function () {
          return PDFNet.sendWithPromise("Page.getThumb", { page: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.Page.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("Page.getSDFObj", { page: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Annot.create = function (doc, type, pos) {
          ...
          return PDFNet.sendWithPromise("annotCreate", { doc: doc.id, type: type, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Annot, id)
            }
          )
        ...
        PDFNet.Annot.prototype.compare = function (d) {
          ...
          return PDFNet.sendWithPromise("Annot.compare", { annot: this.id, d: d.id })
        }
        ...
        PDFNet.Annot.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("Annot.getSDFObj", { annot: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Annot.prototype.getRect = function () {
          return PDFNet.sendWithPromise("Annot.getRect", { annot: this.id }).then(function (id) {
            return new PDFNet.Rect(id)
          })
        }
        PDFNet.Annot.prototype.getVisibleContentBox = function () {
          return PDFNet.sendWithPromise("Annot.getVisibleContentBox", { annot: this.id }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.Annot.prototype.setRect = function (pos) {
          ...
          return PDFNet.sendWithPromise("Annot.setRect", { annot: this.id, pos: pos })
        }
        PDFNet.Annot.prototype.resize = function (newrect) {
          ...
          return PDFNet.sendWithPromise("Annot.resize", { annot: this.id, newrect: newrect })
        }
        PDFNet.Annot.prototype.setContents = function (contents) {
          checkArguments(arguments.length, 1, "setContents", "(string)", [[contents, "string"]])
          return PDFNet.sendWithPromise("Annot.setContents", { annot: this.id, contents: contents })
        }
        ...
        PDFNet.Annot.prototype.getCustomData = function (key) {
          ...
          return PDFNet.sendWithPromise("Annot.getCustomData", { annot: this.id, key: key })
        }
        ...
        PDFNet.Annot.prototype.deleteCustomData = function (key) {
          ...
          return PDFNet.sendWithPromise("Annot.deleteCustomData", { annot: this.id, key: key })
        }
        PDFNet.Annot.prototype.getPage = function () {
          return PDFNet.sendWithPromise("Annot.getPage", { annot: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Page, id)
          })
        }
        PDFNet.Annot.prototype.setPage = function (page) {
          ...
          return PDFNet.sendWithPromise("Annot.setPage", { annot: this.id, page: page.id })
        }
        PDFNet.Annot.prototype.getUniqueID = function () {
          return PDFNet.sendWithPromise("Annot.getUniqueID", { annot: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Annot.prototype.setUniqueID = function (id) {
          checkArguments(arguments.length, 1, "setUniqueID", "(ArrayBuffer|TypedArray)", [
            [id, "ArrayBuffer"],
          ])
        ...
        PDFNet.Annot.prototype.getDate = function () {
          return PDFNet.sendWithPromise("Annot.getDate", { annot: this.id }).then(function (id) {
        ...
        PDFNet.Annot.prototype.setDate = function (date) {
          ...
          return PDFNet.sendWithPromise("Annot.setDate", { annot: this.id, date: date })
        }
        PDFNet.Annot.prototype.getFlag = function (flag) {
          checkArguments(arguments.length, 1, "getFlag", "(number)", [[flag, "number"]])
          return PDFNet.sendWithPromise("Annot.getFlag", { annot: this.id, flag: flag })
        }
        ...
        PDFNet.AnnotBorderStyle.prototype.copy = function () {
          return PDFNet.sendWithPromise("AnnotBorderStyle.copy", { bs: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.AnnotBorderStyle, id)
          })
        ...
        PDFNet.AnnotBorderStyle.prototype.getStyle = function () {
          return PDFNet.sendWithPromise("AnnotBorderStyle.getStyle", { bs: this.id })
        }
        PDFNet.AnnotBorderStyle.prototype.setStyle = function (style) {
          checkArguments(arguments.length, 1, "setStyle", "(number)", [[style, "number"]])
          return PDFNet.sendWithPromise("AnnotBorderStyle.setStyle", { bs: this.id, style: style })
        }
        ...
        PDFNet.Annot.prototype.flatten = function (page) {
          ...
          return PDFNet.sendWithPromise("Annot.flatten", { annot: this.id, page: page.id })
        }
        PDFNet.Annot.prototype.getActiveAppearanceState = function () {
          return PDFNet.sendWithPromise("Annot.getActiveAppearanceState", { annot: this.id })
        }
        PDFNet.Annot.prototype.setActiveAppearanceState = function (astate) {
          checkArguments(arguments.length, 1, "setActiveAppearanceState", "(string)", [
            [astate, "string"],
          ])
        ...
        PDFNet.Annot.prototype.getColor = function () {
          return PDFNet.sendWithPromise("Annot.getColor", { annot: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        }
        PDFNet.Annot.prototype.getColorAsRGB = function () {
          return PDFNet.sendWithPromise("Annot.getColorAsRGB", { annot: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        ...
        PDFNet.Annot.prototype.getColorAsCMYK = function () {
          return PDFNet.sendWithPromise("Annot.getColorAsCMYK", { annot: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        ...
        PDFNet.Annot.prototype.getColorAsGray = function () {
          return PDFNet.sendWithPromise("Annot.getColorAsGray", { annot: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        ...
        PDFNet.Annot.prototype.getColorCompNum = function () {
          return PDFNet.sendWithPromise("Annot.getColorCompNum", { annot: this.id })
        }
        PDFNet.Annot.prototype.setColorDefault = function (col) {
          checkArguments(arguments.length, 1, "setColorDefault", "(PDFNet.ColorPt)", [
            [col, "Object", PDFNet.ColorPt, "ColorPt"],
          ])
          return PDFNet.sendWithPromise("Annot.setColorDefault", { annot: this.id, col: col.id })
        }
        ...
        PDFNet.Annot.prototype.getStructParent = function () {
          return PDFNet.sendWithPromise("Annot.getStructParent", { annot: this.id })
        }
        ...
        PDFNet.Annot.prototype.getOptionalContent = function () {
          return PDFNet.sendWithPromise("Annot.getOptionalContent", { annot: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Annot.prototype.setOptionalContent = function (content) {
          checkArguments(arguments.length, 1, "setOptionalContent", "(PDFNet.Obj)", [
        ...
        PDFNet.Annot.prototype.refreshAppearance = function () {
          return PDFNet.sendWithPromise("Annot.refreshAppearance", { annot: this.id })
        }
        ...
        PDFNet.Annot.prototype.setRotation = function (angle) {
          checkArguments(arguments.length, 1, "setRotation", "(number)", [[angle, "number"]])
          return PDFNet.sendWithPromise("Annot.setRotation", { annot: this.id, angle: angle })
        }
        PDFNet.AnnotBorderStyle.prototype.getWidth = function () {
          return PDFNet.sendWithPromise("AnnotBorderStyle.getWidth", { bs: this.id })
        }
        PDFNet.AnnotBorderStyle.prototype.setWidth = function (width) {
          checkArguments(arguments.length, 1, "setWidth", "(number)", [[width, "number"]])
          return PDFNet.sendWithPromise("AnnotBorderStyle.setWidth", { bs: this.id, width: width })
        }
        PDFNet.AnnotBorderStyle.prototype.getHR = function () {
          return PDFNet.sendWithPromise("AnnotBorderStyle.getHR", { bs: this.id })
        }
        ...
        PDFNet.AnnotBorderStyle.prototype.getVR = function () {
          return PDFNet.sendWithPromise("AnnotBorderStyle.getVR", { bs: this.id })
        }
        ...
        PDFNet.AnnotBorderStyle.prototype.getDashPattern = function () {
          return PDFNet.sendWithPromise("AnnotBorderStyle.getDashPattern", { bs: this.id }).then(
            function (id) {
        ...
        PDFNet.Annot.prototype.getBorderStyle = function () {
          return PDFNet.sendWithPromise("Annot.getBorderStyle", { annot: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.AnnotBorderStyle, id)
          })
        ...
        PDFNet.Annot.setBorderStyleStyle = function (bs, bst) {
          ...
          return PDFNet.sendWithPromise("annotSetBorderStyleStyle", { bs: bs.id, bst: bst })
        }
        PDFNet.AnnotBorderStyle.prototype.compare = function (b) {
          checkArguments(arguments.length, 1, "compare", "(PDFNet.AnnotBorderStyle)", [
        ...
        PDFNet.CaretAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("caretAnnotCreateFromObj", { d: d.id }).then(function (id) {
        ...
        PDFNet.CaretAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("caretAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.CaretAnnot, id)
            }
          )
        ...
        PDFNet.CaretAnnot.create = function (doc, pos) {
          ...
          return PDFNet.sendWithPromise("caretAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.CaretAnnot, id)
            }
          )
        ...
        PDFNet.CaretAnnot.prototype.getSymbol = function () {
          return PDFNet.sendWithPromise("CaretAnnot.getSymbol", { caret: this.id })
        }
        PDFNet.CaretAnnot.prototype.setSymbol = function (symbol) {
          checkArguments(arguments.length, 1, "setSymbol", "(string)", [[symbol, "string"]])
          return PDFNet.sendWithPromise("CaretAnnot.setSymbol", { caret: this.id, symbol: symbol })
        }
        PDFNet.LineAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("lineAnnotCreateFromObj", { d: d.id }).then(function (id) {
        ...
        PDFNet.LineAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("lineAnnotCreateFromAnnot", { ann: ann.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.LineAnnot, id)
          })
        ...
        PDFNet.LineAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("lineAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.LineAnnot, id)
            }
          )
        ...
        PDFNet.LineAnnot.prototype.getStartPoint = function () {
          return PDFNet.sendWithPromise("LineAnnot.getStartPoint", { line: this.id })
        }
        PDFNet.LineAnnot.prototype.setStartPoint = function (sp) {
          checkArguments(arguments.length, 1, "setStartPoint", "(PDFNet.Point)", [
            [sp, "Structure", PDFNet.Point, "Point"],
          ])
          checkParamsYieldFunction("setStartPoint", [[sp, 0]])
          return PDFNet.sendWithPromise("LineAnnot.setStartPoint", { line: this.id, sp: sp })
        }
        PDFNet.LineAnnot.prototype.getEndPoint = function () {
          return PDFNet.sendWithPromise("LineAnnot.getEndPoint", { line: this.id })
        }
        PDFNet.LineAnnot.prototype.setEndPoint = function (ep) {
          ...
          return PDFNet.sendWithPromise("LineAnnot.setEndPoint", { line: this.id, ep: ep })
        }
        PDFNet.LineAnnot.prototype.getStartStyle = function () {
          return PDFNet.sendWithPromise("LineAnnot.getStartStyle", { line: this.id })
        }
        PDFNet.LineAnnot.prototype.setStartStyle = function (ss) {
          checkArguments(arguments.length, 1, "setStartStyle", "(number)", [[ss, "number"]])
          return PDFNet.sendWithPromise("LineAnnot.setStartStyle", { line: this.id, ss: ss })
        }
        PDFNet.LineAnnot.prototype.getEndStyle = function () {
          return PDFNet.sendWithPromise("LineAnnot.getEndStyle", { line: this.id })
        }
        PDFNet.LineAnnot.prototype.setEndStyle = function (es) {
          checkArguments(arguments.length, 1, "setEndStyle", "(number)", [[es, "number"]])
          return PDFNet.sendWithPromise("LineAnnot.setEndStyle", { line: this.id, es: es })
        }
        PDFNet.LineAnnot.prototype.getLeaderLineLength = function () {
          return PDFNet.sendWithPromise("LineAnnot.getLeaderLineLength", { line: this.id })
        }
        PDFNet.LineAnnot.prototype.setLeaderLineLength = function (length) {
          checkArguments(arguments.length, 1, "setLeaderLineLength", "(number)", [
            [length, "number"],
          ])
        ...
        PDFNet.LineAnnot.prototype.setLeaderLineExtensionLength = function (length) {
          checkArguments(arguments.length, 1, "setLeaderLineExtensionLength", "(number)", [
            [length, "number"],
          ])
        ...
        PDFNet.LineAnnot.prototype.getShowCaption = function () {
          return PDFNet.sendWithPromise("LineAnnot.getShowCaption", { line: this.id })
        }
        ...
        PDFNet.LineAnnot.prototype.getIntentType = function () {
          return PDFNet.sendWithPromise("LineAnnot.getIntentType", { line: this.id })
        }
        PDFNet.LineAnnot.prototype.setIntentType = function (it) {
          checkArguments(arguments.length, 1, "setIntentType", "(number)", [[it, "number"]])
          return PDFNet.sendWithPromise("LineAnnot.setIntentType", { line: this.id, it: it })
        }
        PDFNet.LineAnnot.prototype.getCapPos = function () {
          return PDFNet.sendWithPromise("LineAnnot.getCapPos", { line: this.id })
        }
        PDFNet.LineAnnot.prototype.setCapPos = function (it) {
          checkArguments(arguments.length, 1, "setCapPos", "(number)", [[it, "number"]])
          return PDFNet.sendWithPromise("LineAnnot.setCapPos", { line: this.id, it: it })
        }
        PDFNet.LineAnnot.prototype.getLeaderLineOffset = function () {
          return PDFNet.sendWithPromise("LineAnnot.getLeaderLineOffset", { line: this.id })
        }
        PDFNet.LineAnnot.prototype.setLeaderLineOffset = function (length) {
          checkArguments(arguments.length, 1, "setLeaderLineOffset", "(number)", [
            [length, "number"],
          ])
        ...
        PDFNet.LineAnnot.prototype.getTextHOffset = function () {
          return PDFNet.sendWithPromise("LineAnnot.getTextHOffset", { line: this.id })
        }
        ...
        PDFNet.LineAnnot.prototype.getTextVOffset = function () {
          return PDFNet.sendWithPromise("LineAnnot.getTextVOffset", { line: this.id })
        }
        ...
        PDFNet.CircleAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("circleAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.CircleAnnot.createFromAnnot = function (circle) {
          ...
          return PDFNet.sendWithPromise("circleAnnotCreateFromAnnot", { circle: circle.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.CircleAnnot, id)
            }
          )
        ...
        PDFNet.CircleAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("circleAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.CircleAnnot, id)
            }
          )
        ...
        PDFNet.CircleAnnot.prototype.getInteriorColor = function () {
          return PDFNet.sendWithPromise("CircleAnnot.getInteriorColor", { circle: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorPt, id)
            }
          )
        ...
        PDFNet.CircleAnnot.prototype.getInteriorColorCompNum = function () {
          return PDFNet.sendWithPromise("CircleAnnot.getInteriorColorCompNum", { circle: this.id })
        }
        PDFNet.CircleAnnot.prototype.setInteriorColorDefault = function (col) {
          checkArguments(arguments.length, 1, "setInteriorColorDefault", "(PDFNet.ColorPt)", [
            [col, "Object", PDFNet.ColorPt, "ColorPt"],
          ])
        ...
        PDFNet.CircleAnnot.prototype.getContentRect = function () {
          return PDFNet.sendWithPromise("CircleAnnot.getContentRect", { circle: this.id }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.CircleAnnot.prototype.setContentRect = function (cr) {
          checkArguments(arguments.length, 1, "setContentRect", "(PDFNet.Rect)", [
            [cr, "Structure", PDFNet.Rect, "Rect"],
          ])
          checkParamsYieldFunction("setContentRect", [[cr, 0]])
          return PDFNet.sendWithPromise("CircleAnnot.setContentRect", { circle: this.id, cr: cr })
        }
        PDFNet.CircleAnnot.prototype.getPadding = function () {
          return PDFNet.sendWithPromise("CircleAnnot.getPadding", { circle: this.id }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.CircleAnnot.prototype.setPadding = function (cr) {
          ...
          return PDFNet.sendWithPromise("CircleAnnot.setPadding", { circle: this.id, cr: cr })
        }
        PDFNet.FileAttachmentAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("fileAttachmentAnnotCreateFromObj", { d: d.id }).then(
            function (id) {
        ...
        PDFNet.FileAttachmentAnnot.prototype.setFileSpec = function (file) {
          checkArguments(arguments.length, 1, "setFileSpec", "(PDFNet.FileSpec)", [
            [file, "Object", PDFNet.FileSpec, "FileSpec"],
          ])
        ...
        PDFNet.FileAttachmentAnnot.prototype.getIcon = function () {
          return PDFNet.sendWithPromise("FileAttachmentAnnot.getIcon", { fileatt: this.id })
        }
        ...
        PDFNet.FileAttachmentAnnot.prototype.getIconName = function () {
          return PDFNet.sendWithPromise("FileAttachmentAnnot.getIconName", { fileatt: this.id })
        }
        ...
        PDFNet.FreeTextAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("freeTextAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.FreeTextAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("freeTextAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.FreeTextAnnot, id)
            }
          )
        ...
        PDFNet.FreeTextAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("freeTextAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.FreeTextAnnot, id)
            }
          )
        ...
        PDFNet.FreeTextAnnot.prototype.getDefaultAppearance = function () {
          return PDFNet.sendWithPromise("FreeTextAnnot.getDefaultAppearance", { ft: this.id })
        }
        PDFNet.FreeTextAnnot.prototype.setDefaultAppearance = function (app_str) {
          checkArguments(arguments.length, 1, "setDefaultAppearance", "(string)", [
            [app_str, "string"],
          ])
        ...
        PDFNet.FreeTextAnnot.prototype.getQuaddingFormat = function () {
          return PDFNet.sendWithPromise("FreeTextAnnot.getQuaddingFormat", { ft: this.id })
        }
        ...
        PDFNet.FreeTextAnnot.prototype.getCalloutLinePoints = function () {
          return PDFNet.sendWithPromise("FreeTextAnnot.getCalloutLinePoints", { ft: this.id })
        }
        ...
        PDFNet.FreeTextAnnot.prototype.getIntentName = function () {
          return PDFNet.sendWithPromise("FreeTextAnnot.getIntentName", { ft: this.id })
        }
        PDFNet.FreeTextAnnot.prototype.setIntentName = function (mode) {
          ...
          return PDFNet.sendWithPromise("FreeTextAnnot.setIntentName", { ft: this.id, mode: mode })
        }
        PDFNet.FreeTextAnnot.prototype.setIntentNameDefault = function () {
          return PDFNet.sendWithPromise("FreeTextAnnot.setIntentNameDefault", { ft: this.id })
        }
        PDFNet.FreeTextAnnot.prototype.getEndingStyle = function () {
          return PDFNet.sendWithPromise("FreeTextAnnot.getEndingStyle", { ft: this.id })
        }
        ...
        PDFNet.FreeTextAnnot.prototype.getTextColor = function () {
          return PDFNet.sendWithPromise("FreeTextAnnot.getTextColor", { ft: this.id }).then(
            function (id) {
        ...
        PDFNet.FreeTextAnnot.prototype.getLineColor = function () {
          return PDFNet.sendWithPromise("FreeTextAnnot.getLineColor", { ft: this.id }).then(
            function (id) {
              id.color = createDestroyableObj(PDFNet.ColorPt, id.color)
              return id
            }
        ...
        PDFNet.FreeTextAnnot.prototype.getFontSize = function () {
          return PDFNet.sendWithPromise("FreeTextAnnot.getFontSize", { ft: this.id })
        }
        PDFNet.HighlightAnnot.createFromObj = function (d) {
          checkArguments(arguments.length, 1, "createFromObj", "(PDFNet.Obj)", [
            [d, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("highlightAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.HighlightAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("highlightAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.HighlightAnnot, id)
            }
          )
        ...
        PDFNet.HighlightAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("highlightAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.HighlightAnnot, id)
            }
          )
        ...
        PDFNet.InkAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("inkAnnotCreateFromObj", { d: d.id }).then(function (id) {
        ...
        PDFNet.InkAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("inkAnnotCreateFromAnnot", { ann: ann.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.InkAnnot, id)
          })
        ...
        PDFNet.InkAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("inkAnnotCreate", { doc: doc.id, pos: pos }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.InkAnnot, id)
          })
        ...
        PDFNet.InkAnnot.prototype.getPathCount = function () {
          return PDFNet.sendWithPromise("InkAnnot.getPathCount", { ink: this.id })
        }
        ...
        PDFNet.InkAnnot.prototype.getHighlightIntent = function () {
          return PDFNet.sendWithPromise("InkAnnot.getHighlightIntent", { ink: this.id })
        }
        PDFNet.InkAnnot.prototype.setHighlightIntent = function (highlight) {
          checkArguments(arguments.length, 1, "setHighlightIntent", "(boolean)", [
            [highlight, "boolean"],
          ])
        ...
        PDFNet.LinkAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("linkAnnotCreateFromObj", { d: d.id }).then(function (id) {
        ...
        PDFNet.LinkAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("linkAnnotCreateFromAnnot", { ann: ann.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.LinkAnnot, id)
          })
        ...
        PDFNet.LinkAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("linkAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.LinkAnnot, id)
            }
          )
        ...
        PDFNet.LinkAnnot.prototype.removeAction = function () {
          return PDFNet.sendWithPromise("LinkAnnot.removeAction", { link: this.id })
        }
        PDFNet.LinkAnnot.prototype.getAction = function () {
          return PDFNet.sendWithPromise("LinkAnnot.getAction", { link: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Action, id)
          })
        ...
        PDFNet.LinkAnnot.prototype.setAction = function (action) {
          ...
          return PDFNet.sendWithPromise("LinkAnnot.setAction", { link: this.id, action: action.id })
        }
        PDFNet.LinkAnnot.prototype.getHighlightingMode = function () {
          return PDFNet.sendWithPromise("LinkAnnot.getHighlightingMode", { link: this.id })
        }
        PDFNet.LinkAnnot.prototype.setHighlightingMode = function (value) {
          checkArguments(arguments.length, 1, "setHighlightingMode", "(number)", [
            [value, "number"],
          ])
        ...
        PDFNet.LinkAnnot.prototype.getQuadPointCount = function () {
          return PDFNet.sendWithPromise("LinkAnnot.getQuadPointCount", { link: this.id })
        }
        PDFNet.LinkAnnot.prototype.getQuadPoint = function (idx) {
          checkArguments(arguments.length, 1, "getQuadPoint", "(number)", [[idx, "number"]])
          return PDFNet.sendWithPromise("LinkAnnot.getQuadPoint", { link: this.id, idx: idx })
        }
        ...
        PDFNet.MarkupAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("markupAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.MarkupAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("markupAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.MarkupAnnot, id)
            }
          )
        ...
        PDFNet.MarkupAnnot.prototype.getTitle = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getTitle", { markup: this.id })
        }
        PDFNet.MarkupAnnot.prototype.setTitle = function (title) {
          checkArguments(arguments.length, 1, "setTitle", "(string)", [[title, "string"]])
          return PDFNet.sendWithPromise("MarkupAnnot.setTitle", { markup: this.id, title: title })
        }
        ...
        PDFNet.MarkupAnnot.prototype.getPopup = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getPopup", { markup: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Annot, id)
          })
        ...
        PDFNet.MarkupAnnot.prototype.setPopup = function (ppup) {
          ...
          return PDFNet.sendWithPromise("MarkupAnnot.setPopup", { markup: this.id, ppup: ppup.id })
        }
        PDFNet.MarkupAnnot.prototype.getOpacity = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getOpacity", { markup: this.id })
        }
        PDFNet.MarkupAnnot.prototype.setOpacity = function (op) {
          checkArguments(arguments.length, 1, "setOpacity", "(number)", [[op, "number"]])
          return PDFNet.sendWithPromise("MarkupAnnot.setOpacity", { markup: this.id, op: op })
        }
        PDFNet.MarkupAnnot.prototype.getSubject = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getSubject", { markup: this.id })
        }
        ...
        PDFNet.MarkupAnnot.prototype.getCreationDates = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getCreationDates", { markup: this.id }).then(
            function (id) {
              return new PDFNet.Date(id)
            }
          )
        ...
        PDFNet.MarkupAnnot.prototype.getBorderEffect = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getBorderEffect", { markup: this.id })
        }
        ...
        PDFNet.MarkupAnnot.prototype.setBorderEffectIntensity = function (intensity) {
          ...
          checkArguments(arguments.length, 0, "setBorderEffectIntensity", "(number)", [
            [intensity, "number"],
          ])
        ...
        PDFNet.MarkupAnnot.prototype.setCreationDates = function (dt) {
          checkArguments(arguments.length, 1, "setCreationDates", "(PDFNet.Date)", [
            [dt, "Structure", PDFNet.Date, "Date"],
          ])
          checkParamsYieldFunction("setCreationDates", [[dt, 0]])
          return PDFNet.sendWithPromise("MarkupAnnot.setCreationDates", { markup: this.id, dt: dt })
        }
        PDFNet.MarkupAnnot.prototype.getInteriorColor = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getInteriorColor", { markup: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorPt, id)
            }
          )
        ...
        PDFNet.MarkupAnnot.prototype.getInteriorColorCompNum = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getInteriorColorCompNum", { markup: this.id })
        }
        PDFNet.MarkupAnnot.prototype.setInteriorColorRGB = function (col) {
          checkArguments(arguments.length, 1, "setInteriorColorRGB", "(PDFNet.ColorPt)", [
            [col, "Object", PDFNet.ColorPt, "ColorPt"],
          ])
        ...
        PDFNet.MarkupAnnot.prototype.getContentRect = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getContentRect", { markup: this.id }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.MarkupAnnot.prototype.setContentRect = function (cr) {
          ...
          checkParamsYieldFunction("setContentRect", [[cr, 0]])
          return PDFNet.sendWithPromise("MarkupAnnot.setContentRect", { markup: this.id, cr: cr })
        }
        PDFNet.MarkupAnnot.prototype.getPadding = function () {
          return PDFNet.sendWithPromise("MarkupAnnot.getPadding", { markup: this.id }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.MarkupAnnot.prototype.setPadding = function (rd) {
          ...
          return PDFNet.sendWithPromise("MarkupAnnot.setPadding", { markup: this.id, rd: rd })
        }
        ...
        PDFNet.MovieAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("movieAnnotCreateFromObj", { d: d.id }).then(function (id) {
        ...
        PDFNet.MovieAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("movieAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.MovieAnnot, id)
            }
          )
        ...
        PDFNet.MovieAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("movieAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.MovieAnnot, id)
            }
          )
        ...
        PDFNet.MovieAnnot.prototype.getTitle = function () {
          return PDFNet.sendWithPromise("MovieAnnot.getTitle", { movie: this.id })
        }
        PDFNet.MovieAnnot.prototype.setTitle = function (title) {
          checkArguments(arguments.length, 1, "setTitle", "(string)", [[title, "string"]])
          return PDFNet.sendWithPromise("MovieAnnot.setTitle", { movie: this.id, title: title })
        }
        PDFNet.MovieAnnot.prototype.isToBePlayed = function () {
          return PDFNet.sendWithPromise("MovieAnnot.isToBePlayed", { movie: this.id })
        }
        ...
        PDFNet.PolyLineAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("polyLineAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.PolyLineAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("polyLineAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.PolyLineAnnot, id)
            }
          )
        ...
        PDFNet.PolyLineAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("polyLineAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.PolyLineAnnot, id)
            }
          )
        ...
        PDFNet.PolyLineAnnot.prototype.getVertexCount = function () {
          return PDFNet.sendWithPromise("PolyLineAnnot.getVertexCount", { polyline: this.id })
        }
        PDFNet.PolyLineAnnot.prototype.getVertex = function (idx) {
          checkArguments(arguments.length, 1, "getVertex", "(number)", [[idx, "number"]])
          return PDFNet.sendWithPromise("PolyLineAnnot.getVertex", { polyline: this.id, idx: idx })
        }
        ...
        PDFNet.PolyLineAnnot.prototype.getStartStyle = function () {
          return PDFNet.sendWithPromise("PolyLineAnnot.getStartStyle", { polyline: this.id })
        }
        ...
        PDFNet.PolyLineAnnot.prototype.getEndStyle = function () {
          return PDFNet.sendWithPromise("PolyLineAnnot.getEndStyle", { polyline: this.id })
        }
        ...
        PDFNet.PolyLineAnnot.prototype.getIntentName = function () {
          return PDFNet.sendWithPromise("PolyLineAnnot.getIntentName", { polyline: this.id })
        }
        ...
        PDFNet.PolygonAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("polygonAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.PolygonAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("polygonAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.PolygonAnnot, id)
            }
          )
        ...
        PDFNet.PolygonAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("polygonAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.PolygonAnnot, id)
            }
          )
        ...
        PDFNet.PopupAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("popupAnnotCreateFromObj", { d: d.id }).then(function (id) {
        ...
        PDFNet.PopupAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("popupAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.PopupAnnot, id)
            }
          )
        ...
        PDFNet.PopupAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("popupAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.PopupAnnot, id)
            }
          )
        ...
        PDFNet.PopupAnnot.prototype.getParent = function () {
          return PDFNet.sendWithPromise("PopupAnnot.getParent", { popup: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Annot, id)
          })
        ...
        PDFNet.PopupAnnot.prototype.setOpen = function (isopen) {
          ...
          return PDFNet.sendWithPromise("PopupAnnot.setOpen", { popup: this.id, isopen: isopen })
        }
        PDFNet.RedactionAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("redactionAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.RedactionAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("redactionAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.RedactionAnnot, id)
            }
          )
        ...
        PDFNet.RedactionAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("redactionAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.RedactionAnnot, id)
            }
          )
        ...
        PDFNet.RedactionAnnot.prototype.getQuadPointCount = function () {
          return PDFNet.sendWithPromise("RedactionAnnot.getQuadPointCount", { redaction: this.id })
        }
        ...
        PDFNet.RedactionAnnot.prototype.getOverlayText = function () {
          return PDFNet.sendWithPromise("RedactionAnnot.getOverlayText", { redaction: this.id })
        }
        ...
        PDFNet.RedactionAnnot.prototype.getUseRepeat = function () {
          return PDFNet.sendWithPromise("RedactionAnnot.getUseRepeat", { redaction: this.id })
        }
        ...
        PDFNet.RedactionAnnot.prototype.setOverlayTextAppearance = function (app) {
          checkArguments(arguments.length, 1, "setOverlayTextAppearance", "(string)", [
            [app, "string"],
          ])
        ...
        PDFNet.RedactionAnnot.prototype.getQuadForm = function () {
          return PDFNet.sendWithPromise("RedactionAnnot.getQuadForm", { redaction: this.id })
        }
        ...
        PDFNet.RedactionAnnot.prototype.getAppFormXO = function () {
          return PDFNet.sendWithPromise("RedactionAnnot.getAppFormXO", { redaction: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.RubberStampAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("rubberStampAnnotCreateFromObj", { d: d.id }).then(
            function (id) {
        ...
        PDFNet.RubberStampAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("rubberStampAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.RubberStampAnnot, id)
            }
          )
        ...
        PDFNet.RubberStampAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("rubberStampAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.RubberStampAnnot, id)
            }
          )
        ...
        PDFNet.RubberStampAnnot.prototype.getIcon = function () {
          return PDFNet.sendWithPromise("RubberStampAnnot.getIcon", { stamp: this.id })
        }
        PDFNet.RubberStampAnnot.prototype.setIcon = function (type) {
          "undefined" === typeof type && (type = PDFNet.RubberStampAnnot.Icon.e_Draft)
          checkArguments(arguments.length, 0, "setIcon", "(number)", [[type, "number"]])
          return PDFNet.sendWithPromise("RubberStampAnnot.setIcon", { stamp: this.id, type: type })
        }
        PDFNet.RubberStampAnnot.prototype.setIconDefault = function () {
          return PDFNet.sendWithPromise("RubberStampAnnot.setIconDefault", { stamp: this.id })
        }
        PDFNet.RubberStampAnnot.prototype.getIconName = function () {
          return PDFNet.sendWithPromise("RubberStampAnnot.getIconName", { stamp: this.id })
        }
        ...
        PDFNet.ScreenAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("screenAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.ScreenAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("screenAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.ScreenAnnot, id)
            }
          )
        ...
        PDFNet.ScreenAnnot.prototype.setTitle = function (title) {
          checkArguments(arguments.length, 1, "setTitle", "(string)", [[title, "string"]])
          return PDFNet.sendWithPromise("ScreenAnnot.setTitle", { s: this.id, title: title })
        }
        PDFNet.ScreenAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("screenAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.ScreenAnnot, id)
            }
          )
        ...
        PDFNet.ScreenAnnot.prototype.getAction = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getAction", { s: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Action, id)
          })
        ...
        PDFNet.ScreenAnnot.prototype.setAction = function (action) {
          ...
          return PDFNet.sendWithPromise("ScreenAnnot.setAction", { s: this.id, action: action.id })
        }
        PDFNet.ScreenAnnot.prototype.getBorderColor = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getBorderColor", { s: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorPt, id)
            }
          )
        ...
        PDFNet.ScreenAnnot.prototype.getBorderColorCompNum = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getBorderColorCompNum", { s: this.id })
        }
        ...
        PDFNet.ScreenAnnot.prototype.getBackgroundColor = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getBackgroundColor", { s: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorPt, id)
            }
          )
        ...
        PDFNet.ScreenAnnot.prototype.getStaticCaptionText = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getStaticCaptionText", { s: this.id })
        }
        PDFNet.ScreenAnnot.prototype.setStaticCaptionText = function (contents) {
          checkArguments(arguments.length, 1, "setStaticCaptionText", "(string)", [
            [contents, "string"],
          ])
        ...
        PDFNet.ScreenAnnot.prototype.getRolloverCaptionText = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getRolloverCaptionText", { s: this.id })
        }
        PDFNet.ScreenAnnot.prototype.setRolloverCaptionText = function (contents) {
          checkArguments(arguments.length, 1, "setRolloverCaptionText", "(string)", [
            [contents, "string"],
          ])
        ...
        PDFNet.ScreenAnnot.prototype.getMouseDownCaptionText = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getMouseDownCaptionText", { s: this.id })
        }
        PDFNet.ScreenAnnot.prototype.setMouseDownCaptionText = function (contents) {
          checkArguments(arguments.length, 1, "setMouseDownCaptionText", "(string)", [
            [contents, "string"],
          ])
        ...
        PDFNet.ScreenAnnot.prototype.getStaticIcon = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getStaticIcon", { s: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.ScreenAnnot.prototype.setStaticIcon = function (icon) {
          ...
          return PDFNet.sendWithPromise("ScreenAnnot.setStaticIcon", { s: this.id, icon: icon.id })
        }
        PDFNet.ScreenAnnot.prototype.getRolloverIcon = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getRolloverIcon", { s: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.ScreenAnnot.prototype.setRolloverIcon = function (icon) {
          checkArguments(arguments.length, 1, "setRolloverIcon", "(PDFNet.Obj)", [
            [icon, "Object", PDFNet.Obj, "Obj"],
          ])
        ...
        PDFNet.ScreenAnnot.prototype.getMouseDownIcon = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getMouseDownIcon", { s: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.ScreenAnnot.prototype.setMouseDownIcon = function (icon) {
          checkArguments(arguments.length, 1, "setMouseDownIcon", "(PDFNet.Obj)", [
            [icon, "Object", PDFNet.Obj, "Obj"],
          ])
        ...
        PDFNet.ScreenAnnot.prototype.getScaleType = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getScaleType", { s: this.id })
        }
        PDFNet.ScreenAnnot.prototype.setScaleType = function (st) {
          checkArguments(arguments.length, 1, "setScaleType", "(number)", [[st, "number"]])
          return PDFNet.sendWithPromise("ScreenAnnot.setScaleType", { s: this.id, st: st })
        }
        PDFNet.ScreenAnnot.prototype.getIconCaptionRelation = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getIconCaptionRelation", { s: this.id })
        }
        PDFNet.ScreenAnnot.prototype.setIconCaptionRelation = function (icr) {
          checkArguments(arguments.length, 1, "setIconCaptionRelation", "(number)", [
            [icr, "number"],
          ])
        ...
        PDFNet.ScreenAnnot.prototype.getScaleCondition = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getScaleCondition", { s: this.id })
        }
        PDFNet.ScreenAnnot.prototype.setScaleCondition = function (sc) {
          ...
          return PDFNet.sendWithPromise("ScreenAnnot.setScaleCondition", { s: this.id, sc: sc })
        }
        PDFNet.ScreenAnnot.prototype.getFitFull = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getFitFull", { s: this.id })
        }
        PDFNet.ScreenAnnot.prototype.setFitFull = function (ff) {
          checkArguments(arguments.length, 1, "setFitFull", "(boolean)", [[ff, "boolean"]])
          return PDFNet.sendWithPromise("ScreenAnnot.setFitFull", { s: this.id, ff: ff })
        }
        PDFNet.ScreenAnnot.prototype.getHIconLeftOver = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getHIconLeftOver", { s: this.id })
        }
        PDFNet.ScreenAnnot.prototype.setHIconLeftOver = function (hl) {
          ...
          return PDFNet.sendWithPromise("ScreenAnnot.setHIconLeftOver", { s: this.id, hl: hl })
        }
        PDFNet.ScreenAnnot.prototype.getVIconLeftOver = function () {
          return PDFNet.sendWithPromise("ScreenAnnot.getVIconLeftOver", { s: this.id })
        }
        ...
        PDFNet.SoundAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("soundAnnotCreateFromObj", { d: d.id }).then(function (id) {
        ...
        PDFNet.SoundAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("soundAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SoundAnnot, id)
            }
          )
        ...
        PDFNet.SoundAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("soundAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SoundAnnot, id)
            }
          )
        ...
        PDFNet.SoundAnnot.createAtPoint = function (doc, pos) {
          ...
          return PDFNet.sendWithPromise("soundAnnotCreateAtPoint", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SoundAnnot, id)
            }
          )
        ...
        PDFNet.SoundAnnot.prototype.getSoundStream = function () {
          return PDFNet.sendWithPromise("SoundAnnot.getSoundStream", { sound: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.SoundAnnot.prototype.setSoundStream = function (icon) {
          checkArguments(arguments.length, 1, "setSoundStream", "(PDFNet.Obj)", [
            [icon, "Object", PDFNet.Obj, "Obj"],
          ])
        ...
        PDFNet.SoundAnnot.prototype.getIcon = function () {
          return PDFNet.sendWithPromise("SoundAnnot.getIcon", { sound: this.id })
        }
        PDFNet.SoundAnnot.prototype.setIcon = function (type) {
          "undefined" === typeof type && (type = PDFNet.SoundAnnot.Icon.e_Speaker)
          checkArguments(arguments.length, 0, "setIcon", "(number)", [[type, "number"]])
          return PDFNet.sendWithPromise("SoundAnnot.setIcon", { sound: this.id, type: type })
        }
        PDFNet.SoundAnnot.prototype.getIconName = function () {
          return PDFNet.sendWithPromise("SoundAnnot.getIconName", { sound: this.id })
        }
        PDFNet.SoundAnnot.prototype.setIconName = function (type) {
          checkArguments(arguments.length, 1, "setIconName", "(string)", [[type, "string"]])
          return PDFNet.sendWithPromise("SoundAnnot.setIconName", { sound: this.id, type: type })
        }
        PDFNet.SquareAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("squareAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.SquareAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("squareAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SquareAnnot, id)
            }
          )
        ...
        PDFNet.SquareAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("squareAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SquareAnnot, id)
            }
          )
        ...
        PDFNet.SquareAnnot.prototype.getInteriorColor = function () {
          return PDFNet.sendWithPromise("SquareAnnot.getInteriorColor", { square: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorPt, id)
            }
          )
        ...
        PDFNet.SquareAnnot.prototype.getInteriorColorCompNum = function () {
          return PDFNet.sendWithPromise("SquareAnnot.getInteriorColorCompNum", { square: this.id })
        }
        ...
        PDFNet.SquareAnnot.prototype.getContentRect = function () {
          return PDFNet.sendWithPromise("SquareAnnot.getContentRect", { square: this.id }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.SquareAnnot.prototype.setContentRect = function (cr) {
          ...
          checkParamsYieldFunction("setContentRect", [[cr, 0]])
          return PDFNet.sendWithPromise("SquareAnnot.setContentRect", { square: this.id, cr: cr })
        }
        PDFNet.SquareAnnot.prototype.getPadding = function () {
          return PDFNet.sendWithPromise("SquareAnnot.getPadding", { square: this.id }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.SquareAnnot.prototype.setPadding = function (cr) {
          ...
          checkParamsYieldFunction("setPadding", [[cr, 0]])
          return PDFNet.sendWithPromise("SquareAnnot.setPadding", { square: this.id, cr: cr })
        }
        PDFNet.SquigglyAnnot.createFromObj = function (d) {
          checkArguments(arguments.length, 1, "createFromObj", "(PDFNet.Obj)", [
            [d, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("squigglyAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.SquigglyAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("squigglyAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SquigglyAnnot, id)
            }
          )
        ...
        PDFNet.SquigglyAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("squigglyAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SquigglyAnnot, id)
            }
          )
        ...
        PDFNet.StrikeOutAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("strikeOutAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.StrikeOutAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("strikeOutAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.StrikeOutAnnot, id)
            }
          )
        ...
        PDFNet.StrikeOutAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("strikeOutAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.StrikeOutAnnot, id)
            }
          )
        ...
        PDFNet.TextAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("textAnnotCreateFromObj", { d: d.id }).then(function (id) {
        ...
        PDFNet.TextAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("textAnnotCreateFromAnnot", { ann: ann.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.TextAnnot, id)
          })
        ...
        PDFNet.TextAnnot.createAtPoint = function (doc, pos) {
          ...
          checkParamsYieldFunction("createAtPoint", [[pos, 1]])
          return PDFNet.sendWithPromise("textAnnotCreateAtPoint", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.TextAnnot, id)
            }
          )
        ...
        PDFNet.TextAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("textAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.TextAnnot, id)
            }
          )
        ...
        PDFNet.TextAnnot.prototype.setOpen = function (isopen) {
          checkArguments(arguments.length, 1, "setOpen", "(boolean)", [[isopen, "boolean"]])
          return PDFNet.sendWithPromise("TextAnnot.setOpen", { text: this.id, isopen: isopen })
        }
        ...
        PDFNet.TextAnnot.prototype.setIcon = function (icon) {
          ...
          return PDFNet.sendWithPromise("TextAnnot.setIcon", { text: this.id, icon: icon })
        }
        PDFNet.TextAnnot.prototype.setIconDefault = function () {
          return PDFNet.sendWithPromise("TextAnnot.setIconDefault", { text: this.id })
        }
        PDFNet.TextAnnot.prototype.getIconName = function () {
          return PDFNet.sendWithPromise("TextAnnot.getIconName", { text: this.id })
        }
        PDFNet.TextAnnot.prototype.setIconName = function (icon) {
          checkArguments(arguments.length, 1, "setIconName", "(string)", [[icon, "string"]])
          return PDFNet.sendWithPromise("TextAnnot.setIconName", { text: this.id, icon: icon })
        }
        ...
        PDFNet.TextAnnot.prototype.setState = function (state) {
          ...
          return PDFNet.sendWithPromise("TextAnnot.setState", { text: this.id, state: state })
        }
        PDFNet.TextAnnot.prototype.getStateModel = function () {
          return PDFNet.sendWithPromise("TextAnnot.getStateModel", { text: this.id })
        }
        PDFNet.TextAnnot.prototype.setStateModel = function (sm) {
          checkArguments(arguments.length, 1, "setStateModel", "(string)", [[sm, "string"]])
          return PDFNet.sendWithPromise("TextAnnot.setStateModel", { text: this.id, sm: sm })
        }
        PDFNet.TextAnnot.prototype.getAnchorPosition = function (anchor) {
          checkArguments(arguments.length, 1, "getAnchorPosition", "(PDFNet.Point)", [
        ...
        PDFNet.TextAnnot.prototype.setAnchorPosition = function (anchor) {
          checkArguments(arguments.length, 1, "setAnchorPosition", "(PDFNet.Point)", [
            [anchor, "Structure", PDFNet.Point, "Point"],
          ])
        ...
        PDFNet.UnderlineAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("underlineAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.UnderlineAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("underlineAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.UnderlineAnnot, id)
            }
          )
        ...
        PDFNet.UnderlineAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("underlineAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.UnderlineAnnot, id)
            }
          )
        ...
        PDFNet.WatermarkAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("watermarkAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.WatermarkAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("watermarkAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.WatermarkAnnot, id)
            }
          )
        ...
        PDFNet.WatermarkAnnot.create = function (doc, pos) {
          ...
          checkParamsYieldFunction("create", [[pos, 1]])
          return PDFNet.sendWithPromise("watermarkAnnotCreate", { doc: doc.id, pos: pos }).then(
            function (id) {
              return createPDFNetObj(PDFNet.WatermarkAnnot, id)
            }
          )
        ...
        PDFNet.TextMarkupAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("textMarkupAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.TextMarkupAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("textMarkupAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.TextMarkupAnnot, id)
            }
          )
        ...
        PDFNet.WidgetAnnot.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("widgetAnnotCreateFromObj", { d: d.id }).then(function (
            id
          ) {
        ...
        PDFNet.WidgetAnnot.createFromAnnot = function (ann) {
          ...
          return PDFNet.sendWithPromise("widgetAnnotCreateFromAnnot", { ann: ann.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.WidgetAnnot, id)
            }
          )
        ...
        PDFNet.WidgetAnnot.prototype.getField = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getField", { widget: this.id }).then(function (
            id
          ) {
            return new PDFNet.Field(id)
          })
        ...
        PDFNet.WidgetAnnot.prototype.getHighlightingMode = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getHighlightingMode", { widget: this.id })
        }
        PDFNet.WidgetAnnot.prototype.setHighlightingMode = function (value) {
          ...
          checkArguments(arguments.length, 0, "setHighlightingMode", "(number)", [
            [value, "number"],
          ])
        ...
        PDFNet.WidgetAnnot.prototype.getAction = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getAction", { widget: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Action, id)
            }
          )
        ...
        PDFNet.WidgetAnnot.prototype.getBorderColor = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getBorderColor", { widget: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorPt, id)
            }
          )
        ...
        PDFNet.WidgetAnnot.prototype.getBorderColorCompNum = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getBorderColorCompNum", { widget: this.id })
        }
        ...
        PDFNet.WidgetAnnot.prototype.getBackgroundColor = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getBackgroundColor", { widget: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorPt, id)
            }
          )
        ...
        PDFNet.WidgetAnnot.prototype.getStaticCaptionText = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getStaticCaptionText", { widget: this.id })
        }
        ...
        PDFNet.WidgetAnnot.prototype.getRolloverCaptionText = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getRolloverCaptionText", { widget: this.id })
        }
        ...
        PDFNet.WidgetAnnot.prototype.getMouseDownCaptionText = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getMouseDownCaptionText", { widget: this.id })
        }
        ...
        PDFNet.WidgetAnnot.prototype.getStaticIcon = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getStaticIcon", { widget: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.WidgetAnnot.prototype.getRolloverIcon = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getRolloverIcon", { widget: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.WidgetAnnot.prototype.getMouseDownIcon = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getMouseDownIcon", { widget: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.WidgetAnnot.prototype.getScaleType = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getScaleType", { widget: this.id })
        }
        PDFNet.WidgetAnnot.prototype.setScaleType = function (st) {
          checkArguments(arguments.length, 1, "setScaleType", "(number)", [[st, "number"]])
          return PDFNet.sendWithPromise("WidgetAnnot.setScaleType", { widget: this.id, st: st })
        }
        PDFNet.WidgetAnnot.prototype.getIconCaptionRelation = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getIconCaptionRelation", { widget: this.id })
        }
        ...
        PDFNet.WidgetAnnot.prototype.getScaleCondition = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getScaleCondition", { widget: this.id })
        }
        ...
        PDFNet.WidgetAnnot.prototype.getFitFull = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getFitFull", { widget: this.id })
        }
        PDFNet.WidgetAnnot.prototype.setFitFull = function (ff) {
          checkArguments(arguments.length, 1, "setFitFull", "(boolean)", [[ff, "boolean"]])
          return PDFNet.sendWithPromise("WidgetAnnot.setFitFull", { widget: this.id, ff: ff })
        }
        PDFNet.WidgetAnnot.prototype.getHIconLeftOver = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getHIconLeftOver", { widget: this.id })
        }
        PDFNet.WidgetAnnot.prototype.setHIconLeftOver = function (hl) {
          checkArguments(arguments.length, 1, "setHIconLeftOver", "(number)", [[hl, "number"]])
          return PDFNet.sendWithPromise("WidgetAnnot.setHIconLeftOver", { widget: this.id, hl: hl })
        }
        PDFNet.WidgetAnnot.prototype.getVIconLeftOver = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getVIconLeftOver", { widget: this.id })
        }
        PDFNet.WidgetAnnot.prototype.setVIconLeftOver = function (vl) {
          checkArguments(arguments.length, 1, "setVIconLeftOver", "(number)", [[vl, "number"]])
          return PDFNet.sendWithPromise("WidgetAnnot.setVIconLeftOver", { widget: this.id, vl: vl })
        }
        ...
        PDFNet.WidgetAnnot.prototype.setFont = function (font) {
          ...
          return PDFNet.sendWithPromise("WidgetAnnot.setFont", { widget: this.id, font: font.id })
        }
        PDFNet.WidgetAnnot.prototype.getFontSize = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getFontSize", { widget: this.id })
        }
        PDFNet.WidgetAnnot.prototype.getTextColor = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getTextColor", { widget: this.id }).then(
            function (id) {
        ...
        PDFNet.WidgetAnnot.prototype.getFont = function () {
          return PDFNet.sendWithPromise("WidgetAnnot.getFont", { widget: this.id }).then(function (
            id
          ) {
        ...
        PDFNet.SignatureWidget.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("signatureWidgetCreateFromObj", { d: d.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.SignatureWidget, id)
          })
        ...
        PDFNet.SignatureWidget.createFromAnnot = function (annot) {
          ...
          return PDFNet.sendWithPromise("signatureWidgetCreateFromAnnot", { annot: annot.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SignatureWidget, id)
            }
          )
        ...
        PDFNet.SignatureWidget.prototype.createSignatureAppearance = function (img) {
          checkArguments(arguments.length, 1, "createSignatureAppearance", "(PDFNet.Image)", [
            [img, "Object", PDFNet.Image, "Image"],
          ])
        ...
        PDFNet.ComboBoxWidget.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("comboBoxWidgetCreateFromObj", { d: d.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.ComboBoxWidget, id)
          })
        ...
        PDFNet.ComboBoxWidget.createFromAnnot = function (annot) {
          ...
          return PDFNet.sendWithPromise("comboBoxWidgetCreateFromAnnot", { annot: annot.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.ComboBoxWidget, id)
            }
          )
        ...
        PDFNet.ComboBoxWidget.prototype.getSelectedOption = function () {
          return PDFNet.sendWithPromise("ComboBoxWidget.getSelectedOption", { combobox: this.id })
        }
        PDFNet.ComboBoxWidget.prototype.replaceOptions = function (new_opts) {
          checkArguments(arguments.length, 1, "replaceOptions", "(Array<string>)", [
            [new_opts, "Array"],
          ])
        ...
        PDFNet.ListBoxWidget.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("listBoxWidgetCreateFromObj", { d: d.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.ListBoxWidget, id)
          })
        ...
        PDFNet.ListBoxWidget.createFromAnnot = function (annot) {
          ...
          return PDFNet.sendWithPromise("listBoxWidgetCreateFromAnnot", { annot: annot.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.ListBoxWidget, id)
            }
          )
        ...
        PDFNet.ListBoxWidget.prototype.setSelectedOptions = function (selected_opts) {
          checkArguments(arguments.length, 1, "setSelectedOptions", "(Array<string>)", [
            [selected_opts, "Array"],
          ])
        ...
        PDFNet.TextWidget.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("textWidgetCreateFromObj", { d: d.id }).then(function (id) {
            return createPDFNetObj(PDFNet.TextWidget, id)
          })
        }
        PDFNet.TextWidget.createFromAnnot = function (annot) {
          ...
          return PDFNet.sendWithPromise("textWidgetCreateFromAnnot", { annot: annot.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.TextWidget, id)
            }
          )
        ...
        PDFNet.TextWidget.prototype.setText = function (text) {
          ...
          return PDFNet.sendWithPromise("TextWidget.setText", { widget: this.id, text: text })
        }
        PDFNet.TextWidget.prototype.getText = function () {
          return PDFNet.sendWithPromise("TextWidget.getText", { widget: this.id })
        }
        ...
        PDFNet.CheckBoxWidget.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("checkBoxWidgetCreateFromObj", { d: d.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.CheckBoxWidget, id)
          })
        ...
        PDFNet.CheckBoxWidget.createFromAnnot = function (annot) {
          ...
          return PDFNet.sendWithPromise("checkBoxWidgetCreateFromAnnot", { annot: annot.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.CheckBoxWidget, id)
            }
          )
        ...
        PDFNet.CheckBoxWidget.prototype.isChecked = function () {
          return PDFNet.sendWithPromise("CheckBoxWidget.isChecked", { button: this.id })
        }
        ...
        PDFNet.RadioButtonWidget.createFromObj = function (d) {
          ...
          return PDFNet.sendWithPromise("radioButtonWidgetCreateFromObj", { d: d.id }).then(
            function (id) {
        ...
        PDFNet.RadioButtonWidget.prototype.isEnabled = function () {
          return PDFNet.sendWithPromise("RadioButtonWidget.isEnabled", { button: this.id })
        }
        PDFNet.RadioButtonWidget.prototype.enableButton = function () {
          return PDFNet.sendWithPromise("RadioButtonWidget.enableButton", { button: this.id })
        }
        PDFNet.RadioButtonWidget.prototype.getGroup = function () {
          return PDFNet.sendWithPromise("RadioButtonWidget.getGroup", { button: this.id }).then(
            function (id) {
        ...
        PDFNet.PushButtonWidget.createFromObj = function (obj) {
          ...
          return PDFNet.sendWithPromise("pushButtonWidgetCreateFromObj", { obj: obj.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.PushButtonWidget, id)
            }
          )
        ...
        PDFNet.Bookmark.prototype.copy = function () {
          return PDFNet.sendWithPromise("Bookmark.copy", { in_bookmark: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Bookmark, id)
          })
        ...
        PDFNet.Bookmark.prototype.getNext = function () {
          return PDFNet.sendWithPromise("Bookmark.getNext", { bm: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Bookmark, id)
          })
        }
        PDFNet.Bookmark.prototype.getPrev = function () {
          return PDFNet.sendWithPromise("Bookmark.getPrev", { bm: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Bookmark, id)
          })
        }
        PDFNet.Bookmark.prototype.getFirstChild = function () {
          return PDFNet.sendWithPromise("Bookmark.getFirstChild", { bm: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Bookmark, id)
          })
        ...
        PDFNet.Bookmark.prototype.getLastChild = function () {
          return PDFNet.sendWithPromise("Bookmark.getLastChild", { bm: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Bookmark, id)
          })
        ...
        PDFNet.Bookmark.prototype.getParent = function () {
          return PDFNet.sendWithPromise("Bookmark.getParent", { bm: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Bookmark, id)
          })
        }
        PDFNet.Bookmark.prototype.find = function (in_title) {
          checkArguments(arguments.length, 1, "find", "(string)", [[in_title, "string"]])
          return PDFNet.sendWithPromise("Bookmark.find", { bm: this.id, in_title: in_title }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Bookmark, id)
            }
          )
        ...
        PDFNet.Bookmark.prototype.setOpen = function (in_open) {
          ...
          return PDFNet.sendWithPromise("Bookmark.setOpen", { bm: this.id, in_open: in_open })
        }
        PDFNet.Bookmark.prototype.getOpenCount = function () {
          return PDFNet.sendWithPromise("Bookmark.getOpenCount", { bm: this.id })
        }
        ...
        PDFNet.Bookmark.prototype.getTitleObj = function () {
          return PDFNet.sendWithPromise("Bookmark.getTitleObj", { bm: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Bookmark.prototype.setTitle = function (title) {
          checkArguments(arguments.length, 1, "setTitle", "(string)", [[title, "string"]])
          return PDFNet.sendWithPromise("Bookmark.setTitle", { bm: this.id, title: title })
        }
        PDFNet.Bookmark.prototype.getAction = function () {
          return PDFNet.sendWithPromise("Bookmark.getAction", { bm: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Action, id)
          })
        }
        ...
        PDFNet.Bookmark.prototype.removeAction = function () {
          return PDFNet.sendWithPromise("Bookmark.removeAction", { bm: this.id })
        }
        ...
        PDFNet.Bookmark.prototype.setFlags = function (in_flags) {
          ...
          return PDFNet.sendWithPromise("Bookmark.setFlags", { bm: this.id, in_flags: in_flags })
        }
        ...
        PDFNet.Bookmark.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("Bookmark.getSDFObj", { bm: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.ColorPt.init = function (x, y, z, w) {
          ...
          return PDFNet.sendWithPromise("colorPtInit", { x: x, y: y, z: z, w: w }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        ...
        PDFNet.ColorPt.prototype.compare = function (right) {
          ...
          return PDFNet.sendWithPromise("ColorPt.compare", { left: this.id, right: right.id })
        }
        PDFNet.ColorPt.prototype.set = function (x, y, z, w) {
          ...
          return PDFNet.sendWithPromise("ColorPt.set", { cp: this.id, x: x, y: y, z: z, w: w })
        }
        ...
        PDFNet.ColorPt.prototype.setColorantNum = function (num) {
          ...
          return PDFNet.sendWithPromise("ColorPt.setColorantNum", { cp: this.id, num: num })
        }
        ...
        PDFNet.ColorSpace.create = function (color_space) {
          ...
          return PDFNet.sendWithPromise("colorSpaceCreate", { color_space: color_space.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorSpace, id)
            }
          )
        ...
        PDFNet.ColorSpace.getTypeFromObj = function (cs_obj) {
          checkArguments(arguments.length, 1, "getTypeFromObj", "(PDFNet.Obj)", [
            [cs_obj, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("colorSpaceGetTypeFromObj", { cs_obj: cs_obj.id })
        }
        ...
        PDFNet.ColorSpace.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("ColorSpace.getSDFObj", { cs: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.ColorSpace.prototype.getComponentNum = function () {
          return PDFNet.sendWithPromise("ColorSpace.getComponentNum", { cs: this.id })
        }
        PDFNet.ColorSpace.prototype.initColor = function () {
          return PDFNet.sendWithPromise("ColorSpace.initColor", { cs: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        ...
        PDFNet.ColorSpace.prototype.initComponentRanges = function (num_comps) {
          checkArguments(arguments.length, 1, "initComponentRanges", "(number)", [
            [num_comps, "number"],
          ])
        ...
        PDFNet.ColorSpace.prototype.convert2Gray = function (in_color) {
          checkArguments(arguments.length, 1, "convert2Gray", "(PDFNet.ColorPt)", [
        ...
        PDFNet.ColorSpace.prototype.convert2RGB = function (in_color) {
          checkArguments(arguments.length, 1, "convert2RGB", "(PDFNet.ColorPt)", [
            [in_color, "Object", PDFNet.ColorPt, "ColorPt"],
          ])
        ...
        PDFNet.ColorSpace.prototype.convert2CMYK = function (in_color) {
          checkArguments(arguments.length, 1, "convert2CMYK", "(PDFNet.ColorPt)", [
            [in_color, "Object", PDFNet.ColorPt, "ColorPt"],
          ])
        ...
        PDFNet.ColorSpace.prototype.getAlternateColorSpace = function () {
          return PDFNet.sendWithPromise("ColorSpace.getAlternateColorSpace", { cs: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorSpace, id)
            }
          )
        ...
        PDFNet.ColorSpace.prototype.getBaseColorSpace = function () {
          return PDFNet.sendWithPromise("ColorSpace.getBaseColorSpace", { cs: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorSpace, id)
            }
          )
        ...
        PDFNet.ColorSpace.prototype.getHighVal = function () {
          return PDFNet.sendWithPromise("ColorSpace.getHighVal", { cs: this.id })
        }
        PDFNet.ColorSpace.prototype.getLookupTable = function () {
          return PDFNet.sendWithPromise("ColorSpace.getLookupTable", { cs: this.id })
        }
        ...
        PDFNet.ColorSpace.prototype.getTintFunction = function () {
          return PDFNet.sendWithPromise("ColorSpace.getTintFunction", { cs: this.id }).then(
            function (id) {
        ...
        PDFNet.ContentReplacer.prototype.process = function (page) {
          ...
          return PDFNet.sendWithPromise("ContentReplacer.process", { cr: this.id, page: page.id })
        }
        ...
        PDFNet.Reflow.prototype.getAnnot = function (in_id) {
          ...
          return PDFNet.sendWithPromise("Reflow.getAnnot", { self: this.id, in_id: in_id })
        }
        PDFNet.Reflow.prototype.setAnnot = function (in_json) {
          checkArguments(arguments.length, 1, "setAnnot", "(string)", [[in_json, "string"]])
          return PDFNet.sendWithPromise("Reflow.setAnnot", { self: this.id, in_json: in_json })
        }
        ...
        PDFNet.Reflow.prototype.setHTMLOutputTextMarkup = function (include) {
          checkArguments(arguments.length, 1, "setHTMLOutputTextMarkup", "(boolean)", [
            [include, "boolean"],
          ])
        ...
        PDFNet.Reflow.prototype.setMessageWhenNoReflowContent = function (content) {
          checkArguments(arguments.length, 1, "setMessageWhenNoReflowContent", "(string)", [
            [content, "string"],
          ])
        ...
        PDFNet.Reflow.prototype.setMessageWhenReflowFailed = function (content) {
          checkArguments(arguments.length, 1, "setMessageWhenReflowFailed", "(string)", [
            [content, "string"],
          ])
        ...
        PDFNet.Reflow.prototype.setHideBackgroundImages = function (hide_background_images) {
          checkArguments(arguments.length, 1, "setHideBackgroundImages", "(boolean)", [
        ...
        PDFNet.Reflow.prototype.setHideImagesUnderText = function (hide_images_under_text) {
          checkArguments(arguments.length, 1, "setHideImagesUnderText", "(boolean)", [
        ...
        PDFNet.Reflow.prototype.setHideImagesUnderInvisibleText = function (
          ...
          checkArguments(arguments.length, 1, "setHideImagesUnderInvisibleText", "(boolean)", [
        ...
        PDFNet.Reflow.prototype.setFontOverrideName = function (font_family) {
          checkArguments(arguments.length, 1, "setFontOverrideName", "(string)", [
            [font_family, "string"],
          ])
        ...
        PDFNet.Reflow.prototype.setCustomStyles = function (styles) {
          ...
          return PDFNet.sendWithPromise("Reflow.setCustomStyles", { self: this.id, styles: styles })
        }
        PDFNet.Reflow.prototype.setIncludeBBoxForRecognizedZones = function (include) {
          checkArguments(arguments.length, 1, "setIncludeBBoxForRecognizedZones", "(boolean)", [
            [include, "boolean"],
          ])
        ...
        PDFNet.Convert.toXpsBuffer = function (in_pdfdoc, options$jscomp$0) {
          ...
          if ("PDFNet.Convert.XPSOutputOptions" === options$jscomp$0.name) {
          ...
          } else options$jscomp$0 = Promise.resolve(options$jscomp$0)
        ...
        PDFNet.Convert.fileToXodWithBuffer = function (fileData, fileType, options$jscomp$0) {
          ...
          fileType.startsWith(".") || (fileType = "." + fileType)
          fileData = getArrayBuffer(fileData, !1)
          if ("PDFNet.Convert.XODOutputOptions" === options$jscomp$0.name) {
            var optsCopy = options$jscomp$0
            options$jscomp$0 = PDFNet.ObjSet.create().then(function (set) {
              return set.createFromJson(JSON.stringify(optsCopy))
            })
        ...
        PDFNet.ConversionMonitor.prototype.next = function () {
          return PDFNet.sendWithPromise("ConversionMonitor.next", { conversionMonitor: this.id })
        }
        PDFNet.ConversionMonitor.prototype.ready = function () {
          return PDFNet.sendWithPromise("ConversionMonitor.ready", { conversionMonitor: this.id })
        }
        ...
        PDFNet.Convert.fileToTiffWithBuffer = function (fileData, fileType, options$jscomp$0) {
          ...
          fileType.startsWith(".") || (fileType = "." + fileType)
          fileData = getArrayBuffer(fileData, !1)
          if ("PDFNet.Convert.TiffOutputOptions" === options$jscomp$0.name) {
            var optsCopy = options$jscomp$0
            options$jscomp$0 = PDFNet.ObjSet.create().then(function (set) {
              return set.createFromJson(JSON.stringify(optsCopy))
            })
        ...
        PDFNet.Date.prototype.attach = function (d) {
          ...
          return PDFNet.sendWithPromise("Date.attach", { date: this, d: d.id }).then(function (id) {
            me.yieldFunction = void 0
            copyFunc(id, me)
          })
        }
        PDFNet.Date.prototype.update = function (d) {
          ...
          return PDFNet.sendWithPromise("Date.update", { date: this, d: d.id }).then(function (id) {
            me.yieldFunction = void 0
            copyFunc(id.date, me)
            return id.result
          })
        ...
        PDFNet.Date.prototype.setCurrentTime = function () {
          ...
          return PDFNet.sendWithPromise("Date.setCurrentTime", { date: this }).then(function (id) {
            me.yieldFunction = void 0
            copyFunc(id, me)
          })
        }
        ...
        PDFNet.Destination.createFit = function (page) {
          ...
          return PDFNet.sendWithPromise("destinationCreateFit", { page: page.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Destination, id)
          })
        ...
        PDFNet.Destination.createFitH = function (page, top) {
          ...
          return PDFNet.sendWithPromise("destinationCreateFitH", { page: page.id, top: top }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Destination, id)
            }
          )
        ...
        PDFNet.Destination.createFitB = function (page) {
          ...
          return PDFNet.sendWithPromise("destinationCreateFitB", { page: page.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Destination, id)
          })
        ...
        PDFNet.Destination.createFitBH = function (page, top) {
          ...
          return PDFNet.sendWithPromise("destinationCreateFitBH", { page: page.id, top: top }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Destination, id)
            }
          )
        ...
        PDFNet.Destination.create = function (dest) {
          ...
          return PDFNet.sendWithPromise("destinationCreate", { dest: dest.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Destination, id)
          })
        }
        PDFNet.Destination.prototype.copy = function () {
          return PDFNet.sendWithPromise("Destination.copy", { d: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Destination, id)
          })
        }
        PDFNet.Destination.prototype.isValid = function () {
          return PDFNet.sendWithPromise("Destination.isValid", { dest: this.id })
        }
        PDFNet.Destination.prototype.getFitType = function () {
          return PDFNet.sendWithPromise("Destination.getFitType", { dest: this.id })
        }
        PDFNet.Destination.prototype.getPage = function () {
          return PDFNet.sendWithPromise("Destination.getPage", { dest: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Page, id)
          })
        ...
        PDFNet.Destination.prototype.setPage = function (page) {
          ...
          return PDFNet.sendWithPromise("Destination.setPage", { dest: this.id, page: page.id })
        }
        PDFNet.Destination.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("Destination.getSDFObj", { dest: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Destination.prototype.getExplicitDestObj = function () {
          return PDFNet.sendWithPromise("Destination.getExplicitDestObj", { dest: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.GState.prototype.getTransform = function () {
          return PDFNet.sendWithPromise("GState.getTransform", { gs: this.id }).then(function (id) {
            return new PDFNet.Matrix2D(id)
          })
        }
        PDFNet.GState.prototype.getStrokeColorSpace = function () {
          return PDFNet.sendWithPromise("GState.getStrokeColorSpace", { gs: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorSpace, id)
            }
          )
        ...
        PDFNet.GState.prototype.getFillColorSpace = function () {
          return PDFNet.sendWithPromise("GState.getFillColorSpace", { gs: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorSpace, id)
          })
        ...
        PDFNet.GState.prototype.getStrokeColor = function () {
          return PDFNet.sendWithPromise("GState.getStrokeColor", { gs: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        ...
        PDFNet.GState.prototype.getStrokePattern = function () {
          return PDFNet.sendWithPromise("GState.getStrokePattern", { gs: this.id }).then(function (
            id
          ) {
        ...
        PDFNet.GState.prototype.getFillColor = function () {
          return PDFNet.sendWithPromise("GState.getFillColor", { gs: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        }
        PDFNet.GState.prototype.getFillPattern = function () {
          return PDFNet.sendWithPromise("GState.getFillPattern", { gs: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.PatternColor, id)
          })
        ...
        PDFNet.GState.prototype.getCharSpacing = function () {
          return PDFNet.sendWithPromise("GState.getCharSpacing", { gs: this.id })
        }
        PDFNet.GState.prototype.getWordSpacing = function () {
          return PDFNet.sendWithPromise("GState.getWordSpacing", { gs: this.id })
        }
        PDFNet.GState.prototype.getHorizontalScale = function () {
          return PDFNet.sendWithPromise("GState.getHorizontalScale", { gs: this.id })
        }
        ...
        PDFNet.GState.prototype.getTextRenderMode = function () {
          return PDFNet.sendWithPromise("GState.getTextRenderMode", { gs: this.id })
        }
        ...
        PDFNet.GState.prototype.isTextKnockout = function () {
          return PDFNet.sendWithPromise("GState.isTextKnockout", { gs: this.id })
        }
        PDFNet.GState.prototype.getRenderingIntent = function () {
          return PDFNet.sendWithPromise("GState.getRenderingIntent", { gs: this.id })
        }
        PDFNet.GState.getRenderingIntentType = function (name) {
          checkArguments(arguments.length, 1, "getRenderingIntentType", "(string)", [
            [name, "string"],
          ])
          return PDFNet.sendWithPromise("gStateGetRenderingIntentType", { name: name })
        }
        ...
        PDFNet.GState.prototype.getFillOpacity = function () {
          return PDFNet.sendWithPromise("GState.getFillOpacity", { gs: this.id })
        }
        PDFNet.GState.prototype.getStrokeOpacity = function () {
          return PDFNet.sendWithPromise("GState.getStrokeOpacity", { gs: this.id })
        }
        ...
        PDFNet.GState.prototype.getSoftMask = function () {
          return PDFNet.sendWithPromise("GState.getSoftMask", { gs: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.GState.prototype.getSoftMaskTransform = function () {
          return PDFNet.sendWithPromise("GState.getSoftMaskTransform", { gs: this.id }).then(
            function (id) {
              return new PDFNet.Matrix2D(id)
            }
          )
        ...
        PDFNet.GState.prototype.getStrokeOverprint = function () {
          return PDFNet.sendWithPromise("GState.getStrokeOverprint", { gs: this.id })
        }
        PDFNet.GState.prototype.getFillOverprint = function () {
          return PDFNet.sendWithPromise("GState.getFillOverprint", { gs: this.id })
        }
        PDFNet.GState.prototype.getOverprintMode = function () {
          return PDFNet.sendWithPromise("GState.getOverprintMode", { gs: this.id })
        }
        PDFNet.GState.prototype.getAutoStrokeAdjust = function () {
          return PDFNet.sendWithPromise("GState.getAutoStrokeAdjust", { gs: this.id })
        }
        PDFNet.GState.prototype.getSmoothnessTolerance = function () {
          return PDFNet.sendWithPromise("GState.getSmoothnessTolerance", { gs: this.id })
        }
        PDFNet.GState.prototype.getTransferFunct = function () {
          return PDFNet.sendWithPromise("GState.getTransferFunct", { gs: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.GState.prototype.getBlackGenFunct = function () {
          return PDFNet.sendWithPromise("GState.getBlackGenFunct", { gs: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.GState.prototype.getUCRFunct = function () {
          return PDFNet.sendWithPromise("GState.getUCRFunct", { gs: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.GState.prototype.getHalftone = function () {
          return PDFNet.sendWithPromise("GState.getHalftone", { gs: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.GState.prototype.setTransformMatrix = function (mtx) {
          checkArguments(arguments.length, 1, "setTransformMatrix", "(PDFNet.Matrix2D)", [
            [mtx, "Structure", PDFNet.Matrix2D, "Matrix2D"],
          ])
          checkParamsYieldFunction("setTransformMatrix", [[mtx, 0]])
          return PDFNet.sendWithPromise("GState.setTransformMatrix", { gs: this.id, mtx: mtx })
        }
        ...
        PDFNet.GState.prototype.concatMatrix = function (mtx) {
          checkArguments(arguments.length, 1, "concatMatrix", "(PDFNet.Matrix2D)", [
            [mtx, "Structure", PDFNet.Matrix2D, "Matrix2D"],
          ])
          checkParamsYieldFunction("concatMatrix", [[mtx, 0]])
          return PDFNet.sendWithPromise("GState.concatMatrix", { gs: this.id, mtx: mtx })
        }
        ...
        PDFNet.GState.prototype.setStrokeColorSpace = function (cs) {
          checkArguments(arguments.length, 1, "setStrokeColorSpace", "(PDFNet.ColorSpace)", [
            [cs, "Object", PDFNet.ColorSpace, "ColorSpace"],
          ])
          return PDFNet.sendWithPromise("GState.setStrokeColorSpace", { gs: this.id, cs: cs.id })
        }
        PDFNet.GState.prototype.setFillColorSpace = function (cs) {
          checkArguments(arguments.length, 1, "setFillColorSpace", "(PDFNet.ColorSpace)", [
            [cs, "Object", PDFNet.ColorSpace, "ColorSpace"],
          ])
          return PDFNet.sendWithPromise("GState.setFillColorSpace", { gs: this.id, cs: cs.id })
        }
        PDFNet.GState.prototype.setStrokeColorWithColorPt = function (c) {
          checkArguments(arguments.length, 1, "setStrokeColorWithColorPt", "(PDFNet.ColorPt)", [
            [c, "Object", PDFNet.ColorPt, "ColorPt"],
          ])
        ...
        PDFNet.GState.prototype.setFillColorWithColorPt = function (c) {
          checkArguments(arguments.length, 1, "setFillColorWithColorPt", "(PDFNet.ColorPt)", [
            [c, "Object", PDFNet.ColorPt, "ColorPt"],
          ])
          return PDFNet.sendWithPromise("GState.setFillColorWithColorPt", { gs: this.id, c: c.id })
        }
        PDFNet.GState.prototype.setFillColorWithPattern = function (pattern) {
          checkArguments(arguments.length, 1, "setFillColorWithPattern", "(PDFNet.PatternColor)", [
            [pattern, "Object", PDFNet.PatternColor, "PatternColor"],
          ])
        ...
        PDFNet.GState.prototype.setHorizontalScale = function (hscale) {
          checkArguments(arguments.length, 1, "setHorizontalScale", "(number)", [
            [hscale, "number"],
          ])
        ...
        PDFNet.GState.prototype.setLeading = function (leading) {
          ...
          return PDFNet.sendWithPromise("GState.setLeading", { gs: this.id, leading: leading })
        }
        ...
        PDFNet.GState.prototype.setTextRenderMode = function (rmode) {
          ...
          return PDFNet.sendWithPromise("GState.setTextRenderMode", { gs: this.id, rmode: rmode })
        }
        PDFNet.GState.prototype.setTextRise = function (rise) {
          checkArguments(arguments.length, 1, "setTextRise", "(number)", [[rise, "number"]])
          return PDFNet.sendWithPromise("GState.setTextRise", { gs: this.id, rise: rise })
        }
        ...
        PDFNet.GState.prototype.setRenderingIntent = function (intent) {
          checkArguments(arguments.length, 1, "setRenderingIntent", "(number)", [
            [intent, "number"],
          ])
        ...
        PDFNet.GState.prototype.setSoftMask = function (SM) {
          ...
          return PDFNet.sendWithPromise("GState.setSoftMask", { gs: this.id, SM: SM.id })
        }
        PDFNet.GState.prototype.setStrokeOverprint = function (OP) {
          ...
          return PDFNet.sendWithPromise("GState.setStrokeOverprint", { gs: this.id, OP: OP })
        }
        PDFNet.GState.prototype.setFillOverprint = function (op) {
          ...
          return PDFNet.sendWithPromise("GState.setFillOverprint", { gs: this.id, op: op })
        }
        PDFNet.GState.prototype.setOverprintMode = function (OPM) {
          ...
          return PDFNet.sendWithPromise("GState.setOverprintMode", { gs: this.id, OPM: OPM })
        }
        PDFNet.GState.prototype.setAutoStrokeAdjust = function (SA) {
          ...
          return PDFNet.sendWithPromise("GState.setAutoStrokeAdjust", { gs: this.id, SA: SA })
        }
        PDFNet.GState.prototype.setSmoothnessTolerance = function (SM) {
          checkArguments(arguments.length, 1, "setSmoothnessTolerance", "(number)", [
            [SM, "number"],
          ])
          return PDFNet.sendWithPromise("GState.setSmoothnessTolerance", { gs: this.id, SM: SM })
        }
        PDFNet.GState.prototype.setBlackGenFunct = function (BG) {
          checkArguments(arguments.length, 1, "setBlackGenFunct", "(PDFNet.Obj)", [
            [BG, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("GState.setBlackGenFunct", { gs: this.id, BG: BG.id })
        }
        PDFNet.GState.prototype.setUCRFunct = function (UCR) {
          ...
          return PDFNet.sendWithPromise("GState.setUCRFunct", { gs: this.id, UCR: UCR.id })
        }
        PDFNet.GState.prototype.setTransferFunct = function (TR) {
          checkArguments(arguments.length, 1, "setTransferFunct", "(PDFNet.Obj)", [
            [TR, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("GState.setTransferFunct", { gs: this.id, TR: TR.id })
        }
        PDFNet.GState.prototype.setHalftone = function (HT) {
          ...
          return PDFNet.sendWithPromise("GState.setHalftone", { gs: this.id, HT: HT.id })
        }
        ...
        PDFNet.Element.prototype.getGState = function () {
          return PDFNet.sendWithPromise("Element.getGState", { e: this.id }).then(function (id) {
        ...
        PDFNet.Element.prototype.getParentStructElement = function () {
          return PDFNet.sendWithPromise("Element.getParentStructElement", { e: this.id }).then(
            function (id) {
              return new PDFNet.SElement(id)
            }
          )
        ...
        PDFNet.Element.prototype.isClippingPath = function () {
          return PDFNet.sendWithPromise("Element.isClippingPath", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.isClipWindingFill = function () {
          return PDFNet.sendWithPromise("Element.isClipWindingFill", { e: this.id })
        }
        PDFNet.Element.prototype.setPathClip = function (clip) {
          checkArguments(arguments.length, 1, "setPathClip", "(boolean)", [[clip, "boolean"]])
          return PDFNet.sendWithPromise("Element.setPathClip", { e: this.id, clip: clip })
        }
        PDFNet.Element.prototype.setPathStroke = function (stroke) {
          ...
          return PDFNet.sendWithPromise("Element.setPathStroke", { e: this.id, stroke: stroke })
        }
        PDFNet.Element.prototype.setPathFill = function (fill) {
          checkArguments(arguments.length, 1, "setPathFill", "(boolean)", [[fill, "boolean"]])
          return PDFNet.sendWithPromise("Element.setPathFill", { e: this.id, fill: fill })
        }
        ...
        PDFNet.Element.prototype.setClipWindingFill = function (winding_rule) {
          checkArguments(arguments.length, 1, "setClipWindingFill", "(boolean)", [
            [winding_rule, "boolean"],
          ])
        ...
        PDFNet.Element.prototype.getXObject = function () {
          return PDFNet.sendWithPromise("Element.getXObject", { e: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.Element.prototype.getImageData = function () {
          return PDFNet.sendWithPromise("Element.getImageData", { e: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Filter, id)
          })
        }
        PDFNet.Element.prototype.getImageDataSize = function () {
          return PDFNet.sendWithPromise("Element.getImageDataSize", { e: this.id })
        }
        PDFNet.Element.prototype.getImageColorSpace = function () {
          return PDFNet.sendWithPromise("Element.getImageColorSpace", { e: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorSpace, id)
            }
          )
        ...
        PDFNet.Element.prototype.getImageHeight = function () {
          return PDFNet.sendWithPromise("Element.getImageHeight", { e: this.id })
        }
        PDFNet.Element.prototype.getDecodeArray = function () {
          return PDFNet.sendWithPromise("Element.getDecodeArray", { e: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Element.prototype.getBitsPerComponent = function () {
          return PDFNet.sendWithPromise("Element.getBitsPerComponent", { e: this.id })
        }
        PDFNet.Element.prototype.getComponentNum = function () {
          return PDFNet.sendWithPromise("Element.getComponentNum", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.isImageInterpolate = function () {
          return PDFNet.sendWithPromise("Element.isImageInterpolate", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.getImageRenderingIntent = function () {
          return PDFNet.sendWithPromise("Element.getImageRenderingIntent", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.getTextMatrix = function () {
          return PDFNet.sendWithPromise("Element.getTextMatrix", { e: this.id }).then(function (
            id
          ) {
            return new PDFNet.Matrix2D(id)
          })
        ...
        PDFNet.Element.prototype.getCharIterator = function () {
          return PDFNet.sendWithPromise("Element.getCharIterator", { e: this.id }).then(function (
            id
          ) {
        ...
        PDFNet.Element.prototype.getPosAdjustment = function () {
          return PDFNet.sendWithPromise("Element.getPosAdjustment", { e: this.id })
        }
        PDFNet.Element.prototype.getNewTextLineOffset = function () {
          return PDFNet.sendWithPromise("Element.getNewTextLineOffset", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.setTextData = function (buf_text_data) {
          checkArguments(arguments.length, 1, "setTextData", "(ArrayBuffer|TypedArray)", [
        ...
        PDFNet.Element.prototype.setTextMatrix = function (mtx) {
          checkArguments(arguments.length, 1, "setTextMatrix", "(PDFNet.Matrix2D)", [
            [mtx, "Structure", PDFNet.Matrix2D, "Matrix2D"],
          ])
          checkParamsYieldFunction("setTextMatrix", [[mtx, 0]])
          return PDFNet.sendWithPromise("Element.setTextMatrix", { e: this.id, mtx: mtx })
        }
        ...
        PDFNet.Element.prototype.setPosAdjustment = function (adjust) {
          ...
          return PDFNet.sendWithPromise("Element.setPosAdjustment", { e: this.id, adjust: adjust })
        }
        PDFNet.Element.prototype.updateTextMetrics = function () {
          return PDFNet.sendWithPromise("Element.updateTextMetrics", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.getShading = function () {
          return PDFNet.sendWithPromise("Element.getShading", { e: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.Shading, id)
          })
        }
        PDFNet.Element.prototype.getMCPropertyDict = function () {
          return PDFNet.sendWithPromise("Element.getMCPropertyDict", { e: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Element.prototype.getMCTag = function () {
          return PDFNet.sendWithPromise("Element.getMCTag", { e: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.ShapedText.prototype.getScale = function () {
          return PDFNet.sendWithPromise("ShapedText.getScale", { self: this.id })
        }
        PDFNet.ShapedText.prototype.getShapingStatus = function () {
          return PDFNet.sendWithPromise("ShapedText.getShapingStatus", { self: this.id })
        }
        PDFNet.ShapedText.prototype.getFailureReason = function () {
          return PDFNet.sendWithPromise("ShapedText.getFailureReason", { self: this.id })
        }
        ...
        PDFNet.ShapedText.prototype.getNumGlyphs = function () {
          return PDFNet.sendWithPromise("ShapedText.getNumGlyphs", { self: this.id })
        }
        PDFNet.ShapedText.prototype.getGlyph = function (index) {
          checkArguments(arguments.length, 1, "getGlyph", "(number)", [[index, "number"]])
          return PDFNet.sendWithPromise("ShapedText.getGlyph", { self: this.id, index: index })
        }
        PDFNet.ShapedText.prototype.getGlyphXPos = function (index) {
          ...
          return PDFNet.sendWithPromise("ShapedText.getGlyphXPos", { self: this.id, index: index })
        }
        PDFNet.ShapedText.prototype.getGlyphYPos = function (index) {
          ...
          return PDFNet.sendWithPromise("ShapedText.getGlyphYPos", { self: this.id, index: index })
        }
        ...
        PDFNet.ElementBuilder.prototype.reset = function (gs) {
          ...
          return PDFNet.sendWithPromise("ElementBuilder.reset", { b: this.id, gs: gs.id })
        }
        ...
        PDFNet.ElementBuilder.prototype.createGroupBegin = function () {
          return PDFNet.sendWithPromise("ElementBuilder.createGroupBegin", { b: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Element, id)
            }
          )
        ...
        PDFNet.ElementBuilder.prototype.createGroupEnd = function () {
          return PDFNet.sendWithPromise("ElementBuilder.createGroupEnd", { b: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Element, id)
            }
          )
        ...
        PDFNet.ElementBuilder.prototype.createShading = function (sh) {
          checkArguments(arguments.length, 1, "createShading", "(PDFNet.Shading)", [
        ...
        PDFNet.ElementBuilder.prototype.createFormFromStream = function (form) {
          checkArguments(arguments.length, 1, "createFormFromStream", "(PDFNet.Obj)", [
        ...
        PDFNet.ElementBuilder.prototype.createFormFromPage = function (page) {
          checkArguments(arguments.length, 1, "createFormFromPage", "(PDFNet.Page)", [
            [page, "Object", PDFNet.Page, "Page"],
          ])
        ...
        PDFNet.ElementBuilder.prototype.createTextBegin = function () {
          return PDFNet.sendWithPromise("ElementBuilder.createTextBegin", { b: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Element, id)
            }
          )
        ...
        PDFNet.ElementBuilder.prototype.createTextEnd = function () {
          return PDFNet.sendWithPromise("ElementBuilder.createTextEnd", { b: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Element, id)
            }
          )
        ...
        PDFNet.ElementBuilder.prototype.createNewTextRunUnsigned = function (text_data) {
          checkArguments(arguments.length, 1, "createNewTextRunUnsigned", "(string)", [
            [text_data, "string"],
          ])
        ...
        PDFNet.ElementBuilder.prototype.createShapedTextRun = function (text_data) {
          checkArguments(arguments.length, 1, "createShapedTextRun", "(PDFNet.ShapedText)", [
        ...
        PDFNet.ElementBuilder.prototype.createTextNewLine = function () {
          return PDFNet.sendWithPromise("ElementBuilder.createTextNewLine", { b: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Element, id)
            }
          )
        ...
        PDFNet.ElementBuilder.prototype.pathBegin = function () {
          return PDFNet.sendWithPromise("ElementBuilder.pathBegin", { b: this.id })
        }
        PDFNet.ElementBuilder.prototype.pathEnd = function () {
          return PDFNet.sendWithPromise("ElementBuilder.pathEnd", { b: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Element, id)
          })
        ...
        PDFNet.ElementBuilder.prototype.moveTo = function (x, y) {
          ...
          return PDFNet.sendWithPromise("ElementBuilder.moveTo", { b: this.id, x: x, y: y })
        }
        PDFNet.ElementBuilder.prototype.lineTo = function (x, y) {
          ...
          return PDFNet.sendWithPromise("ElementBuilder.lineTo", { b: this.id, x: x, y: y })
        }
        ...
        PDFNet.ElementBuilder.prototype.closePath = function () {
          return PDFNet.sendWithPromise("ElementBuilder.closePath", { b: this.id })
        }
        ...
        PDFNet.ElementReader.prototype.appendResource = function (res) {
          checkArguments(arguments.length, 1, "appendResource", "(PDFNet.Obj)", [
            [res, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("ElementReader.appendResource", { r: this.id, res: res.id })
        }
        PDFNet.ElementReader.prototype.next = function () {
          return PDFNet.sendWithPromise("ElementReader.next", { r: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Element, id)
          })
        }
        PDFNet.ElementReader.prototype.current = function () {
          return PDFNet.sendWithPromise("ElementReader.current", { r: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Element, id)
          })
        ...
        PDFNet.ElementReader.prototype.formBegin = function () {
          return PDFNet.sendWithPromise("ElementReader.formBegin", { r: this.id })
        }
        ...
        PDFNet.ElementReader.prototype.getChangesIterator = function () {
          return PDFNet.sendWithPromise("ElementReader.getChangesIterator", { r: this.id }).then(
            function (id) {
        ...
        PDFNet.ElementReader.prototype.isChanged = function (attrib) {
          ...
          return PDFNet.sendWithPromise("ElementReader.isChanged", { r: this.id, attrib: attrib })
        }
        PDFNet.ElementReader.prototype.clearChangeList = function () {
          return PDFNet.sendWithPromise("ElementReader.clearChangeList", { r: this.id })
        }
        PDFNet.ElementReader.prototype.getFont = function (name) {
          checkArguments(arguments.length, 1, "getFont", "(string)", [[name, "string"]])
          return PDFNet.sendWithPromise("ElementReader.getFont", { r: this.id, name: name }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.ElementWriter.prototype.end = function () {
          return PDFNet.sendWithPromise("ElementWriter.end", { w: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.ElementWriter.prototype.writeElement = function (element) {
          checkArguments(arguments.length, 1, "writeElement", "(PDFNet.Element)", [
        ...
        PDFNet.ElementWriter.prototype.writePlacedElement = function (element) {
          checkArguments(arguments.length, 1, "writePlacedElement", "(PDFNet.Element)", [
            [element, "Object", PDFNet.Element, "Element"],
          ])
        ...
        PDFNet.ElementWriter.prototype.writeString = function (str) {
          checkArguments(arguments.length, 1, "writeString", "(string)", [[str, "string"]])
          return PDFNet.sendWithPromise("ElementWriter.writeString", { w: this.id, str: str })
        }
        PDFNet.ElementWriter.prototype.setDefaultGState = function (reader) {
          checkArguments(arguments.length, 1, "setDefaultGState", "(PDFNet.ElementReader)", [
        ...
        PDFNet.ElementWriter.prototype.writeGStateChanges = function (element) {
          checkArguments(arguments.length, 1, "writeGStateChanges", "(PDFNet.Element)", [
            [element, "Object", PDFNet.Element, "Element"],
          ])
        ...
        PDFNet.FileSpec.createURL = function (doc, url) {
          ...
          return PDFNet.sendWithPromise("fileSpecCreateURL", { doc: doc.id, url: url }).then(
            function (id) {
              return createPDFNetObj(PDFNet.FileSpec, id)
            }
          )
        ...
        PDFNet.FileSpec.createFromObj = function (f) {
          ...
          return PDFNet.sendWithPromise("fileSpecCreateFromObj", { f: f.id }).then(function (id) {
            return createPDFNetObj(PDFNet.FileSpec, id)
          })
        }
        ...
        PDFNet.FileSpec.prototype.compare = function (d) {
          ...
          return PDFNet.sendWithPromise("FileSpec.compare", { fs: this.id, d: d.id })
        }
        ...
        PDFNet.FileSpec.prototype["export"] = function (save_as) {
          "undefined" === typeof save_as && (save_as = "")
          checkArguments(arguments.length, 0, "export", "(string)", [[save_as, "string"]])
          return PDFNet.sendWithPromise("FileSpec.export", { fs: this.id, save_as: save_as })
        }
        PDFNet.FileSpec.prototype.getFileData = function () {
          return PDFNet.sendWithPromise("FileSpec.getFileData", { fs: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Filter, id)
          })
        ...
        PDFNet.FileSpec.prototype.setDesc = function (desc) {
          ...
          return PDFNet.sendWithPromise("FileSpec.setDesc", { fs: this.id, desc: desc })
        }
        PDFNet.FileSpec.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("FileSpec.getSDFObj", { fs: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Flattener.prototype.setDPI = function (dpi) {
          ...
          return PDFNet.sendWithPromise("Flattener.setDPI", { flattener: this.id, dpi: dpi })
        }
        ...
        PDFNet.Flattener.prototype.setMaximumImagePixels = function (max_pixels) {
          checkArguments(arguments.length, 1, "setMaximumImagePixels", "(number)", [
            [max_pixels, "number"],
          ])
        ...
        PDFNet.Flattener.prototype.setPreferJPG = function (jpg) {
          ...
          return PDFNet.sendWithPromise("Flattener.setPreferJPG", { flattener: this.id, jpg: jpg })
        }
        ...
        PDFNet.Font.createFromObj = function (font_dict) {
          ...
          return PDFNet.sendWithPromise("fontCreateFromObj", { font_dict: font_dict.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.Font, id)
            }
          )
        ...
        PDFNet.Font.create = function (doc, type) {
          ...
          return PDFNet.sendWithPromise("fontCreate", { doc: doc.id, type: type }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.Font, id)
          })
        ...
        PDFNet.Font.createAndEmbed = function (doc, type) {
          ...
          return PDFNet.sendWithPromise("fontCreateAndEmbed", { doc: doc.id, type: type }).then(
            function (id) {
              return createDestroyableObj(PDFNet.Font, id)
            }
          )
        ...
        PDFNet.Font.getTypeFromObj = function (font_dict) {
          ...
          return PDFNet.sendWithPromise("fontGetTypeFromObj", { font_dict: font_dict.id })
        }
        PDFNet.Font.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("Font.getSDFObj", { font: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.Font.prototype.getDescriptor = function () {
          return PDFNet.sendWithPromise("Font.getDescriptor", { font: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Font.prototype.isHorizontalMode = function () {
          return PDFNet.sendWithPromise("Font.isHorizontalMode", { font: this.id })
        }
        PDFNet.Font.prototype.getWidth = function (char_code) {
          checkArguments(arguments.length, 1, "getWidth", "(number)", [[char_code, "number"]])
          return PDFNet.sendWithPromise("Font.getWidth", { font: this.id, char_code: char_code })
        }
        ...
        PDFNet.Font.prototype.getMissingWidth = function () {
          return PDFNet.sendWithPromise("Font.getMissingWidth", { font: this.id })
        }
        PDFNet.Font.prototype.getCharCodeIterator = function () {
          return PDFNet.sendWithPromise("Font.getCharCodeIterator", { font: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.Iterator, id, "Int")
            }
          )
        ...
        PDFNet.Font.prototype.getEmbeddedFontName = function () {
          return PDFNet.sendWithPromise("Font.getEmbeddedFontName", { font: this.id })
        }
        PDFNet.Font.prototype.getEmbeddedFont = function () {
          return PDFNet.sendWithPromise("Font.getEmbeddedFont", { font: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Font.prototype.getEmbeddedFontBufSize = function () {
          return PDFNet.sendWithPromise("Font.getEmbeddedFontBufSize", { font: this.id })
        }
        ...
        PDFNet.Font.prototype.getStandardType1FontType = function () {
          return PDFNet.sendWithPromise("Font.getStandardType1FontType", { font: this.id })
        }
        ...
        PDFNet.Font.prototype.getType3FontMatrix = function () {
          return PDFNet.sendWithPromise("Font.getType3FontMatrix", { font: this.id }).then(
            function (id) {
              return new PDFNet.Matrix2D(id)
            }
          )
        ...
        PDFNet.Font.prototype.getType3GlyphStream = function (char_code) {
          checkArguments(arguments.length, 1, "getType3GlyphStream", "(number)", [
            [char_code, "number"],
          ])
        ...
        PDFNet.Font.prototype.getVerticalAdvance = function (char_code) {
          checkArguments(arguments.length, 1, "getVerticalAdvance", "(number)", [
            [char_code, "number"],
          ])
        ...
        PDFNet.Font.prototype.getDescendant = function () {
          return PDFNet.sendWithPromise("Font.getDescendant", { font: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.Font, id)
          })
        ...
        PDFNet.Function.create = function (funct_dict) {
          ...
          return PDFNet.sendWithPromise("functionCreate", { funct_dict: funct_dict.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.Function, id)
            }
          )
        ...
        PDFNet.Function.prototype.getInputCardinality = function () {
          return PDFNet.sendWithPromise("Function.getInputCardinality", { f: this.id })
        }
        PDFNet.Function.prototype.getOutputCardinality = function () {
          return PDFNet.sendWithPromise("Function.getOutputCardinality", { f: this.id })
        }
        ...
        PDFNet.Function.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("Function.getSDFObj", { f: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Highlights.prototype.copyCtor = function () {
          return PDFNet.sendWithPromise("Highlights.copyCtor", { hlts: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.Highlights, id)
          })
        ...
        PDFNet.Highlights.prototype.add = function (hlts) {
          ...
          return PDFNet.sendWithPromise("Highlights.add", { hlts2: this.id, hlts: hlts.id })
        }
        PDFNet.Highlights.prototype.saveToString = function () {
          return PDFNet.sendWithPromise("Highlights.saveToString", { hlts: this.id })
        }
        ...
        PDFNet.Highlights.prototype.begin = function (doc) {
          ...
          return PDFNet.sendWithPromise("Highlights.begin", { hlts: this.id, doc: doc.id })
        }
        ...
        PDFNet.Highlights.prototype.getCurrentPageNumber = function () {
          return PDFNet.sendWithPromise("Highlights.getCurrentPageNumber", { hlts: this.id })
        }
        PDFNet.Highlights.prototype.getCurrentTextRange = function () {
          return PDFNet.sendWithPromise("Highlights.getCurrentTextRange", { hlts: this.id }).then(
            function (id) {
        ...
        PDFNet.Image.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("Image.getSDFObj", { img: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Image.prototype.getImageData = function () {
          return PDFNet.sendWithPromise("Image.getImageData", { img: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Filter, id)
          })
        }
        PDFNet.Image.prototype.getImageDataSize = function () {
          return PDFNet.sendWithPromise("Image.getImageDataSize", { img: this.id })
        }
        PDFNet.Image.prototype.getImageColorSpace = function () {
          return PDFNet.sendWithPromise("Image.getImageColorSpace", { img: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ColorSpace, id)
            }
          )
        ...
        PDFNet.Image.prototype.getImageHeight = function () {
          return PDFNet.sendWithPromise("Image.getImageHeight", { img: this.id })
        }
        PDFNet.Image.prototype.getDecodeArray = function () {
          return PDFNet.sendWithPromise("Image.getDecodeArray", { img: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Image.prototype.getBitsPerComponent = function () {
          return PDFNet.sendWithPromise("Image.getBitsPerComponent", { img: this.id })
        }
        PDFNet.Image.prototype.getComponentNum = function () {
          return PDFNet.sendWithPromise("Image.getComponentNum", { img: this.id })
        }
        ...
        PDFNet.Image.prototype.isImageInterpolate = function () {
          return PDFNet.sendWithPromise("Image.isImageInterpolate", { img: this.id })
        }
        ...
        PDFNet.Image.prototype.setMaskWithObj = function (mask) {
          checkArguments(arguments.length, 1, "setMaskWithObj", "(PDFNet.Obj)", [
            [mask, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("Image.setMaskWithObj", { img: this.id, mask: mask.id })
        }
        PDFNet.Image.prototype.getSoftMask = function () {
          return PDFNet.sendWithPromise("Image.getSoftMask", { img: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Image.prototype.getImageRenderingIntent = function () {
          return PDFNet.sendWithPromise("Image.getImageRenderingIntent", { img: this.id })
        }
        PDFNet.Image.prototype.exportFromStream = function (writer) {
          checkArguments(arguments.length, 1, "exportFromStream", "(PDFNet.FilterWriter)", [
        ...
        PDFNet.Image.prototype.exportAsTiffFromStream = function (writer) {
          checkArguments(arguments.length, 1, "exportAsTiffFromStream", "(PDFNet.FilterWriter)", [
            [writer, "Object", PDFNet.FilterWriter, "FilterWriter"],
          ])
        ...
        PDFNet.Image.prototype.exportAsPngFromStream = function (writer) {
          checkArguments(arguments.length, 1, "exportAsPngFromStream", "(PDFNet.FilterWriter)", [
            [writer, "Object", PDFNet.FilterWriter, "FilterWriter"],
          ])
        ...
        PDFNet.PageLabel.prototype.compare = function (d) {
          ...
          return PDFNet.sendWithPromise("PageLabel.compare", { l: this, d: d }).then(function (id) {
            me.yieldFunction = void 0
            copyFunc(id.l, me)
            return id.result
          })
        ...
        PDFNet.PageLabel.prototype.setStyle = function (style) {
          ...
          return PDFNet.sendWithPromise("PageLabel.setStyle", { l: this, style: style }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.PageLabel.prototype.setPrefix = function (prefix) {
          ...
          return PDFNet.sendWithPromise("PageLabel.setPrefix", { l: this, prefix: prefix }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.PageLabel.prototype.setStart = function (start_at) {
          ...
          return PDFNet.sendWithPromise("PageLabel.setStart", { l: this, start_at: start_at }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.PageLabel.prototype.getFirstPageNum = function () {
          ...
          return PDFNet.sendWithPromise("PageLabel.getFirstPageNum", { l: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id.l, me)
        ...
        PDFNet.PageLabel.prototype.getLastPageNum = function () {
          ...
          return PDFNet.sendWithPromise("PageLabel.getLastPageNum", { l: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id.l, me)
        ...
        PDFNet.PageLabel.prototype.getSDFObj = function () {
          checkThisYieldFunction("getSDFObj", this.yieldFunction)
          return PDFNet.sendWithPromise("PageLabel.getSDFObj", { l: this }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.PageSet.createSinglePage = function (one_page) {
          ...
          return PDFNet.sendWithPromise("pageSetCreateSinglePage", { one_page: one_page }).then(
            function (id) {
              return createDestroyableObj(PDFNet.PageSet, id)
            }
          )
        ...
        PDFNet.PatternColor.create = function (pattern) {
          ...
          return PDFNet.sendWithPromise("patternColorCreate", { pattern: pattern.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.PatternColor, id)
            }
          )
        ...
        PDFNet.PatternColor.getTypeFromObj = function (pattern) {
          ...
          return PDFNet.sendWithPromise("patternColorGetTypeFromObj", { pattern: pattern.id })
        }
        ...
        PDFNet.PatternColor.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("PatternColor.getSDFObj", { pc: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.PatternColor.prototype.getMatrix = function () {
          return PDFNet.sendWithPromise("PatternColor.getMatrix", { pc: this.id }).then(function (
            id
          ) {
            return new PDFNet.Matrix2D(id)
          })
        ...
        PDFNet.PatternColor.prototype.getShading = function () {
          return PDFNet.sendWithPromise("PatternColor.getShading", { pc: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.Shading, id)
          })
        ...
        PDFNet.PatternColor.prototype.getTilingType = function () {
          return PDFNet.sendWithPromise("PatternColor.getTilingType", { pc: this.id })
        }
        PDFNet.PatternColor.prototype.getBBox = function () {
          return PDFNet.sendWithPromise("PatternColor.getBBox", { pc: this.id }).then(function (
            id
          ) {
            return new PDFNet.Rect(id)
          })
        ...
        PDFNet.PatternColor.prototype.getXStep = function () {
          return PDFNet.sendWithPromise("PatternColor.getXStep", { pc: this.id })
        }
        PDFNet.PatternColor.prototype.getYStep = function () {
          return PDFNet.sendWithPromise("PatternColor.getYStep", { pc: this.id })
        }
        ...
        PDFNet.ObjectIdentifier.createFromPredefined = function (in_oid_enum) {
          checkArguments(arguments.length, 1, "createFromPredefined", "(number)", [
            [in_oid_enum, "number"],
          ])
        ...
        PDFNet.ObjectIdentifier.createFromIntArray = function (in_list) {
          checkArguments(arguments.length, 1, "createFromIntArray", "(Array<number>)", [
            [in_list, "Array"],
          ])
        ...
        PDFNet.ObjectIdentifier.createFromDigestAlgorithm = function (in_algorithm) {
          checkArguments(arguments.length, 1, "createFromDigestAlgorithm", "(number)", [
            [in_algorithm, "number"],
          ])
        ...
        PDFNet.ObjectIdentifier.prototype.getRawValue = function () {
          return PDFNet.sendWithPromise("ObjectIdentifier.getRawValue", { self: this.id })
        }
        PDFNet.X501DistinguishedName.prototype.hasAttribute = function (in_oid) {
          checkArguments(arguments.length, 1, "hasAttribute", "(PDFNet.ObjectIdentifier)", [
        ...
        PDFNet.X509Certificate.createFromBuffer = function (in_cert_buf) {
          checkArguments(arguments.length, 1, "createFromBuffer", "(ArrayBuffer|TypedArray)", [
        ...
        PDFNet.X509Certificate.prototype.getIssuerField = function () {
          return PDFNet.sendWithPromise("X509Certificate.getIssuerField", { self: this.id }).then(
            function (id) {
        ...
        PDFNet.X509Certificate.prototype.getSubjectField = function () {
          return PDFNet.sendWithPromise("X509Certificate.getSubjectField", { self: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.X501DistinguishedName, id)
            }
          )
        ...
        PDFNet.X509Certificate.prototype.toString = function () {
          return PDFNet.sendWithPromise("X509Certificate.toString", { self: this.id })
        }
        ...
        PDFNet.X509Certificate.prototype.getSerialNumber = function () {
          return PDFNet.sendWithPromise("X509Certificate.getSerialNumber", { self: this.id }).then(
            function (id) {
              return new Uint8Array(id)
            }
          )
        ...
        PDFNet.X509Certificate.prototype.getExtensions = function () {
          return PDFNet.sendWithPromise("X509Certificate.getExtensions", { self: this.id }).then(
            function (idArray) {
              for (var retArray = [], i = 0; i < idArray.length; ++i) {
                var id = idArray[i]
                if ("0" === id) return null
        ...
        PDFNet.X509Certificate.prototype.getData = function () {
          return PDFNet.sendWithPromise("X509Certificate.getData", { self: this.id }).then(
            function (id) {
              return new Uint8Array(id)
            }
          )
        ...
        PDFNet.TimestampingConfiguration.prototype.setTimestampAuthorityServerURL = function (
          in_url
        ) {
          checkArguments(arguments.length, 1, "setTimestampAuthorityServerURL", "(string)", [
            [in_url, "string"],
          ])
        ...
        PDFNet.TimestampingConfiguration.prototype.setTimestampAuthorityServerUsername = function (
          in_username
        ) {
          checkArguments(arguments.length, 1, "setTimestampAuthorityServerUsername", "(string)", [
            [in_username, "string"],
          ])
          return PDFNet.sendWithPromise(
        ...
        PDFNet.TimestampingConfiguration.prototype.setTimestampAuthorityServerPassword = function (
          in_password
        ) {
          checkArguments(arguments.length, 1, "setTimestampAuthorityServerPassword", "(string)", [
            [in_password, "string"],
          ])
          return PDFNet.sendWithPromise(
        ...
        PDFNet.DigitalSignatureField.prototype.getSubFilter = function () {
          ...
          return PDFNet.sendWithPromise("DigitalSignatureField.getSubFilter", { self: this })
        }
        ...
        PDFNet.DigitalSignatureField.prototype.getLocation = function () {
          ...
          return PDFNet.sendWithPromise("DigitalSignatureField.getLocation", { self: this })
        }
        PDFNet.DigitalSignatureField.prototype.getReason = function () {
          checkThisYieldFunction("getReason", this.yieldFunction)
          return PDFNet.sendWithPromise("DigitalSignatureField.getReason", { self: this })
        }
        ...
        PDFNet.DigitalSignatureField.prototype.getCertCount = function () {
          ...
          return PDFNet.sendWithPromise("DigitalSignatureField.getCertCount", { self: this })
        }
        ...
        PDFNet.DigitalSignatureField.prototype.setDocumentPermissions = function (in_perms) {
          checkArguments(arguments.length, 1, "setDocumentPermissions", "(number)", [
            [in_perms, "number"],
          ])
        ...
        PDFNet.DigitalSignatureField.createFromField = function (in_field) {
          checkArguments(arguments.length, 1, "createFromField", "(PDFNet.Field)", [
        ...
        PDFNet.DigitalSignatureField.prototype.signOnNextSaveFromBuffer = function (
          in_pkcs12_buffer,
          in_password
        ) {
          checkArguments(
        ...
        PDFNet.DigitalSignatureField.prototype.signOnNextSaveWithCustomHandler = function (
          in_signature_handler_id
        ) {
          checkArguments(arguments.length, 1, "signOnNextSaveWithCustomHandler", "(number)", [
        ...
        PDFNet.DigitalSignatureField.prototype.certifyOnNextSaveFromBuffer = function (
          in_pkcs12_buffer,
          in_password
        ) {
          checkArguments(
        ...
        PDFNet.DigitalSignatureField.prototype.certifyOnNextSaveWithCustomHandler = function (
          in_signature_handler_id
        ) {
          checkArguments(arguments.length, 1, "certifyOnNextSaveWithCustomHandler", "(number)", [
            [in_signature_handler_id, "number"],
          ])
        ...
        PDFNet.DigitalSignatureField.prototype.getSDFObj = function () {
          checkThisYieldFunction("getSDFObj", this.yieldFunction)
          return PDFNet.sendWithPromise("DigitalSignatureField.getSDFObj", { self: this }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.DigitalSignatureField.prototype.getByteRanges = function () {
          ...
          return PDFNet.sendWithPromise("DigitalSignatureField.getByteRanges", { self: this }).then(
            function (idArray) {
              for (var retArray = [], i = 0; i < idArray.length; ++i) {
                var id = idArray[i]
                if ("0" === id) return null
        ...
        PDFNet.DigitalSignatureField.prototype.enableLTVOfflineVerification = function (
        ...
        PDFNet.DigitalSignatureField.prototype.setPreferredDigestAlgorithm = function (
          in_digest_algorithm_type,
          in_make_mandatory
        ) {
          "undefined" === typeof in_make_mandatory && (in_make_mandatory = !0)
        ...
        PDFNet.DigitalSignatureField.prototype.createSigDictForCustomCertification = function (
          in_filter_name,
          in_subfilter_type,
        ...
        PDFNet.DigitalSignatureField.prototype.createSigDictForCustomSigning = function (
          in_filter_name,
          in_subfilter_type,
          in_contents_size_to_reserve
        ) {
        ...
        PDFNet.DigitalSignatureField.prototype.setSigDictTimeOfSigning = function (in_date) {
          checkArguments(arguments.length, 1, "setSigDictTimeOfSigning", "(PDFNet.Date)", [
        ...
        PDFNet.DigitalSignatureField.generateESSSigningCertPAdESAttribute = function (
          in_signer_cert,
          in_digest_algorithm_type
        ) {
          checkArguments(
        ...
        PDFNet.PDFDoc.createFromFilter = function (stream) {
          checkArguments(arguments.length, 1, "createFromFilter", "(PDFNet.Filter)", [
            [stream, "Object", PDFNet.Filter, "Filter"],
          ])
          0 != stream.id && avoidCleanup(stream.id)
        ...
        PDFNet.PDFDoc.createFromBuffer = function (buf) {
          ...
          var bufArrayBuffer = getArrayBuffer(buf, !1)
          return PDFNet.sendWithPromise("pdfDocCreateFromBuffer", { buf: bufArrayBuffer }).then(
            function (id) {
              return createDestroyableObj(PDFNet.PDFDoc, id)
            }
          )
        ...
        PDFNet.PDFDoc.createFromLayoutEls = function (buf) {
          checkArguments(arguments.length, 1, "createFromLayoutEls", "(ArrayBuffer|TypedArray)", [
            [buf, "ArrayBuffer"],
          ])
          var bufArrayBuffer = getArrayBuffer(buf, !1)
          return PDFNet.sendWithPromise("pdfDocCreateFromLayoutEls", { buf: bufArrayBuffer }).then(
            function (id) {
              return createDestroyableObj(PDFNet.PDFDoc, id)
            }
          )
        ...
        PDFNet.PDFDoc.prototype.createShallowCopy = function () {
          return PDFNet.sendWithPromise("PDFDoc.createShallowCopy", { source: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.PDFDoc, id)
            }
          )
        ...
        PDFNet.PDFDoc.prototype.initStdSecurityHandlerUString = function (password) {
          checkArguments(arguments.length, 1, "initStdSecurityHandlerUString", "(string)", [
            [password, "string"],
          ])
        ...
        PDFNet.PDFDoc.prototype.getSecurityHandler = function () {
          return PDFNet.sendWithPromise("PDFDoc.getSecurityHandler", { doc: this.id }).then(
            function (id) {
        ...
        PDFNet.PDFDoc.prototype.removeSecurity = function () {
          return PDFNet.sendWithPromise("PDFDoc.removeSecurity", { doc: this.id })
        }
        PDFNet.PDFDoc.prototype.getDocInfo = function () {
          return PDFNet.sendWithPromise("PDFDoc.getDocInfo", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.PDFDocInfo, id)
          })
        }
        PDFNet.PDFDoc.prototype.getViewPrefs = function () {
          return PDFNet.sendWithPromise("PDFDoc.getViewPrefs", { doc: this.id }).then(function (
            id
          ) {
        ...
        PDFNet.PDFDoc.prototype.hasRepairedXRef = function () {
          return PDFNet.sendWithPromise("PDFDoc.hasRepairedXRef", { doc: this.id })
        }
        ...
        PDFNet.PDFDoc.prototype.pageRemove = function (page_itr) {
          checkArguments(arguments.length, 1, "pageRemove", "(PDFNet.Iterator)", [
        ...
        PDFNet.PDFDoc.prototype.pagePushFront = function (page) {
          checkArguments(arguments.length, 1, "pagePushFront", "(PDFNet.Page)", [
            [page, "Object", PDFNet.Page, "Page"],
          ])
          return PDFNet.sendWithPromise("PDFDoc.pagePushFront", { doc: this.id, page: page.id })
        }
        PDFNet.PDFDoc.prototype.pagePushBack = function (page) {
          checkArguments(arguments.length, 1, "pagePushBack", "(PDFNet.Page)", [
            [page, "Object", PDFNet.Page, "Page"],
          ])
          return PDFNet.sendWithPromise("PDFDoc.pagePushBack", { doc: this.id, page: page.id })
        }
        ...
        PDFNet.PDFDoc.prototype.getFirstBookmark = function () {
          return PDFNet.sendWithPromise("PDFDoc.getFirstBookmark", { doc: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Bookmark, id)
          })
        ...
        PDFNet.PDFDoc.prototype.addRootBookmark = function (root_bookmark) {
          checkArguments(arguments.length, 1, "addRootBookmark", "(PDFNet.Bookmark)", [
        ...
        PDFNet.PDFDoc.prototype.getTrailer = function () {
          return PDFNet.sendWithPromise("PDFDoc.getTrailer", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.PDFDoc.prototype.getRoot = function () {
          return PDFNet.sendWithPromise("PDFDoc.getRoot", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.PDFDoc.prototype.jsContextInitialize = function () {
          return PDFNet.sendWithPromise("PDFDoc.jsContextInitialize", { doc: this.id })
        }
        PDFNet.PDFDoc.prototype.getPages = function () {
          return PDFNet.sendWithPromise("PDFDoc.getPages", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.PDFDoc.prototype.getDownloadedByteCount = function () {
          return PDFNet.sendWithPromise("PDFDoc.getDownloadedByteCount", { doc: this.id })
        }
        PDFNet.PDFDoc.prototype.getTotalRemoteByteCount = function () {
          return PDFNet.sendWithPromise("PDFDoc.getTotalRemoteByteCount", { doc: this.id })
        }
        PDFNet.PDFDoc.prototype.getFieldIteratorBegin = function () {
          return PDFNet.sendWithPromise("PDFDoc.getFieldIteratorBegin", { doc: this.id }).then(
            function (id) {
        ...
        PDFNet.PDFDoc.prototype.refreshFieldAppearances = function () {
          return PDFNet.sendWithPromise("PDFDoc.refreshFieldAppearances", { doc: this.id })
        }
        PDFNet.PDFDoc.prototype.refreshAnnotAppearances = function (options) {
          "undefined" === typeof options && (options = null)
          checkArguments(arguments.length, 0, "refreshAnnotAppearances", "(PDFNet.OptionBase)", [
            [options, "OptionBase"],
          ])
        ...
        PDFNet.PDFDoc.prototype.flattenAnnotations = function (forms_only) {
          ...
          checkArguments(arguments.length, 0, "flattenAnnotations", "(boolean)", [
            [forms_only, "boolean"],
          ])
        ...
        PDFNet.PDFDoc.prototype.flattenAnnotationsAdvanced = function (flags) {
          checkArguments(arguments.length, 1, "flattenAnnotationsAdvanced", "(number)", [
            [flags, "number"],
          ])
          return PDFNet.sendWithPromise("PDFDoc.flattenAnnotationsAdvanced", {
            doc: this.id,
            flags: flags,
          })
        }
        PDFNet.PDFDoc.prototype.getAcroForm = function () {
          return PDFNet.sendWithPromise("PDFDoc.getAcroForm", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.PDFDoc.prototype.fdfExtract = function (flag) {
          ...
          return PDFNet.sendWithPromise("PDFDoc.fdfExtract", { doc: this.id, flag: flag }).then(
            function (id) {
              return createDestroyableObj(PDFNet.FDFDoc, id)
            }
          )
        ...
        PDFNet.PDFDoc.prototype.fdfMerge = function (fdf_doc) {
          ...
          return PDFNet.sendWithPromise("PDFDoc.fdfMerge", { doc: this.id, fdf_doc: fdf_doc.id })
        }
        PDFNet.PDFDoc.prototype.fdfUpdate = function (fdf_doc) {
          ...
          return PDFNet.sendWithPromise("PDFDoc.fdfUpdate", { doc: this.id, fdf_doc: fdf_doc.id })
        }
        PDFNet.PDFDoc.prototype.getOpenAction = function () {
          return PDFNet.sendWithPromise("PDFDoc.getOpenAction", { doc: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Action, id)
          })
        ...
        PDFNet.PDFDoc.prototype.setOpenAction = function (action) {
          checkArguments(arguments.length, 1, "setOpenAction", "(PDFNet.Action)", [
            [action, "Object", PDFNet.Action, "Action"],
          ])
          return PDFNet.sendWithPromise("PDFDoc.setOpenAction", { doc: this.id, action: action.id })
        }
        ...
        PDFNet.PDFDoc.prototype.getStructTree = function () {
          return PDFNet.sendWithPromise("PDFDoc.getStructTree", { doc: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.STree, id)
          })
        ...
        PDFNet.PDFDoc.prototype.getOCGs = function () {
          return PDFNet.sendWithPromise("PDFDoc.getOCGs", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.PDFDoc.prototype.getOCGConfig = function () {
          return PDFNet.sendWithPromise("PDFDoc.getOCGConfig", { doc: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.OCGConfig, id)
          })
        ...
        PDFNet.PDFDoc.prototype.createIndirectArray = function () {
          return PDFNet.sendWithPromise("PDFDoc.createIndirectArray", { doc: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.PDFDoc.prototype.createIndirectBool = function (value) {
          checkArguments(arguments.length, 1, "createIndirectBool", "(boolean)", [
            [value, "boolean"],
          ])
        ...
        PDFNet.PDFDoc.prototype.createIndirectDict = function () {
          return PDFNet.sendWithPromise("PDFDoc.createIndirectDict", { doc: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.PDFDoc.prototype.createIndirectNull = function () {
          return PDFNet.sendWithPromise("PDFDoc.createIndirectNull", { doc: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.PDFDoc.prototype.createIndirectNumber = function (value) {
          checkArguments(arguments.length, 1, "createIndirectNumber", "(number)", [
            [value, "number"],
          ])
        ...
        PDFNet.PDFDoc.prototype.createIndirectStringFromUString = function (str) {
          checkArguments(arguments.length, 1, "createIndirectStringFromUString", "(string)", [
            [str, "string"],
          ])
        ...
        PDFNet.PDFDoc.prototype.createIndirectStream = function (data_buf, filter_chain) {
          checkArguments(
            arguments.length,
            2,
        ...
        PDFNet.PDFDoc.prototype.getSDFDoc = function () {
          return PDFNet.sendWithPromise("PDFDoc.getSDFDoc", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.SDFDoc, id)
          })
        }
        ...
        PDFNet.PDFDoc.prototype.unlockRead = function () {
          var me = this
          return PDFNet.sendWithPromise("PDFDoc.unlockRead", { doc: this.id }).then(function () {
            unregisterLockedObject(me)
          })
        }
        PDFNet.PDFDoc.prototype.addHighlights = function (hilite) {
          ...
          return PDFNet.sendWithPromise("PDFDoc.addHighlights", { doc: this.id, hilite: hilite })
        }
        ...
        PDFNet.PDFDoc.prototype.hasSignatures = function () {
          return PDFNet.sendWithPromise("PDFDoc.hasSignatures", { doc: this.id })
        }
        ...
        PDFNet.PDFDoc.prototype.removeSignatureHandler = function (signature_handler_id) {
          checkArguments(arguments.length, 1, "removeSignatureHandler", "(number)", [
            [signature_handler_id, "number"],
          ])
        ...
        PDFNet.PDFDoc.prototype.getSignatureHandler = function (signature_handler_id) {
          checkArguments(arguments.length, 1, "getSignatureHandler", "(number)", [
            [signature_handler_id, "number"],
          ])
        ...
        PDFNet.PDFDoc.prototype.generateThumbnails = function (size) {
          ...
          return PDFNet.sendWithPromise("PDFDoc.generateThumbnails", { doc: this.id, size: size })
        }
        ...
        PDFNet.PDFDoc.prototype.getGeometryCollectionForPage = function (page_num) {
          checkArguments(arguments.length, 1, "getGeometryCollectionForPage", "(number)", [
            [page_num, "number"],
          ])
        ...
        PDFNet.PDFDoc.prototype.getUndoManager = function () {
          return PDFNet.sendWithPromise("PDFDoc.getUndoManager", { doc: this.id }).then(function (
            id
          ) {
        ...
        PDFNet.PDFDoc.prototype.createDigitalSignatureField = function (in_sig_field_name) {
          ...
          checkArguments(arguments.length, 0, "createDigitalSignatureField", "(string)", [
        ...
        PDFNet.PDFDoc.prototype.saveViewerOptimizedBuffer = function (opts$jscomp$0) {
          ...
          if ("PDFNet.PDFDoc.ViewerOptimizedOptions" === opts$jscomp$0.name) {
            var optsCopy = opts$jscomp$0
            opts$jscomp$0 = PDFNet.ObjSet.create().then(function (set) {
              return set.createFromJson(JSON.stringify(optsCopy))
            })
          } else opts$jscomp$0 = Promise.resolve(opts$jscomp$0)
          var me = this
        ...
        PDFNet.PDFDocInfo.prototype.getTitle = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getTitle", { info: this.id })
        }
        PDFNet.PDFDocInfo.prototype.getTitleObj = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getTitleObj", { info: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.PDFDocInfo.prototype.setTitle = function (title) {
          checkArguments(arguments.length, 1, "setTitle", "(string)", [[title, "string"]])
          return PDFNet.sendWithPromise("PDFDocInfo.setTitle", { info: this.id, title: title })
        }
        PDFNet.PDFDocInfo.prototype.getAuthor = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getAuthor", { info: this.id })
        }
        PDFNet.PDFDocInfo.prototype.getAuthorObj = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getAuthorObj", { info: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.PDFDocInfo.prototype.setAuthor = function (author) {
          ...
          return PDFNet.sendWithPromise("PDFDocInfo.setAuthor", { info: this.id, author: author })
        }
        PDFNet.PDFDocInfo.prototype.getSubject = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getSubject", { info: this.id })
        }
        PDFNet.PDFDocInfo.prototype.getSubjectObj = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getSubjectObj", { info: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.PDFDocInfo.prototype.getKeywords = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getKeywords", { info: this.id })
        }
        PDFNet.PDFDocInfo.prototype.getKeywordsObj = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getKeywordsObj", { info: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.PDFDocInfo.prototype.getCreator = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getCreator", { info: this.id })
        }
        PDFNet.PDFDocInfo.prototype.getCreatorObj = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getCreatorObj", { info: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.PDFDocInfo.prototype.getProducer = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getProducer", { info: this.id })
        }
        PDFNet.PDFDocInfo.prototype.getProducerObj = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getProducerObj", { info: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.PDFDocInfo.prototype.getCreationDate = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getCreationDate", { info: this.id }).then(
            function (id) {
              return new PDFNet.Date(id)
            }
          )
        ...
        PDFNet.PDFDocInfo.prototype.setCreationDate = function (creation_date) {
          checkArguments(arguments.length, 1, "setCreationDate", "(PDFNet.Date)", [
        ...
        PDFNet.PDFDocInfo.prototype.getModDate = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getModDate", { info: this.id }).then(function (
            id
          ) {
            return new PDFNet.Date(id)
          })
        ...
        PDFNet.PDFDocInfo.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.getSDFObj", { info: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.PDFDocInfo.prototype.copy = function () {
          return PDFNet.sendWithPromise("PDFDocInfo.copy", { info: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.PDFDocInfo, id)
          })
        }
        PDFNet.PDFDocViewPrefs.prototype.setInitialPage = function (dest) {
          checkArguments(arguments.length, 1, "setInitialPage", "(PDFNet.Destination)", [
            [dest, "Object", PDFNet.Destination, "Destination"],
          ])
        ...
        PDFNet.PDFDocViewPrefs.prototype.setPageMode = function (mode) {
          ...
          return PDFNet.sendWithPromise("PDFDocViewPrefs.setPageMode", { p: this.id, mode: mode })
        }
        PDFNet.PDFDocViewPrefs.prototype.getPageMode = function () {
          return PDFNet.sendWithPromise("PDFDocViewPrefs.getPageMode", { p: this.id })
        }
        PDFNet.PDFDocViewPrefs.prototype.setLayoutMode = function (mode) {
          ...
          return PDFNet.sendWithPromise("PDFDocViewPrefs.setLayoutMode", { p: this.id, mode: mode })
        }
        PDFNet.PDFDocViewPrefs.prototype.getLayoutMode = function () {
          return PDFNet.sendWithPromise("PDFDocViewPrefs.getLayoutMode", { p: this.id })
        }
        ...
        PDFNet.PDFDocViewPrefs.prototype.getPref = function (pref) {
          ...
          return PDFNet.sendWithPromise("PDFDocViewPrefs.getPref", { p: this.id, pref: pref })
        }
        PDFNet.PDFDocViewPrefs.prototype.setNonFullScreenPageMode = function (mode) {
          checkArguments(arguments.length, 1, "setNonFullScreenPageMode", "(number)", [
            [mode, "number"],
          ])
        ...
        PDFNet.PDFDocViewPrefs.prototype.getDirection = function () {
          return PDFNet.sendWithPromise("PDFDocViewPrefs.getDirection", { p: this.id })
        }
        PDFNet.PDFDocViewPrefs.prototype.setViewArea = function (box) {
          checkArguments(arguments.length, 1, "setViewArea", "(number)", [[box, "number"]])
          return PDFNet.sendWithPromise("PDFDocViewPrefs.setViewArea", { p: this.id, box: box })
        }
        PDFNet.PDFDocViewPrefs.prototype.getViewArea = function () {
          return PDFNet.sendWithPromise("PDFDocViewPrefs.getViewArea", { p: this.id })
        }
        PDFNet.PDFDocViewPrefs.prototype.setViewClip = function (box) {
          checkArguments(arguments.length, 1, "setViewClip", "(number)", [[box, "number"]])
          return PDFNet.sendWithPromise("PDFDocViewPrefs.setViewClip", { p: this.id, box: box })
        }
        PDFNet.PDFDocViewPrefs.prototype.getViewClip = function () {
          return PDFNet.sendWithPromise("PDFDocViewPrefs.getViewClip", { p: this.id })
        }
        PDFNet.PDFDocViewPrefs.prototype.setPrintArea = function (box) {
          ...
          return PDFNet.sendWithPromise("PDFDocViewPrefs.setPrintArea", { p: this.id, box: box })
        }
        PDFNet.PDFDocViewPrefs.prototype.getPrintArea = function () {
          return PDFNet.sendWithPromise("PDFDocViewPrefs.getPrintArea", { p: this.id })
        }
        PDFNet.PDFDocViewPrefs.prototype.setPrintClip = function (box) {
          ...
          return PDFNet.sendWithPromise("PDFDocViewPrefs.setPrintClip", { p: this.id, box: box })
        }
        PDFNet.PDFDocViewPrefs.prototype.getPrintClip = function () {
          return PDFNet.sendWithPromise("PDFDocViewPrefs.getPrintClip", { p: this.id })
        }
        PDFNet.PDFDocViewPrefs.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("PDFDocViewPrefs.getSDFObj", { p: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.PDFDocViewPrefs.create = function (tr) {
          ...
          return PDFNet.sendWithPromise("pdfDocViewPrefsCreate", { tr: tr.id }).then(function (id) {
            return createPDFNetObj(PDFNet.PDFDocViewPrefs, id)
          })
        }
        PDFNet.PDFDocViewPrefs.prototype.copy = function () {
          return PDFNet.sendWithPromise("PDFDocViewPrefs.copy", { prefs: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.PDFDocViewPrefs, id)
          })
        ...
        PDFNet.PDFRasterizer.create = function (type) {
          ...
          return PDFNet.sendWithPromise("pdfRasterizerCreate", { type: type }).then(function (id) {
        ...
        PDFNet.PDFRasterizer.prototype.setDrawAnnotations = function (render_annots) {
          checkArguments(arguments.length, 1, "setDrawAnnotations", "(boolean)", [
        ...
        PDFNet.PDFRasterizer.prototype.setHighlightFields = function (highlight) {
          checkArguments(arguments.length, 1, "setHighlightFields", "(boolean)", [
            [highlight, "boolean"],
          ])
        ...
        PDFNet.PDFRasterizer.prototype.setOCGContext = function (ctx) {
          ...
          return PDFNet.sendWithPromise("PDFRasterizer.setOCGContext", { r: this.id, ctx: ctx.id })
        }
        ...
        PDFNet.PDFRasterizer.prototype.setOverprint = function (op) {
          ...
          return PDFNet.sendWithPromise("PDFRasterizer.setOverprint", { r: this.id, op: op })
        }
        ...
        PDFNet.PDFDraw.prototype.setOCGContext = function (ctx) {
          ...
          return PDFNet.sendWithPromise("PDFDraw.setOCGContext", { r: this.id, ctx: ctx.id })
        }
        ...
        PDFNet.PDFRasterizer.prototype.getRasterizerType = function () {
          return PDFNet.sendWithPromise("PDFRasterizer.getRasterizerType", { r: this.id })
        }
        PDFNet.PDFRasterizer.prototype.setColorPostProcessMode = function (mode) {
          checkArguments(arguments.length, 1, "setColorPostProcessMode", "(number)", [
            [mode, "number"],
          ])
        ...
        PDFNet.PDFRasterizer.prototype.enableDisplayListCaching = function (enabled) {
          checkArguments(arguments.length, 1, "enableDisplayListCaching", "(boolean)", [
            [enabled, "boolean"],
          ])
        ...
        PDFNet.PDFRasterizer.prototype.updateBuffer = function () {
          return PDFNet.sendWithPromise("PDFRasterizer.updateBuffer", { r: this.id })
        }
        ...
        PDFNet.PDFDraw.prototype.setRasterizerType = function (type) {
          checkArguments(arguments.length, 1, "setRasterizerType", "(number)", [[type, "number"]])
          return PDFNet.sendWithPromise("PDFDraw.setRasterizerType", { d: this.id, type: type })
        }
        PDFNet.PDFDraw.prototype.setDPI = function (dpi) {
          checkArguments(arguments.length, 1, "setDPI", "(number)", [[dpi, "number"]])
          return PDFNet.sendWithPromise("PDFDraw.setDPI", { d: this.id, dpi: dpi })
        }
        ...
        PDFNet.PDFDraw.prototype.setPageBox = function (region) {
          ...
          return PDFNet.sendWithPromise("PDFDraw.setPageBox", { d: this.id, region: region })
        }
        PDFNet.PDFDraw.prototype.setClipRect = function (rect) {
          ...
          return PDFNet.sendWithPromise("PDFDraw.setClipRect", { d: this.id, rect: rect })
        }
        PDFNet.PDFDraw.prototype.setFlipYAxis = function (flip_y) {
          ...
          return PDFNet.sendWithPromise("PDFDraw.setFlipYAxis", { d: this.id, flip_y: flip_y })
        }
        PDFNet.PDFDraw.prototype.setRotate = function (angle) {
          checkArguments(arguments.length, 1, "setRotate", "(number)", [[angle, "number"]])
          return PDFNet.sendWithPromise("PDFDraw.setRotate", { d: this.id, angle: angle })
        }
        ...
        PDFNet.PDFDraw.prototype.setGamma = function (exp) {
          ...
          return PDFNet.sendWithPromise("PDFDraw.setGamma", { d: this.id, exp: exp })
        }
        ...
        PDFNet.PDFDraw.prototype.setPageTransparent = function (is_transparent) {
          checkArguments(arguments.length, 1, "setPageTransparent", "(boolean)", [
        ...
        PDFNet.PDFDraw.prototype.setOverprint = function (op) {
          checkArguments(arguments.length, 1, "setOverprint", "(number)", [[op, "number"]])
          return PDFNet.sendWithPromise("PDFDraw.setOverprint", { d: this.id, op: op })
        }
        ...
        PDFNet.PDFDraw.prototype.setCaching = function (enabled) {
          "undefined" === typeof enabled && (enabled = !0)
          checkArguments(arguments.length, 0, "setCaching", "(boolean)", [[enabled, "boolean"]])
          return PDFNet.sendWithPromise("PDFDraw.setCaching", { d: this.id, enabled: enabled })
        }
        ...
        PDFNet.PDFDraw.prototype.getSeparationBitmaps = function (page) {
          checkArguments(arguments.length, 1, "getSeparationBitmaps", "(PDFNet.Page)", [
            [page, "Object", PDFNet.Page, "Page"],
          ])
        ...
        PDFNet.enableJavaScript = function (enable) {
          ...
          return PDFNet.sendWithPromise("pdfNetEnableJavaScript", { enable: enable })
        }
        ...
        PDFNet.setDefaultFlateCompressionLevel = function (level) {
          checkArguments(arguments.length, 1, "setDefaultFlateCompressionLevel", "(number)", [
            [level, "number"],
          ])
        ...
        PDFNet.addPDFTronCustomHandler = function (custom_id) {
          checkArguments(arguments.length, 1, "addPDFTronCustomHandler", "(number)", [
            [custom_id, "number"],
          ])
          return PDFNet.sendWithPromise("pdfNetAddPDFTronCustomHandler", { custom_id: custom_id })
        }
        ...
        PDFNet.setConnectionErrorHandlingMode = function (mode) {
          checkArguments(arguments.length, 1, "setConnectionErrorHandlingMode", "(number)", [
            [mode, "number"],
          ])
        ...
        PDFNet.Rect.init = function (x1, y1, x2, y2) {
          ...
          return PDFNet.sendWithPromise("rectInit", { x1: x1, y1: y1, x2: x2, y2: y2 }).then(
            function (id) {
              return new PDFNet.Rect(id)
            }
          )
        ...
        PDFNet.Rect.prototype.attach = function (obj) {
          ...
          return PDFNet.sendWithPromise("Rect.attach", { rect: this, obj: obj.id }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id, me)
        ...
        PDFNet.Rect.prototype.update = function (obj) {
          ...
          return PDFNet.sendWithPromise("Rect.update", { rect: this, obj: obj.id }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id.rect, me)
        ...
        PDFNet.Rect.prototype.contains = function (x, y) {
          ...
          return PDFNet.sendWithPromise("Rect.contains", { rect: this, x: x, y: y })
        }
        ...
        PDFNet.Rect.prototype.inflate1 = function (amount) {
          ...
          return PDFNet.sendWithPromise("Rect.inflate1", { rect: this, amount: amount }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id, me)
            }
        ...
        PDFNet.Rect.prototype.inflate2 = function (x, y) {
          ...
          return PDFNet.sendWithPromise("Rect.inflate2", { rect: this, x: x, y: y }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id, me)
        ...
        PDFNet.Redactor.redactionDestroy = function (redaction) {
          checkArguments(arguments.length, 1, "redactionDestroy", "(PDFNet.Redaction)", [
            [redaction, "Object", PDFNet.Redaction, "Redaction"],
          ])
          return PDFNet.sendWithPromise("Redactor.redactionDestroy", { redaction: redaction.id })
        }
        PDFNet.Redactor.redactionCopy = function (other) {
          checkArguments(arguments.length, 1, "redactionCopy", "(PDFNet.Redaction)", [
            [other, "Object", PDFNet.Redaction, "Redaction"],
          ])
          return PDFNet.sendWithPromise("Redactor.redactionCopy", { other: other.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Redaction, id)
            }
          )
        ...
        PDFNet.Shading.create = function (shading_dict) {
          ...
          return PDFNet.sendWithPromise("shadingCreate", { shading_dict: shading_dict.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.Shading, id)
            }
          )
        ...
        PDFNet.Shading.getTypeFromObj = function (shading_dict) {
          ...
          return PDFNet.sendWithPromise("shadingGetTypeFromObj", { shading_dict: shading_dict.id })
        }
        ...
        PDFNet.Shading.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("Shading.getSDFObj", { s: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.Shading.prototype.getBaseColorSpace = function () {
          return PDFNet.sendWithPromise("Shading.getBaseColorSpace", { s: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorSpace, id)
          })
        ...
        PDFNet.Shading.prototype.getBackground = function () {
          return PDFNet.sendWithPromise("Shading.getBackground", { s: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        ...
        PDFNet.Shading.prototype.getColor = function (t) {
          ...
          return PDFNet.sendWithPromise("Shading.getColor", { s: this.id, t: t }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.ColorPt, id)
          })
        ...
        PDFNet.Shading.prototype.getCoordsRadial = function () {
          return PDFNet.sendWithPromise("Shading.getCoordsRadial", { s: this.id })
        }
        ...
        PDFNet.Shading.prototype.getMatrix = function () {
          return PDFNet.sendWithPromise("Shading.getMatrix", { s: this.id }).then(function (id) {
            return new PDFNet.Matrix2D(id)
          })
        }
        ...
        PDFNet.Stamper.create = function (size_type, a, b) {
          ...
          return PDFNet.sendWithPromise("stamperCreate", { size_type: size_type, a: a, b: b }).then(
            function (id) {
        ...
        PDFNet.Stamper.prototype.setFont = function (font) {
          ...
          return PDFNet.sendWithPromise("Stamper.setFont", { stamp: this.id, font: font.id })
        }
        PDFNet.Stamper.prototype.setFontColor = function (font_color) {
          checkArguments(arguments.length, 1, "setFontColor", "(PDFNet.ColorPt)", [
        ...
        PDFNet.Stamper.prototype.setOpacity = function (opacity) {
          ...
          return PDFNet.sendWithPromise("Stamper.setOpacity", { stamp: this.id, opacity: opacity })
        }
        ...
        PDFNet.Stamper.hasStamps = function (doc, page_set) {
          ...
          return PDFNet.sendWithPromise("stamperHasStamps", { doc: doc.id, page_set: page_set.id })
        }
        ...
        PDFNet.TextExtractor.prototype.setOCGContext = function (ctx) {
          ...
          return PDFNet.sendWithPromise("TextExtractor.setOCGContext", { te: this.id, ctx: ctx.id })
        }
        ...
        PDFNet.TextExtractor.prototype.getWordCount = function () {
          return PDFNet.sendWithPromise("TextExtractor.getWordCount", { te: this.id })
        }
        PDFNet.TextExtractor.prototype.setRightToLeftLanguage = function (rtl) {
          checkArguments(arguments.length, 1, "setRightToLeftLanguage", "(boolean)", [
            [rtl, "boolean"],
          ])
        ...
        PDFNet.TextExtractor.prototype.getTextUnderAnnot = function (annot) {
          checkArguments(arguments.length, 1, "getTextUnderAnnot", "(PDFNet.Annot)", [
            [annot, "Object", PDFNet.Annot, "Annot"],
          ])
        ...
        PDFNet.TextExtractor.prototype.getHighlights = function (char_ranges, char_ranges_size) {
          checkArguments(arguments.length, 2, "getHighlights", "(number, number)", [
            [char_ranges, "number"],
            [char_ranges_size, "number"],
          ])
          return PDFNet.sendWithPromise("TextExtractor.getHighlights", {
            te: this.id,
            char_ranges: char_ranges,
            char_ranges_size: char_ranges_size,
          }).then(function (id) {
            return createDestroyableObj(PDFNet.Highlights, id)
          })
        }
        PDFNet.TextExtractorStyle.prototype.getFont = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorStyle.getFont", { tes: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            id.result = createPDFNetObj(PDFNet.Obj, id.result)
        ...
        PDFNet.TextExtractorStyle.prototype.getFontName = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorStyle.getFontName", { tes: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.tes, me)
              return id.result
        ...
        PDFNet.TextExtractorStyle.prototype.getFontSize = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorStyle.getFontSize", { tes: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.tes, me)
              return id.result
        ...
        PDFNet.TextExtractorStyle.prototype.getWeight = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorStyle.getWeight", { tes: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.tes, me)
              return id.result
        ...
        PDFNet.TextExtractorStyle.prototype.isItalic = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorStyle.isItalic", { tes: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.tes, me)
              return id.result
        ...
        PDFNet.TextExtractorStyle.prototype.isSerif = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorStyle.isSerif", { tes: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id.tes, me)
        ...
        PDFNet.TextExtractorStyle.prototype.compare = function (s) {
          checkArguments(arguments.length, 1, "compare", "(PDFNet.TextExtractorStyle)", [
            [s, "Structure", PDFNet.TextExtractorStyle, "TextExtractorStyle"],
          ])
          checkThisYieldFunction("compare", this.yieldFunction)
          checkParamsYieldFunction("compare", [[s, 0]])
          return PDFNet.sendWithPromise("TextExtractorStyle.compare", { tes: this, s: s })
        }
        ...
        PDFNet.TextExtractorStyle.prototype.copy = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorStyle.copy", { s: this }).then(function (id) {
            me.yieldFunction = void 0
        ...
        PDFNet.TextExtractorWord.prototype.getNumGlyphs = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorWord.getNumGlyphs", { tew: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.tew, me)
              return id.result
        ...
        PDFNet.TextExtractorWord.prototype.getStyle = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorWord.getStyle", { tew: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            id.result = new PDFNet.TextExtractorStyle(id.result)
        ...
        PDFNet.TextExtractorWord.prototype.getStringLen = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorWord.getStringLen", { tew: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.tew, me)
              return id.result
        ...
        PDFNet.TextExtractorWord.prototype.getNextWord = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorWord.getNextWord", { tew: this }).then(
            function (id) {
              me.yieldFunction = void 0
        ...
        PDFNet.TextExtractorWord.prototype.getCurrentNum = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorWord.getCurrentNum", { tew: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.tew, me)
              return id.result
        ...
        PDFNet.TextExtractorWord.prototype.compare = function (word) {
          checkArguments(arguments.length, 1, "compare", "(PDFNet.TextExtractorWord)", [
            [word, "Structure", PDFNet.TextExtractorWord, "TextExtractorWord"],
          ])
          checkThisYieldFunction("compare", this.yieldFunction)
          checkParamsYieldFunction("compare", [[word, 0]])
          return PDFNet.sendWithPromise("TextExtractorWord.compare", { tew: this, word: word })
        }
        ...
        PDFNet.TextExtractorWord.prototype.isValid = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorWord.isValid", { tew: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id.tew, me)
        ...
        PDFNet.TextExtractorLine.prototype.getNumWords = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.getNumWords", { line: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.line, me)
              return id.result
        ...
        PDFNet.TextExtractorLine.prototype.isSimpleLine = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.isSimpleLine", { line: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.line, me)
              return id.result
        ...
        PDFNet.TextExtractorLine.prototype.getFirstWord = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.getFirstWord", { line: this }).then(
            function (id) {
              me.yieldFunction = void 0
              id.result = new PDFNet.TextExtractorWord(id.result)
              copyFunc(id.line, me)
        ...
        PDFNet.TextExtractorLine.prototype.getNextLine = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.getNextLine", { line: this }).then(
            function (id) {
              me.yieldFunction = void 0
        ...
        PDFNet.TextExtractorLine.prototype.getCurrentNum = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.getCurrentNum", { line: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.line, me)
              return id.result
        ...
        PDFNet.TextExtractorLine.prototype.getStyle = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.getStyle", { line: this }).then(
            function (id) {
              me.yieldFunction = void 0
              id.result = new PDFNet.TextExtractorStyle(id.result)
              copyFunc(id.line, me)
        ...
        PDFNet.TextExtractorLine.prototype.getParagraphID = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.getParagraphID", { line: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.line, me)
              return id.result
        ...
        PDFNet.TextExtractorLine.prototype.getFlowID = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.getFlowID", { line: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.line, me)
              return id.result
        ...
        PDFNet.TextExtractorLine.prototype.endsWithHyphen = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.endsWithHyphen", { line: this }).then(
            function (id) {
              me.yieldFunction = void 0
              copyFunc(id.line, me)
              return id.result
        ...
        PDFNet.TextExtractorLine.prototype.compare = function (line2) {
          checkArguments(arguments.length, 1, "compare", "(PDFNet.TextExtractorLine)", [
            [line2, "Structure", PDFNet.TextExtractorLine, "TextExtractorLine"],
          ])
          checkThisYieldFunction("compare", this.yieldFunction)
          checkParamsYieldFunction("compare", [[line2, 0]])
          return PDFNet.sendWithPromise("TextExtractorLine.compare", { line: this, line2: line2 })
        }
        ...
        PDFNet.TextExtractorLine.prototype.isValid = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.isValid", { line: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            copyFunc(id.line, me)
        ...
        PDFNet.TextExtractor.prototype.getNumLines = function () {
          return PDFNet.sendWithPromise("TextExtractor.getNumLines", { te: this.id })
        }
        PDFNet.TextExtractor.prototype.getFirstLine = function () {
          return PDFNet.sendWithPromise("TextExtractor.getFirstLine", { te: this.id }).then(
            function (id) {
              return new PDFNet.TextExtractorLine(id)
            }
          )
        ...
        PDFNet.TextSearch.prototype.setPattern = function (pattern) {
          ...
          return PDFNet.sendWithPromise("TextSearch.setPattern", { ts: this.id, pattern: pattern })
        }
        ...
        PDFNet.TextSearch.prototype.setMode = function (mode) {
          ...
          return PDFNet.sendWithPromise("TextSearch.setMode", { ts: this.id, mode: mode })
        }
        ...
        PDFNet.TextSearch.prototype.getCurrentPage = function () {
          return PDFNet.sendWithPromise("TextSearch.getCurrentPage", { ts: this.id })
        }
        PDFNet.TextSearch.prototype.setOCGContext = function (ctx) {
          checkArguments(arguments.length, 1, "setOCGContext", "(PDFNet.OCGContext)", [
            [ctx, "Object", PDFNet.OCGContext, "OCGContext"],
          ])
          return PDFNet.sendWithPromise("TextSearch.setOCGContext", { te: this.id, ctx: ctx.id })
        }
        PDFNet.NameTree.create = function (doc, name) {
          ...
          return PDFNet.sendWithPromise("nameTreeCreate", { doc: doc.id, name: name }).then(
            function (id) {
        ...
        PDFNet.NameTree.find = function (doc, name) {
          ...
          return PDFNet.sendWithPromise("nameTreeFind", { doc: doc.id, name: name }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.NameTree, id)
          })
        ...
        PDFNet.NameTree.createFromObj = function (name_tree) {
          ...
          return PDFNet.sendWithPromise("nameTreeCreateFromObj", { name_tree: name_tree.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.NameTree, id)
            }
          )
        ...
        PDFNet.NameTree.prototype.getIterator = function (key) {
          ...
          return PDFNet.sendWithPromise("NameTree.getIterator", { tree: this.id, key: key }).then(
            function (id) {
        ...
        PDFNet.NameTree.prototype.getValue = function (key) {
          ...
          return PDFNet.sendWithPromise("NameTree.getValue", { tree: this.id, key: key }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.NameTree.prototype.getIteratorBegin = function () {
          return PDFNet.sendWithPromise("NameTree.getIteratorBegin", { tree: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.DictIterator, id)
            }
          )
        ...
        PDFNet.NameTree.prototype.eraseKey = function (key) {
          ...
          return PDFNet.sendWithPromise("NameTree.eraseKey", { tree: this.id, key: key })
        }
        PDFNet.NameTree.prototype.erase = function (pos) {
          checkArguments(arguments.length, 1, "erase", "(PDFNet.DictIterator)", [
            [pos, "Object", PDFNet.DictIterator, "DictIterator"],
          ])
          return PDFNet.sendWithPromise("NameTree.erase", { tree: this.id, pos: pos.id })
        }
        PDFNet.NameTree.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("NameTree.getSDFObj", { tree: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.NumberTree.create = function (number_tree) {
          ...
          return PDFNet.sendWithPromise("numberTreeCreate", { number_tree: number_tree.id }).then(
            function (id) {
        ...
        PDFNet.NumberTree.prototype.copy = function () {
          return PDFNet.sendWithPromise("NumberTree.copy", { tree: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.NumberTree, id)
          })
        }
        ...
        PDFNet.NumberTree.prototype.getIterator = function (key) {
          ...
          return PDFNet.sendWithPromise("NumberTree.getIterator", { tree: this.id, key: key }).then(
            function (id) {
              return createDestroyableObj(PDFNet.DictIterator, id)
            }
          )
        ...
        PDFNet.NumberTree.prototype.getValue = function (key) {
          ...
          return PDFNet.sendWithPromise("NumberTree.getValue", { tree: this.id, key: key }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.NumberTree.prototype.getIteratorBegin = function () {
          return PDFNet.sendWithPromise("NumberTree.getIteratorBegin", { tree: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.DictIterator, id)
            }
          )
        ...
        PDFNet.NumberTree.prototype.eraseKey = function (key) {
          ...
          return PDFNet.sendWithPromise("NumberTree.eraseKey", { tree: this.id, key: key })
        }
        PDFNet.NumberTree.prototype.erase = function (pos) {
          checkArguments(arguments.length, 1, "erase", "(PDFNet.DictIterator)", [
            [pos, "Object", PDFNet.DictIterator, "DictIterator"],
          ])
          return PDFNet.sendWithPromise("NumberTree.erase", { tree: this.id, pos: pos.id })
        }
        PDFNet.NumberTree.prototype.getSDFObj = function () {
          return PDFNet.sendWithPromise("NumberTree.getSDFObj", { tree: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Obj.prototype.write = function (stream) {
          ...
          return PDFNet.sendWithPromise("Obj.write", { o: this.id, stream: stream.id })
        }
        PDFNet.Obj.prototype.isEqual = function (to) {
          checkArguments(arguments.length, 1, "isEqual", "(PDFNet.Obj)", [
            [to, "Object", PDFNet.Obj, "Obj"],
          ])
          return PDFNet.sendWithPromise("Obj.isEqual", { o: this.id, to: to.id })
        }
        ...
        PDFNet.Obj.prototype.setString = function (value) {
          ...
          return PDFNet.sendWithPromise("Obj.setString", { o: this.id, value: value })
        }
        PDFNet.Obj.prototype.setUString = function (value) {
          checkArguments(arguments.length, 1, "setUString", "(string)", [[value, "string"]])
          return PDFNet.sendWithPromise("Obj.setUString", { o: this.id, value: value })
        }
        ...
        PDFNet.Obj.prototype.setName = function (name) {
          ...
          return PDFNet.sendWithPromise("Obj.setName", { o: this.id, name: name })
        }
        ...
        PDFNet.Obj.prototype.setMark = function (mark) {
          ...
          return PDFNet.sendWithPromise("Obj.setMark", { o: this.id, mark: mark })
        }
        ...
        PDFNet.Obj.prototype.getDictIterator = function () {
          return PDFNet.sendWithPromise("Obj.getDictIterator", { o: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.DictIterator, id)
          })
        }
        ...
        PDFNet.Obj.prototype.find = function (key) {
          ...
          return PDFNet.sendWithPromise("Obj.find", { o: this.id, key: key }).then(function (id) {
            return createDestroyableObj(PDFNet.DictIterator, id)
          })
        }
        PDFNet.Obj.prototype.findObj = function (key) {
          checkArguments(arguments.length, 1, "findObj", "(string)", [[key, "string"]])
          return PDFNet.sendWithPromise("Obj.findObj", { o: this.id, key: key }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Obj.prototype.get = function (key) {
          ...
          return PDFNet.sendWithPromise("Obj.get", { o: this.id, key: key }).then(function (id) {
            return createDestroyableObj(PDFNet.DictIterator, id)
          })
        }
        PDFNet.Obj.prototype.putName = function (key, name) {
          ...
          return PDFNet.sendWithPromise("Obj.putName", { o: this.id, key: key, name: name }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.putArray = function (key) {
          ...
          return PDFNet.sendWithPromise("Obj.putArray", { o: this.id, key: key }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Obj.prototype.putBool = function (key, value) {
          ...
          return PDFNet.sendWithPromise("Obj.putBool", { o: this.id, key: key, value: value }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.putDict = function (key) {
          ...
          return PDFNet.sendWithPromise("Obj.putDict", { o: this.id, key: key }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Obj.prototype.putText = function (key, t) {
          ...
          return PDFNet.sendWithPromise("Obj.putText", { o: this.id, key: key, t: t }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.putMatrix = function (key, mtx) {
          ...
          return PDFNet.sendWithPromise("Obj.putMatrix", { o: this.id, key: key, mtx: mtx }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.eraseFromKey = function (key) {
          ...
          return PDFNet.sendWithPromise("Obj.eraseFromKey", { o: this.id, key: key })
        }
        PDFNet.Obj.prototype.erase = function (pos) {
          checkArguments(arguments.length, 1, "erase", "(PDFNet.DictIterator)", [
            [pos, "Object", PDFNet.DictIterator, "DictIterator"],
          ])
          return PDFNet.sendWithPromise("Obj.erase", { o: this.id, pos: pos.id })
        }
        ...
        PDFNet.Obj.prototype.getAt = function (index) {
          ...
          return PDFNet.sendWithPromise("Obj.getAt", { o: this.id, index: index }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Obj.prototype.insertArray = function (pos) {
          ...
          return PDFNet.sendWithPromise("Obj.insertArray", { o: this.id, pos: pos }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Obj.prototype.insertDict = function (pos) {
          ...
          return PDFNet.sendWithPromise("Obj.insertDict", { o: this.id, pos: pos }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Obj.prototype.insertText = function (pos, t) {
          ...
          return PDFNet.sendWithPromise("Obj.insertText", { o: this.id, pos: pos, t: t }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.insertNull = function (pos) {
          ...
          return PDFNet.sendWithPromise("Obj.insertNull", { o: this.id, pos: pos }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Obj.prototype.pushBackName = function (name) {
          ...
          return PDFNet.sendWithPromise("Obj.pushBackName", { o: this.id, name: name }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.pushBackArray = function () {
          return PDFNet.sendWithPromise("Obj.pushBackArray", { o: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.Obj.prototype.pushBackBool = function (value) {
          checkArguments(arguments.length, 1, "pushBackBool", "(boolean)", [[value, "boolean"]])
          return PDFNet.sendWithPromise("Obj.pushBackBool", { o: this.id, value: value }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.pushBackDict = function () {
          return PDFNet.sendWithPromise("Obj.pushBackDict", { o: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.Obj.prototype.pushBackNumber = function (value) {
          checkArguments(arguments.length, 1, "pushBackNumber", "(number)", [[value, "number"]])
          return PDFNet.sendWithPromise("Obj.pushBackNumber", { o: this.id, value: value }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.pushBackString = function (value) {
          ...
          return PDFNet.sendWithPromise("Obj.pushBackString", { o: this.id, value: value }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.pushBackText = function (t) {
          ...
          return PDFNet.sendWithPromise("Obj.pushBackText", { o: this.id, t: t }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.Obj.prototype.pushBackNull = function () {
          return PDFNet.sendWithPromise("Obj.pushBackNull", { o: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        ...
        PDFNet.Obj.prototype.pushBackMatrix = function (mtx) {
          ...
          return PDFNet.sendWithPromise("Obj.pushBackMatrix", { o: this.id, mtx: mtx }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.Obj.prototype.getRawStreamLength = function () {
          return PDFNet.sendWithPromise("Obj.getRawStreamLength", { o: this.id })
        }
        PDFNet.Obj.prototype.setStreamData = function (data_buf) {
          checkArguments(arguments.length, 1, "setStreamData", "(ArrayBuffer|TypedArray)", [
            [data_buf, "ArrayBuffer"],
          ])
          var data_bufArrayBuffer = getArrayBuffer(data_buf, !1)
        ...
        PDFNet.Obj.prototype.getRawStream = function (decrypt) {
          ...
          return PDFNet.sendWithPromise("Obj.getRawStream", { o: this.id, decrypt: decrypt }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Filter, id)
            }
          )
        ...
        PDFNet.Obj.prototype.getDecodedStream = function () {
          return PDFNet.sendWithPromise("Obj.getDecodedStream", { o: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Filter, id)
          })
        }
        ...
        PDFNet.ObjSet.prototype.createName = function (name) {
          ...
          return PDFNet.sendWithPromise("ObjSet.createName", { set: this.id, name: name }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.ObjSet.prototype.createArray = function () {
          return PDFNet.sendWithPromise("ObjSet.createArray", { set: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.ObjSet.prototype.createBool = function (value) {
          checkArguments(arguments.length, 1, "createBool", "(boolean)", [[value, "boolean"]])
          return PDFNet.sendWithPromise("ObjSet.createBool", { set: this.id, value: value }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.ObjSet.prototype.createDict = function () {
          return PDFNet.sendWithPromise("ObjSet.createDict", { set: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.ObjSet.prototype.createNull = function () {
          return PDFNet.sendWithPromise("ObjSet.createNull", { set: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.ObjSet.prototype.createNumber = function (value) {
          checkArguments(arguments.length, 1, "createNumber", "(number)", [[value, "number"]])
          return PDFNet.sendWithPromise("ObjSet.createNumber", { set: this.id, value: value }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.ObjSet.prototype.createString = function (value) {
          ...
          return PDFNet.sendWithPromise("ObjSet.createString", { set: this.id, value: value }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.ObjSet.prototype.createFromJson = function (json) {
          ...
          return PDFNet.sendWithPromise("ObjSet.createFromJson", { set: this.id, json: json }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.SDFDoc.prototype.createShallowCopy = function () {
          return PDFNet.sendWithPromise("SDFDoc.createShallowCopy", { source: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SDFDoc, id)
            }
          )
        ...
        PDFNet.SDFDoc.prototype.releaseFileHandles = function () {
          return PDFNet.sendWithPromise("SDFDoc.releaseFileHandles", { doc: this.id })
        }
        ...
        PDFNet.SDFDoc.prototype.hasRepairedXRef = function () {
          return PDFNet.sendWithPromise("SDFDoc.hasRepairedXRef", { doc: this.id })
        }
        PDFNet.SDFDoc.prototype.isFullSaveRequired = function () {
          return PDFNet.sendWithPromise("SDFDoc.isFullSaveRequired", { doc: this.id })
        }
        PDFNet.SDFDoc.prototype.getTrailer = function () {
          return PDFNet.sendWithPromise("SDFDoc.getTrailer", { doc: this.id }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        }
        PDFNet.SDFDoc.prototype.getObj = function (obj_num) {
          checkArguments(arguments.length, 1, "getObj", "(number)", [[obj_num, "number"]])
          return PDFNet.sendWithPromise("SDFDoc.getObj", { doc: this.id, obj_num: obj_num }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.SDFDoc.prototype.getSecurityHandler = function () {
          return PDFNet.sendWithPromise("SDFDoc.getSecurityHandler", { doc: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.SecurityHandler, id)
            }
          )
        ...
        PDFNet.SDFDoc.prototype.removeSecurity = function () {
          return PDFNet.sendWithPromise("SDFDoc.removeSecurity", { doc: this.id })
        }
        ...
        PDFNet.SDFDoc.prototype.getLinearizationDict = function () {
          return PDFNet.sendWithPromise("SDFDoc.getLinearizationDict", { doc: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.SDFDoc.prototype.getHintStream = function () {
          return PDFNet.sendWithPromise("SDFDoc.getHintStream", { doc: this.id }).then(function (
            id
          ) {
            return createPDFNetObj(PDFNet.Obj, id)
          })
        ...
        PDFNet.SDFDoc.prototype.enableDiskCaching = function (use_cache_flag) {
          checkArguments(arguments.length, 1, "enableDiskCaching", "(boolean)", [
        ...
        PDFNet.SDFDoc.prototype.lockRead = function () {
          var me = this
          return PDFNet.sendWithPromise("SDFDoc.lockRead", { doc: this.id }).then(function () {
            lockedObjects.push({ name: "SDFDoc", id: me.id, unlocktype: "unlockRead" })
          })
        }
        PDFNet.SDFDoc.prototype.unlockRead = function () {
          var me = this
          return PDFNet.sendWithPromise("SDFDoc.unlockRead", { doc: this.id }).then(function () {
            unregisterLockedObject(me)
          })
        }
        PDFNet.SDFDoc.prototype.tryLock = function () {
          var me = this
          return PDFNet.sendWithPromise("SDFDoc.tryLock", { doc: this.id }).then(function (
            success
          ) {
        ...
        PDFNet.SDFDoc.prototype.tryLockRead = function () {
          var me = this
          return PDFNet.sendWithPromise("SDFDoc.tryLockRead", { doc: this.id }).then(function (
            success
          ) {
            success && lockedObjects.push({ name: "SDFDoc", id: me.id, unlocktype: "unlockRead" })
          })
        }
        ...
        PDFNet.SDFDoc.prototype.createIndirectArray = function () {
          return PDFNet.sendWithPromise("SDFDoc.createIndirectArray", { doc: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.SDFDoc.prototype.createIndirectDict = function () {
          return PDFNet.sendWithPromise("SDFDoc.createIndirectDict", { doc: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.SDFDoc.prototype.createIndirectNull = function () {
          return PDFNet.sendWithPromise("SDFDoc.createIndirectNull", { doc: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Obj, id)
            }
          )
        ...
        PDFNet.SDFDoc.prototype.createIndirectString = function (buf_value) {
          checkArguments(arguments.length, 1, "createIndirectString", "(ArrayBuffer|TypedArray)", [
        ...
        PDFNet.SecurityHandler.prototype.clone = function () {
          return PDFNet.sendWithPromise("SecurityHandler.clone", { sh: this.id }).then(function (
            id
          ) {
        ...
        PDFNet.SecurityHandler.prototype.getPermission = function (p) {
          ...
          return PDFNet.sendWithPromise("SecurityHandler.getPermission", { sh: this.id, p: p })
        }
        PDFNet.SecurityHandler.prototype.getKeyLength = function () {
          return PDFNet.sendWithPromise("SecurityHandler.getKeyLength", { sh: this.id })
        }
        ...
        PDFNet.SecurityHandler.prototype.getHandlerDocName = function () {
          return PDFNet.sendWithPromise("SecurityHandler.getHandlerDocName", { sh: this.id })
        }
        PDFNet.SecurityHandler.prototype.isModified = function () {
          return PDFNet.sendWithPromise("SecurityHandler.isModified", { sh: this.id })
        }
        ...
        PDFNet.SecurityHandler.create = function (crypt_type) {
          ...
          return PDFNet.sendWithPromise("securityHandlerCreate", { crypt_type: crypt_type }).then(
            function (id) {
              return createDestroyableObj(PDFNet.SecurityHandler, id)
            }
          )
        ...
        PDFNet.SecurityHandler.prototype.changeRevisionNumber = function (rev_num) {
          checkArguments(arguments.length, 1, "changeRevisionNumber", "(number)", [
            [rev_num, "number"],
          ])
        ...
        PDFNet.SecurityHandler.prototype.setEncryptMetadata = function (encrypt_metadata) {
          checkArguments(arguments.length, 1, "setEncryptMetadata", "(boolean)", [
        ...
        PDFNet.SecurityHandler.prototype.getRevisionNumber = function () {
          return PDFNet.sendWithPromise("SecurityHandler.getRevisionNumber", { sh: this.id })
        }
        ...
        PDFNet.SecurityHandler.prototype.isAES = function () {
          return PDFNet.sendWithPromise("SecurityHandler.isAES", { sh: this.id })
        }
        ...
        PDFNet.SecurityHandler.prototype.isRC4 = function () {
          return PDFNet.sendWithPromise("SecurityHandler.isRC4", { sh: this.id })
        }
        PDFNet.SecurityHandler.prototype.changeUserPasswordUString = function (password) {
          checkArguments(arguments.length, 1, "changeUserPasswordUString", "(string)", [
            [password, "string"],
          ])
        ...
        PDFNet.SecurityHandler.prototype.changeUserPasswordBuffer = function (password) {
          checkArguments(
            arguments.length,
            1,
          ...
          var passwordArrayBuffer = getArrayBuffer(password, !1)
          return PDFNet.sendWithPromise("SecurityHandler.changeUserPasswordBuffer", {
            sh: this.id,
            password_buf: passwordArrayBuffer,
          })
        }
        PDFNet.SecurityHandler.prototype.changeMasterPasswordUString = function (password) {
          checkArguments(arguments.length, 1, "changeMasterPasswordUString", "(string)", [
            [password, "string"],
          ])
        ...
        PDFNet.SecurityHandler.prototype.initPasswordBuffer = function (password_buf) {
          checkArguments(arguments.length, 1, "initPasswordBuffer", "(ArrayBuffer|TypedArray)", [
            [password_buf, "ArrayBuffer"],
          ])
          var password_bufArrayBuffer = getArrayBuffer(password_buf, !1)
        ...
        PDFNet.SecurityHandler.prototype.authorize = function (p) {
          ...
          return PDFNet.sendWithPromise("SecurityHandler.authorize", { sh: this.id, p: p })
        }
        PDFNet.SecurityHandler.prototype.authorizeFailed = function () {
          return PDFNet.sendWithPromise("SecurityHandler.authorizeFailed", { sh: this.id })
        }
        PDFNet.SecurityHandler.prototype.getAuthorizationData = function (req_opr) {
          checkArguments(arguments.length, 1, "getAuthorizationData", "(number)", [
            [req_opr, "number"],
          ])
          return PDFNet.sendWithPromise("SecurityHandler.getAuthorizationData", {
            sh: this.id,
            req_opr: req_opr,
          })
        }
        PDFNet.SecurityHandler.prototype.editSecurityData = function (doc) {
          checkArguments(arguments.length, 1, "editSecurityData", "(PDFNet.SDFDoc)", [
            [doc, "SDFDoc"],
          ])
          return PDFNet.sendWithPromise("SecurityHandler.editSecurityData", {
            sh: this.id,
            doc: doc.id,
          })
        }
        PDFNet.SecurityHandler.prototype.fillEncryptDict = function (doc) {
          checkArguments(arguments.length, 1, "fillEncryptDict", "(PDFNet.SDFDoc)", [
            [doc, "SDFDoc"],
          ])
          return PDFNet.sendWithPromise("SecurityHandler.fillEncryptDict", {
            sh: this.id,
            doc: doc.id,
          }).then(function (id) {
            return createPDFNetObj(PDFNet.Obj, id)
        ...
        PDFNet.SignatureHandler.prototype.getName = function () {
          return PDFNet.sendWithPromise("SignatureHandler.getName", { signature_handler: this.id })
        }
        PDFNet.SignatureHandler.prototype.reset = function () {
          return PDFNet.sendWithPromise("SignatureHandler.reset", { signature_handler: this.id })
        }
        ...
        PDFNet.UndoManager.prototype.discardAllSnapshots = function () {
          return PDFNet.sendWithPromise("UndoManager.discardAllSnapshots", { self: this.id }).then(
            function (id) {
        ...
        PDFNet.UndoManager.prototype.undo = function () {
          return PDFNet.sendWithPromise("UndoManager.undo", { self: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.ResultSnapshot, id)
          })
        }
        PDFNet.UndoManager.prototype.canUndo = function () {
          return PDFNet.sendWithPromise("UndoManager.canUndo", { self: this.id })
        }
        PDFNet.UndoManager.prototype.getNextUndoSnapshot = function () {
          return PDFNet.sendWithPromise("UndoManager.getNextUndoSnapshot", { self: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.DocSnapshot, id)
            }
          )
        ...
        PDFNet.UndoManager.prototype.redo = function () {
          return PDFNet.sendWithPromise("UndoManager.redo", { self: this.id }).then(function (id) {
            return createDestroyableObj(PDFNet.ResultSnapshot, id)
          })
        }
        PDFNet.UndoManager.prototype.canRedo = function () {
          return PDFNet.sendWithPromise("UndoManager.canRedo", { self: this.id })
        }
        PDFNet.UndoManager.prototype.getNextRedoSnapshot = function () {
          return PDFNet.sendWithPromise("UndoManager.getNextRedoSnapshot", { self: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.DocSnapshot, id)
            }
          )
        ...
        PDFNet.UndoManager.prototype.takeSnapshot = function () {
          return PDFNet.sendWithPromise("UndoManager.takeSnapshot", { self: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.ResultSnapshot, id)
            }
          )
        ...
        PDFNet.ResultSnapshot.prototype.currentState = function () {
          return PDFNet.sendWithPromise("ResultSnapshot.currentState", { self: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.DocSnapshot, id)
            }
          )
        ...
        PDFNet.ResultSnapshot.prototype.previousState = function () {
          return PDFNet.sendWithPromise("ResultSnapshot.previousState", { self: this.id }).then(
            function (id) {
              return createDestroyableObj(PDFNet.DocSnapshot, id)
            }
          )
        ...
        PDFNet.ResultSnapshot.prototype.isOk = function () {
          return PDFNet.sendWithPromise("ResultSnapshot.isOk", { self: this.id })
        }
        PDFNet.ResultSnapshot.prototype.isNullTransition = function () {
          return PDFNet.sendWithPromise("ResultSnapshot.isNullTransition", { self: this.id })
        }
        PDFNet.DocSnapshot.prototype.getHash = function () {
          return PDFNet.sendWithPromise("DocSnapshot.getHash", { self: this.id })
        }
        PDFNet.DocSnapshot.prototype.isValid = function () {
          return PDFNet.sendWithPromise("DocSnapshot.isValid", { self: this.id })
        }
        PDFNet.DocSnapshot.prototype.equals = function (snapshot) {
          checkArguments(arguments.length, 1, "equals", "(PDFNet.DocSnapshot)", [
        ...
        PDFNet.OCRModule.applyOCRJsonToPDF = function (dst, json) {
          ...
          return PDFNet.sendWithPromise("ocrModuleApplyOCRJsonToPDF", { dst: dst.id, json: json })
        }
        PDFNet.OCRModule.applyOCRXmlToPDF = function (dst, xml) {
          ...
          return PDFNet.sendWithPromise("ocrModuleApplyOCRXmlToPDF", { dst: dst.id, xml: xml })
        }
        PDFNet.VerificationOptions.create = function (in_level) {
          checkArguments(arguments.length, 1, "create", "(number)", [[in_level, "number"]])
          return PDFNet.sendWithPromise("verificationOptionsCreate", { in_level: in_level }).then(
            function (id) {
        ...
        PDFNet.VerificationOptions.prototype.addTrustedCertificate = function (
          ...
          "undefined" === typeof in_trust_flags &&
            (in_trust_flags = PDFNet.VerificationOptions.CertificateTrustFlag.e_default_trust)
          checkArguments(
            arguments.length,
            1,
        ...
        PDFNet.VerificationOptions.prototype.addTrustedCertificates = function (
          ...
          var in_P7C_binary_DER_certificates_file_dataArrayBuffer = getArrayBuffer(
            in_P7C_binary_DER_certificates_file_data,
            !1
          )
        ...
        PDFNet.VerificationOptions.prototype.loadTrustList = function (in_fdf_cert_exchange_data) {
          checkArguments(arguments.length, 1, "loadTrustList", "(PDFNet.FDFDoc)", [
        ...
        PDFNet.VerificationOptions.prototype.enableModificationVerification = function (
          in_on_or_off
        ) {
          checkArguments(arguments.length, 1, "enableModificationVerification", "(boolean)", [
        ...
        PDFNet.VerificationOptions.prototype.enableDigestVerification = function (in_on_or_off) {
          checkArguments(arguments.length, 1, "enableDigestVerification", "(boolean)", [
            [in_on_or_off, "boolean"],
          ])
        ...
        PDFNet.VerificationOptions.prototype.enableTrustVerification = function (in_on_or_off) {
          checkArguments(arguments.length, 1, "enableTrustVerification", "(boolean)", [
            [in_on_or_off, "boolean"],
          ])
        ...
        PDFNet.VerificationOptions.prototype.setRevocationProxyPrefix = function (in_str) {
          checkArguments(arguments.length, 1, "setRevocationProxyPrefix", "(string)", [
            [in_str, "string"],
          ])
        ...
        PDFNet.VerificationOptions.prototype.enableOnlineCRLRevocationChecking = function (
          in_on_or_off
        ) {
          checkArguments(arguments.length, 1, "enableOnlineCRLRevocationChecking", "(boolean)", [
            [in_on_or_off, "boolean"],
          ])
        ...
        PDFNet.VerificationOptions.prototype.enableOnlineOCSPRevocationChecking = function (
          in_on_or_off
        ) {
          checkArguments(arguments.length, 1, "enableOnlineOCSPRevocationChecking", "(boolean)", [
            [in_on_or_off, "boolean"],
          ])
        ...
        PDFNet.VerificationOptions.prototype.enableOnlineRevocationChecking = function (
          in_on_or_off
        ) {
          checkArguments(arguments.length, 1, "enableOnlineRevocationChecking", "(boolean)", [
            [in_on_or_off, "boolean"],
          ])
        ...
        PDFNet.VerificationResult.prototype.getDigestStatus = function () {
          return PDFNet.sendWithPromise("VerificationResult.getDigestStatus", { self: this.id })
        }
        PDFNet.VerificationResult.prototype.getTrustStatus = function () {
          return PDFNet.sendWithPromise("VerificationResult.getTrustStatus", { self: this.id })
        }
        ...
        PDFNet.DisallowedChange.prototype.getObjNum = function () {
          return PDFNet.sendWithPromise("DisallowedChange.getObjNum", { self: this.id })
        }
        PDFNet.DisallowedChange.prototype.getType = function () {
          return PDFNet.sendWithPromise("DisallowedChange.getType", { self: this.id })
        }
        PDFNet.DisallowedChange.prototype.getTypeAsString = function () {
          return PDFNet.sendWithPromise("DisallowedChange.getTypeAsString", { self: this.id })
        }
        PDFNet.X509Extension.prototype.isCritical = function () {
          return PDFNet.sendWithPromise("X509Extension.isCritical", { self: this.id })
        }
        ...
        PDFNet.X509Extension.prototype.toString = function () {
          return PDFNet.sendWithPromise("X509Extension.toString", { self: this.id })
        }
        PDFNet.X509Extension.prototype.getData = function () {
          return PDFNet.sendWithPromise("X509Extension.getData", { self: this.id }).then(function (
            id
          ) {
            return new Uint8Array(id)
          })
        ...
        PDFNet.ByteRange.prototype.getStartOffset = function () {
          ...
          return PDFNet.sendWithPromise("ByteRange.getStartOffset", { self: this })
        }
        PDFNet.ByteRange.prototype.getEndOffset = function () {
          checkThisYieldFunction("getEndOffset", this.yieldFunction)
          return PDFNet.sendWithPromise("ByteRange.getEndOffset", { self: this })
        }
        ...
        PDFNet.TimestampingResult.prototype.getStatus = function () {
          return PDFNet.sendWithPromise("TimestampingResult.getStatus", { self: this.id })
        }
        PDFNet.TimestampingResult.prototype.getString = function () {
          return PDFNet.sendWithPromise("TimestampingResult.getString", { self: this.id })
        }
        ...
        PDFNet.TimestampingResult.prototype.getData = function () {
          return PDFNet.sendWithPromise("TimestampingResult.getData", { self: this.id }).then(
            function (id) {
              return new Uint8Array(id)
            }
          )
        ...
        PDFNet.ActionParameter.create = function (action) {
          ...
          return PDFNet.sendWithPromise("actionParameterCreate", { action: action.id }).then(
            function (id) {
        ...
        PDFNet.Action.prototype.parameterCreateWithField = function (field) {
          checkArguments(arguments.length, 1, "parameterCreateWithField", "(PDFNet.Field)", [
            [field, "Structure", PDFNet.Field, "Field"],
          ])
        ...
        PDFNet.Action.prototype.parameterCreateWithAnnot = function (annot) {
          checkArguments(arguments.length, 1, "parameterCreateWithAnnot", "(PDFNet.Annot)", [
            [annot, "Object", PDFNet.Annot, "Annot"],
          ])
        ...
        PDFNet.Action.prototype.parameterCreateWithPage = function (page) {
          checkArguments(arguments.length, 1, "parameterCreateWithPage", "(PDFNet.Page)", [
            [page, "Object", PDFNet.Page, "Page"],
          ])
        ...
        PDFNet.ActionParameter.prototype.getAction = function () {
          return PDFNet.sendWithPromise("ActionParameter.getAction", { ap: this.id }).then(
            function (id) {
              return createPDFNetObj(PDFNet.Action, id)
            }
          )
        ...
        PDFNet.RadioButtonGroup.createFromField = function (field) {
          ...
          return PDFNet.sendWithPromise("radioButtonGroupCreateFromField", { field: field }).then(
            function (id) {
              return createDestroyableObj(PDFNet.RadioButtonGroup, id)
            }
          )
        ...
        PDFNet.RadioButtonGroup.prototype.copy = function () {
          return PDFNet.sendWithPromise("RadioButtonGroup.copy", { group: this.id }).then(function (
            id
          ) {
            return createDestroyableObj(PDFNet.RadioButtonGroup, id)
          })
        ...
        PDFNet.RadioButtonGroup.prototype.getNumButtons = function () {
          return PDFNet.sendWithPromise("RadioButtonGroup.getNumButtons", { group: this.id })
        }
        ...
        PDFNet.RadioButtonGroup.prototype.getField = function () {
          return PDFNet.sendWithPromise("RadioButtonGroup.getField", { group: this.id }).then(
            function (id) {
              return new PDFNet.Field(id)
            }
          )
        ...
        PDFNet.RadioButtonGroup.prototype.addGroupButtonsToPage = function (page) {
          checkArguments(arguments.length, 1, "addGroupButtonsToPage", "(PDFNet.Page)", [
            [page, "Object", PDFNet.Page, "Page"],
          ])
          ...
          checkArguments = function (inputArgNum, minNum, funcName, funcParams, argInfoList) {
            ...
            for (minNum = 0; minNum < maxNum; minNum++) {
              ...
              if ("OptionBase" === argType) {
                ...
                "Array" === argType
                  ? arg$jscomp$0.constructor !== Array && inputArgNum(arg$jscomp$0, minNum, "Array")
                  : "ArrayBuffer" === argType
                  ...
                  ? arg$jscomp$0.constructor === Array ||
                    exports.isArrayBuffer(arg$jscomp$0) ||
                    exports.isArrayBuffer(arg$jscomp$0.buffer) ||
                    inputArgNum(arg$jscomp$0, minNum, "ArrayBuffer|TypedArray")
                  ...
                  ? arg$jscomp$0 instanceof argInfo[2] ||
                    ("object" === _typeof(arg$jscomp$0) && arg$jscomp$0.name
                      ? arg$jscomp$0.name !== argInfo[4] &&
                        throwParaTypeError(minNum, arg$jscomp$0.name, argInfo[3])
                  ...
                  ? "string" !== typeof arg$jscomp$0 &&
                    null !== arg$jscomp$0 &&
                    throwParaTypeError(minNum, _typeof(arg$jscomp$0), "string")
                  : _typeof(arg$jscomp$0) !== argType &&
                    throwParaTypeError(minNum, _typeof(arg$jscomp$0), argType)
            }
          },
        ...
        var createDestroyableObj = function (constructor, id, type) {
          ...
          unregisterLockedObject = function (obj) {
            ...
            if (-1 != objIndex)
              for (
                lockedObjects.splice(objIndex, 1), i = unlockStackCounter.length - 1;
                0 <= i;
                i--
              )
          ...
          avoidCleanup = function (id) {
            ...
            if (-1 != objIndex)
              for (
                createdObjects.splice(objIndex, 1), i = deallocStackCounter.length - 1;
                0 <= i;
                i--
              )
        ...
        PDFNet.endDeallocateStack = function () {
          if (0 === stackCallCounter)
            return (
              console.log("Warning, no startDeallocateStack() instances remain."), Promise.resolve()
            )
          ...
          if (
            ...
            for (; createdObjects.length > deallocStackPos; )
              (objToDealloc = createdObjects.pop()),
                ...
                promiseListDestroy.push(objToDealloc),
                unlockStackPos++
          --stackCallCounter
        ...
        PDFNet.Redactor.redact = function (doc, red_arr, appearance, ext_neg_mode, page_coord_sys) {
          ...
          "undefined" === typeof appearance.positive_overlay_color
            ...
            : "undefined" !== typeof appearance.positive_overlay_color.id &&
              (appearance.positive_overlay_color = appearance.positive_overlay_color.id)
          ...
          "undefined" === typeof appearance.redacted_content_color
            ...
            : "undefined" !== typeof appearance.redacted_content_color.id &&
              (appearance.redacted_content_color = appearance.redacted_content_color.id)
          "undefined" === typeof ext_neg_mode && (ext_neg_mode = !0)
          "undefined" === typeof page_coord_sys && (page_coord_sys = !0)
          if (2 > arguments.length || 5 < arguments.length)
            throw new RangeError(
              arguments.length +
          ...
          if (
            !(
              doc instanceof PDFNet.PDFDoc ||
              doc instanceof PDFNet.SDFDoc ||
              doc instanceof PDFNet.FDFDoc
            )
          ) {
          ...
          if (appearance instanceof Promise)
            throw new TypeError(
        ...
        PDFNet.Highlights.prototype.getCurrentQuads = function () {
          return PDFNet.sendWithPromise("Highlights.getCurrentQuads", { hlts: this.id }).then(
            function (id) {
        ...
        PDFNet.TextSearch.prototype.run = function () {
          ...
          return PDFNet.sendWithPromise("TextSearch.run", { ts: this.id }).then(function (
            searchObj
          ) {
        ...
        PDFNet.Element.prototype.getPathData = function () {
          ...
          return PDFNet.sendWithPromise("Element.getPathData", { e: this.id }).then(function (id) {
        ...
        PDFNet.FilterReader.prototype.readAllIntoBuffer = function () {
          ...
          return PDFNet.sendWithPromise("FilterReader.readAllIntoBuffer", { reader: this.id }).then(
            function (id) {
              return "0" == id ? null : new Uint8Array(id)
            }
          )
        ...
        PDFNet.PDFDraw.prototype.getBitmap = function (page, pix_fmt, demult) {
          ...
          if (pix_fmt instanceof Promise)
            throw new TypeError(
              "Received a Promise object in 1st input argument 'getBitmap'. Promises require a 'yield' statement before being accessed."
            )
          if ("number" != typeof pix_fmt)
            throw new TypeError(
              "2nd input argument '" +
                pix_fmt +
                "' in function 'getBitmap' is of type '" +
        ...
        PDFNet.Matrix2D.create = function (a, b, c, d, h, v) {
          ...
          var capability = createPromiseCapability(),
            matrix = new PDFNet.Matrix2D({ m_a: a, m_b: b, m_c: c, m_d: d, m_h: h, m_v: v })
        ...
        PDFNet.TextExtractorLine.prototype.getBBox = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.getBBox", { line: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
        ...
        PDFNet.TextExtractorLine.prototype.getQuad = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorLine.getQuad", { line: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
        ...
        PDFNet.TextExtractorWord.prototype.getBBox = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorWord.getBBox", { tew: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            return new PDFNet.Rect(
        ...
        PDFNet.TextExtractorWord.prototype.getQuad = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorWord.getQuad", { tew: this }).then(function (
            id
          ) {
            me.yieldFunction = void 0
            return new PDFNet.QuadPoint(
        ...
        PDFNet.TextExtractorStyle.prototype.getColor = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorStyle.getColor", { tes: this }).then(
            function (id) {
              me.yieldFunction = void 0
        ...
        PDFNet.TextExtractorWord.prototype.getString = function () {
          ...
          return PDFNet.sendWithPromise("TextExtractorWord.getString", { tew: this }).then(
            function (id) {
              me.yieldFunction = void 0
              return id
            }
        ...
        PDFNet.Matrix2D.prototype.mult = function (x, y) {
          ...
          return PDFNet.sendWithPromise("Matrix2D.mult", { matrix: this, x: x, y: y })
        }
        ...
        PDFNet.Image.createFromURL = function (doc, url, encoder_hints, options) {
          ...
          if (!(encoder_hints instanceof PDFNet.Obj)) {
            if ("object" == _typeof(encoder_hints))
              throw new TypeError(
        ...
        PDFNet.PDFDoc.prototype.addStdSignatureHandlerFromURL = function (
          ...
          if (pkcs12_pass instanceof Promise)
            throw new TypeError(
        ...
        PDFNet.PDFDoc.prototype.addStdSignatureHandlerFromBufferWithDoc = function (
          pkcs12_buffer,
          pkcs12_pass,
          doc
        ) {
          ...
          if (!exports.isArrayBuffer(pkcs12_buffer.buffer)) {
            if ("object" == _typeof(pkcs12_buffer))
              throw new TypeError(
        ...
        PDFNet.Filter.createFromMemory = function (buf) {
          ...
          return PDFNet.sendWithPromise("filterCreateFromMemory", { buf: buf }).then(function (id) {
            if ("0" == id) return null
        ...
        PDFNet.Filter.createFlateEncode = function (input_filter, compression_level, buf_sz) {
          ...
          if (input_filter instanceof Promise)
            throw new TypeError(
          ...
          if (!(input_filter instanceof PDFNet.Filter)) {
            if ("object" == _typeof(input_filter))
              throw new TypeError(
            ...
            throw new TypeError(
              "1st input argument '" +
                ...
                _typeof(input_filter) +
                "'. Expected type 'Filter'. Function Signature: createFlateEncode(Filter, number, number)."
            )
          }
          if (compression_level instanceof Promise)
            throw new TypeError(
        ...
        PDFNet.PDFDoc.prototype.importPages = function (page_arr, import_bookmarks) {
          ...
          if (page_arr instanceof Promise)
            throw new TypeError(
          ...
          if (import_bookmarks instanceof Promise)
            throw new TypeError(
        ...
        PDFNet.SDFDoc.prototype.applyCustomQuery = function (query) {
          ...
          if ("object" != _typeof(query))
            throw new TypeError(
              "input argument '" + query + "' in function 'applyCustomQuery' must be an object"
            )
        ...
        PDFNet.PDFACompliance.createFromUrl = function (
          ...
          if (max_ref_objs instanceof Promise)
            throw new TypeError(
        ...
        PDFNet.PDFACompliance.createFromBuffer = function (
          ...
          if (!exports.isArrayBuffer(bufArrayBuffer)) {
            if ("object" == _typeof(buf) && buf.name)
              throw new TypeError(
        ...
        PDFNet.PDFDoc.prototype.tryLock = function () {
          ...
          lockedObjects.push({ name: "PDFDoc", id: this.id, unlocktype: "unlock" })
          return PDFNet.sendWithPromise("PDFDoc.tryLock", { doc: this.id }).then(function (
            success
          ) {
        ...
        PDFNet.PDFDoc.prototype.tryLockRead = function () {
          ...
          var index = lockedObjects.length
          lockedObjects.push({ name: "PDFDoc", id: this.id, unlocktype: "unlockRead" })
          return PDFNet.sendWithPromise("PDFDoc.tryLockRead", { doc: this.id }).then(function (
            success
          ) {
            success || lockedObjects.splice(index, 1)
          })
        ...
        PDFNet.Optimizer.optimize = function (doc, optimizerSettings) {
          ...
          if ("undefined" === typeof optimizerSettings)
            ...
            if (optimizerSettings instanceof Promise)
              throw new TypeError(
        ...
        PDFNet.VerificationOptions.prototype.addTrustedCertificateFromURL = function (
          url,
          options
        ) {
          if (1 > arguments.length || 2 < arguments.length)
        ...
        PDFNet.DigitalSignatureField.prototype.certifyOnNextSaveFromURL = function (
          url,
          in_password,
          options
        ) {
        ...
        PDFNet.DigitalSignatureField.prototype.signOnNextSaveFromURL = function (
          url,
          in_password,
          options
        ) {
        ...
        PDFNet.ElementBuilder.prototype.createUnicodeTextRun = function (text_data) {
          checkArguments(arguments.length, 1, "createUnicodeTextRun", "(string)", [
            [text_data, "string"],
          ])
